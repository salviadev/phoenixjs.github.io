...
$(function () {
	var layout = {
		...
		"$items": [
				...
				"$items": [
					{
						...
						"options": {
							...
							"columns": [
								...
								{ "$bind": "Name", "options": { "width": 200, "selectable": true } },
                                { "$bind": "Type", "options": { "width": 200, "selectable": true } },
                                { "$bind": "DateOfBirth", "options": { "width": 200, "selectable": true } },
								{ "$bind": "PV", "options": { "width": 200, "selectable": true } },
								{ "$bind": "Price", "options": { "width": 200, "selectable": true } },
							]
						}
					}
				]
            ...
            {
				"$type": "html",
				"$html": '<h3>Multi (row) selecting</h3>'
			},
			{
				"$type": "block",
				"$items": [

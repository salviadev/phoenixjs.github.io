...
var __extends=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)},Phoenix;!function(a){var b;!function(b){var c=a.utils,d=(a.dom,a.locale,a.$mem,a.link,b),e=a.customData,f=a.render,g=function(){function a(a,b,c,d,e){var f=this;a=a||{},f.formData=d||{},f.options=a,f.layout=b,f.schema=c,f.module=e}return a.prototype.render=function(a){var b=this;if(!b.$element){var c={replaceParent:b.options.replaceParent,context:b.options.context,beforeAdd:b.options.beforeAdd,beforeRemove:b.options.beforeRemove,beforeSetModel:b.options.beforeSetModel,afterModelCreated:b.options.afterModelCreated,settingsHandler:b.options.onSettings,storageName:b.options.storageName,validators:b.options.validators,module:b.module},e=b.module&&b.module.data&&b.module.data.data&&b.module.data.data.ds&&b.module.data.data.ds.view?b.module.data.data.ds.view.$view:null;d.OpenForm(a,b.layout,b.schema,b.formData||{},e,b.action,c,function(a){b.form=a,b.$element=b.form.$element})}},a.prototype.destroy=function(){var a=this;a.form&&(a.form.destroy(),a.form=null),a.$element=null},a}();b.FormContainer=g,f.register("javascript","widget.content.control.form",g);var h=function(a){function d(d,f,g,h,i){if(!f)throw"Form name is empty.";if(!g)throw"Meta name (schema) is empty.";if(!h)throw"Controller name is empty.";var j=e.get(h);if(!j)throw c.format('Controller not found "{0}". Use customData.register(controllerName, ctrlConfig).',h);b.formController2Options(d,j);var k=j.data?j.data():null;a.call(this,d,f,g,k,i),j.isFormController?this.action=j.modelChanged.bind(j):j.onModelChanged&&(this.action=j.onModelChanged.bind(j))}return __extends(d,a),d}(g);b.FormContainerController=h}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));

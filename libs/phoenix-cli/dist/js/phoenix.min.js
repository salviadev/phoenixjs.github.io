...
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.application,d=a.ajax,e=a.utils,f=function(a){return a},g={getRessources:function(b,g){var h=function(a){return g&&(a=g(a)),a},i=b.$url,j=c.config(c.name)||{},k=j.rest?j.rest.base||"":"";i&&"/"===i.charAt(0)&&(k=""),k&&(i=k+"/"+i),i=j.rest&&j.rest.$context?e.formatNames(i,{$context:j.rest.$context}):i.replace("{context}/","");var l=d.getDefaultAjaxOptions(),m=b.$query;b.$list;switch(i+=a.link.object2search(m),i=f(i),b.$method){case"POST":return d.post(i,b.$data,l);case"PUT":return d.put(i,b.$data,l);case"PATCH":return d.patch(i,b.$data,l);case"DELETE":return d.remove(i,l);default:return d.get(i,l,function(a){return h(a)})}}};b.rest=g}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
...
//clear cache
f={}},urlResEntity:function(a,b){var e=c.config(c.name)||{},f=e.odata?e.odata.base||"/data":"/data";if(f=d.formatNames(f,{$module:a.$module}),!a.$entity)throw"Invalid odata entity.";if(b&&!a.$entityId)throw"Invalid odata entity id.";var g=f+"/"+a.$entity;return a.$entityId&&(g=g+"("+a.$entityId+")"),a.$propertyName&&(g=g+"/"+a.$propertyName),g},doDelete:function(a,b){var c=h.urlResEntity(a,!0),d=e.getDefaultAjaxOptions();return b&&(d.headers["If-Match"]=b),d.ignore={410:!0},c=g(c),h.transport.doDelete(c,d)},doPost:function(a,b){var c=e.getDefaultAjaxOptions(),d=h.urlResEntity(a,!1);return d=g(d),h.transport.doPost(d,b,c)},doPut:function(a,b,c,d){var f=h.urlResEntity(a,!0),i=e.getDefaultAjaxOptions();return i.headers=i.headers||{},c&&(i.headers["If-Match"]=c),d&&(i.headers.Prefer="return=representation"),f=g(f),h.transport.doPut(f,b,i)},doPatch:function(a,b,c,d){var f=h.urlResEntity(a,!0),i=e.getDefaultAjaxOptions();return i.headers=i.headers||{},c&&(i.headers["If-Match"]=c),d&&(i.headers.Prefer="return=representation"),f=g(f),h.transport.doPatch(f,b,i)},getRessources:function(i,j,k){var l=function(a){return j&&(a=j(a)),a},m=!1,n=i.$cache;delete i.$cache;var o=c.config(c.name)||{};o.odata&&void 0!=o.odata.v4&&(h.v4=o.odata.v4);var p=o.odata?o.odata.base||"/data":"/data";p=d.formatNames(p,{$module:i.$module}),delete i.$module;var q=i.$entity;i.$entityId&&(q=q+"("+i.$entityId+")",delete i.$entityId,m=!0),i.$propertyName&&(q=q+"/"+i.$propertyName,delete i.$propertyName);var r=q;delete i.$entity,m||(h.v4?(i.$top&&!i.nocount&&(i.$count=!0),delete i.nocount):i.$inlinecount="allpages");var s=!1;i.$aggregation&&"$count"==i.$aggregation&&(r=r+"/"+i.$aggregation,delete i.$aggregation,s=!0);var t=e.getDefaultAjaxOptions();return t.$errors=k,r=p+"/"+r+a.link.object2search(i),n&&f[q]&&f[q].uri==r?new d.Promise(function(a,b){var c=l(s||m?f[q].data:$.extend(!0,{},f[q].data));a(c)}):(r=g(r),b.odata.transport.doGet(r,t,function(a){var b={};return h.v4&&a&&delete a["@odata.context"],s||m?b=a:(b.documents=h.v4?a.value:a.d.results,b.dataCount=b.documents?b.documents.length:0,b.documents.forEach(function(a){delete a.__metadata}),b&&(b.pageSize=i.$top,b.skip=i.$skip||0,b.count=h.v4?a["@odata.count"]:a.d.__count,b.nodata=0==b.dataCount)),n&&(f[q]={uri:r,data:s?b:$.extend(!0,{},b)}),l(b)},{entity:q,params:i}))}};b.odata=h,a.authentication.registerAfterLogout(h.afterLogout)}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
...
/// <reference path="./schema.data.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a){var b=a.charAt(0).toUpperCase()+a.slice(1);return"on"+b.replace(/(?:^|[-_\.])(\w)/g,function(a,b){return b?b.toUpperCase():""})}var d=a.ajax,e=a.utils,f=a.application,g=a.Observable.SchemaUtils,h=function(a){function c(c,d,e,f,g){a.call(this,c,g);var h=this,i=c.opts?c.opts:{};c.validators&&(i.validators=c.validators,delete c.validators),h.render=new b.Form(d,i,f,e,g),h.render.$locale=g}return __extends(c,a),c.prototype.on=function(a){var b=this,c=function(c,d,e){return a(b,c,d,e)};this._clickHnd=function(a){b.render.afterchanged(a,"modal-action",{})},b.render.on(c)},c}(b.Modal);b.ModalForm=h;var i=function(a,b,c){g.loadSchemaRefs(b.schema,b.data,b.layout,function(d){var e=new h(a,b.layout,b.schema,d,b.locale);e.open(),c&&e.on(c)})},j=function(a,b,c,g,h,j){var k=0,l=-1,m=-1,n=[],o={locale:h},p=-1,q=f.config(f.name),r={};a=a||{},a.opts=r,h&&h.$name&&(r.externalLocale=h.$name),g&&g.then?(n.push(g),p=0,k++):o.data=$.extend(!0,{},g),"object"==typeof b?o.layout=$.extend(!0,{},b):(l=k,k++,r.externalLayout=b,n.push(d.get(q.forms+"/"+b+".json"))),"object"==typeof c?o.schema=$.extend(!0,{},c):(m=k,k++,r.externalSchema=c,n.push(d.get(q.prototypes+"/"+c+".json"))),n.length?e.Promise.all(n).then(function(b){l>=0&&(o.layout=b[l]),m>=0&&(o.schema=b[m]),p>=0&&(o.data=b[p]),i(a,o,j)}):i(a,o,j)},k=function(a,c,d,e){var f=new b.Form(c.layout,e||{design:!1},c.data,c.schema,c.locale);return f.$locale=c.locale,f.render(a),d&&f.on(d),f},l=function(a,b,c,d,e){g.loadSchemaRefs(b.schema,b.data,b.layout,function(f){b.data=f;var g=k(a,b,c,d);e&&e(g)})},m=function(a,b,c,g,h,i,j,k){var m=0,n=-1,o=-1,p=[],q={locale:h},r=-1;j=j||{},h&&h.$name&&(j.externalLocale=h.$name),g&&g.then?(p.push(g),r=0,m++):q.data=$.extend(!0,{},g);var s=f.config(f.name);"object"==typeof b?q.layout=$.extend(!0,{},b):(n=m,m++,j.externalLayout=b,p.push(d.get(s.forms+"/"+b+".json"))),"object"==typeof c?q.schema=$.extend(!0,{},c):(o=m,m++,j.externalSchema=c,p.push(d.get(s.prototypes+"/"+c+".json"))),p.length?e.Promise.all(p).then(function(b){n>=0&&(q.layout=b[n]),o>=0&&(q.schema=b[o]),r>=0&&(q.data=b[r]),l(a,q,i,j,k)})["catch"](function(a){throw console.log(a),a}):l(a,q,i,j,k)},n=function(){function a(){}return a.prototype.initObjectState=function(a){},a.prototype.onModelChanged=function(a,b,d){var e=this;if("propchange"===a.operation){var f=c(a.property);if(e[f])return e[f](a,b,d)}},a}();b.FormController=n,b.OpenModalForm=j,b.OpenForm=m}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/browser.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="../../../ui/layout.control.ts" />
/// <reference path="../schema.data.ts" />
/// <reference path="../form.control.ts" />
var Phoenix;!function(a){var b;!function(b){var c=(a.render,a.dom),d=a.device,e=a.Observable,f=a.bootstrap4,g=a.ulocale,h=a.locale,i=a.customData,j=e.SchemaUtils,k=function(a,b,c,d,e){c=c||!1,d=d||"",c&&(b="*"),e=e||{};var f=e.lookup||!1;e.readOnly?i.register("ui-controls-readonly-"+d,a):i.register("ui-controls-"+b+"-"+c+"-"+f+"-"+d,a)},l=function(a,b,c,d){b=b||!1,b&&(a="*"),c=c||"";var e=!(!d||!d.lookup),f=!(!d||!d.readOnly);return f?i.get("ui-controls-readonly-"+c):i.get("ui-controls-"+a+"-"+b+"-"+e+"-"+c)},m=function(){var a=!1,b=!1;return function(){if(b)return a;if(b=!0,d.phone||d.tablet){var c=document.createElement("input");return c.setAttribute("type","date"),a="date"===c.type}return!1}},n=function(){var a=!1,b=!1;return function(){if(b)return a;if(b=!0,d.phone||d.tablet){var c=document.createElement("input");return c.setAttribute("type","number"),a="number"===c.type}return!1}},o={nativeDate:m(),nativeNumber:n(),addErrorDiv:function(a){a.push('<div class="small text-danger bs-none" id="{0}_errors"></div>')},keyPressPassword:function(a){var b=a.which;return b===c.keys.VK_SPACE?(a.preventDefault(),!1):!0},keyPressCode:function(a){var b=a.which;return b===c.keys.VK_SPACE?(a.preventDefault(),!1):!0},keyPressNumber:function(a){var b="-0123456789,."+h.number.decimal,d=a.which;if(!a.metaKey&&c.ignoreKeys.indexOf(d)<0){var e=String.fromCharCode(d);if(b.indexOf(e)<0)return a.preventDefault(),!1}return!0},getRegisterdControl:l,addContainerId:function(a,b){b&&a.push(' draggable="true"'),a.push(' data-render="{0}"'),a.push(' id="{0}"')},containerBaseClass:function(a,b,c){var d=[a,c.groupFieldClass||"bs-field-group","bs-island"];return c.inline&&d.push(c.inlineFieldClass||"bs-field-inline"),b&&d.push(" design"),d.join(" ")},fieldWrapper:function(a,b,c,d,e){b.inline&&(b.columns=!1);var g=e&&e.formGroup?e.formGroup:"form-group",h=[o.containerBaseClass(g,c,b)],i=e&&e.tag?e.tag:"div";a.push("<"+i+' class="'),b.size&&!f&&h.push("form-group-"+b.size),b.columns&&(f||h.push("form-horizontal"),h.push("row")),b.styles&&h.push(b.styles),b.right&&h.push(" pull-right"),
//if (options.date) css.push('date');
a.push(h.join(" ")),a.push('"'),o.addContainerId(a,c),a.push(">"),d(),a.push("</"+i+">")},fillSelect:function(a,b,d){if(b){var e=d.enumNames||d["enum"],f=d["enum"];c.empty(b);var g=document.createDocumentFragment();a.forEach(function(a){var b=f.indexOf(a),d=e[b]||a+"",h=document.createElement("option");c.attr(h,"value",a),h.textContent=d,c.append(g,h)}),c.append(b,g)}},defaultOptions:{titleIsHidden:!1,placeHolder:!1,labelCol:3},displayValue:function(a,b,d,e){var f;if(e=e||{},void 0===a&&(a=""),b["enum"]){var i=b["enum"].indexOf(a);f=i>=0?{value:b.enumNames?g.tt(b.enumNames[i],d):a,html:!1}:{value:"",html:!1}}else switch(b.type){case"string":if(b.format)switch(b.format){case"date":f={value:g.shortDate(a||""),html:!1}}f||(f={value:a,html:!1});break;case"number":f="money"==b.format?{value:g.money(a||0,e.useSymbol),html:!1}:{value:g.decimal(a||0,b.decimals||0,e.useSymbol?b.symbol:""),html:!1};break;case"integer":f={value:g.decimal(a||0,0,""),html:!1};break;case"boolean":if(e.html){var j=[];if(e.avanced&&e.avanced.editable||e.editable||e.check){var k="",l="bs-cursor-d ";e.editable&&(k=" bs-bool-edit",l="bs-cursor-p ");var m=e.tableOptions&&e.tableOptions.small?" small-table":"";j.push('<center class="bs-bool-center'+m+'"><span data-clickable="true" class="'+l+c.iconClass(a?"check-square-o":"square-o")+k+'"></span></center>'),f={value:j.join(""),html:!0}}else f={value:a?h.ui.Yes:h.ui.No,html:!1}}else f={value:a?h.ui.Yes:h.ui.No,html:!1}}if(f||(f={value:a,html:!1}),e.html&&e.avanced&&e.avanced.$link){var n=['<a class="bs-cursor-p" data-phoenix-href="link://$link">'];n.push(f.value),n.push("</a>"),f.value=n.join(""),f.html=!0}return f},addTooltip:function(a,b,d){a.push('<span id="{0}_tooltip" data-toggle="tooltip" data-phoenix-tooltip="true" data-placement="auto" title="'+b+'" class="'+c.iconClass("question-circle")+" bs-tooltip-icon"),d&&d.inline&&a.push(" bs-tooltip-icon-inline"),a.push('"></span>')}},p=function(){function a(a,b,c){var d=this;d.config=a,d.form=c,d.parent=d.form.getLayoutById(a.$parentId),d.$bind=a.$bind,d.$display=d.config.$display||d.$bind,a.$lookup&&(d.useDisplay=d.$display!==d.$bind,d.$lookup=d.form.getLookupForSchema(d.$bind,a.$lookup));var e=j.isMeta(d.$bind);e&&(d.$bind=d.getCustomBind()),d.$bind&&c.registerListenerFor(d.$bind,d),d.useDisplay&&c.registerListenerFor(d.$display,d),d._defineProps(),d.options=b||{},d.fieldOptions=a.options||{},d.renderOptions=d.fieldOptions,d.$schema=d.$bind?c.getSchema(d.$bind):{},d.id=a.$id}return a.prototype.targetInControl=function(a){var b=this;if(b.$element){var d=b.$element.get(0);return c.isChildOf(d,a)}return!1},a.prototype.getCustomBind=function(){return""},a.prototype.setHidden=function(a){this.state.isHidden?c.addClass(a,"bs-none"):c.removeClass(a,"bs-none")},a.prototype._state=function(){var a=this;a.state=a.state||{};var b=a.form.getState(a.$bind);a.state.value=a.form.getValue(a.$bind),Object.keys(b).forEach(function(c){a.state[c]=b[c]})},a.prototype._defineProps=function(){},a.prototype.render=function(a){},a.prototype.appendElement=function(a,b){var c=this;a&&(c.options.replaceParent?a.replaceWith(c.$element):a.append(c.$element))},a.prototype.setEvents=function(a){},a.prototype.removeEvents=function(){},a.prototype.customOptions=function(a){},a.prototype._initOptions=function(a){var b=this,c={};
// init default options from parent layout ($fieldsOptions)
b.parent&&b.parent.$fieldsOptions&&(b.parent.$fieldsOptions.columns&&(void 0===c.columns&&(c.columns=b.parent.$fieldsOptions.columns),void 0===c.labelCol&&b.parent.$fieldsOptions.labelCol&&(c.labelCol=b.parent.$fieldsOptions.labelCol)),b.parent.$fieldsOptions.titleIsHidden&&void 0===c.titleIsHidden&&(c.titleIsHidden=!0));var d=$.extend({},a,c,b.fieldOptions);return b.parent.$inline&&(d.inline=!0),b.customOptions(d),b.renderOptions=d,d},a.prototype.destroy=function(){var a=this;a.destroyed=!0,a.$schema=null,a.parent=null,a.$element||(a.removeEvents(),a.$element=null),a.$bind&&a.form.unRegisterListenerFor(a.$bind,a),a.useDisplay&&a.form.unRegisterListenerFor(a.$display,a)},a.prototype.showErrors=function(a,b){var d=this,e=b&&b.length,f=c.find(a,d.id+"_errors");f&&(e?(c.text(f,b[0].message),c.removeClass(f,"bs-none")):c.addClass(f,"bs-none"))},a}();b.AbsField=p,b.Utils=o,b.registerControl=k}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/browser.d.ts" />
/// <reference path="../../../core/core.ts" />
...
/// <reference path="../schema.data.ts" />
/// <reference path="../../../core/locale.ts" />
var Phoenix;!function(a){var b;!function(b){var c=b,d=a.utils,e=a.dom,c=b,f=a.ulocale,g=a.Observable.SchemaUtils,h=function(a,b,c,d){c&&d.push(' draggable="true"'),d.push(' data-render="{0}"')},i=function(a,b){var c=e.icon(b?"caret-up":"caret-down");e.addClass(c,"bs-basictable-sort"),e.attr(c,"sort","true"),e.append(a,c)},j=function(a){a.lastElementChild&&"true"===e.attr(a.lastElementChild,"sort")&&e.remove(a.lastElementChild)},k=function(a,b,c,d){if(a.sorting&&b&&b.childElementCount){var f=(d||"").split(" ");f.length||(f=[""]);for(var g=0,h=b.children.length-1;h>g;g++){var k=b.children[g],l=e.attr(k,"colId");f[0]===l?(j(k),i(k,1==f.length)):j(k)}}},l=function(a,b){var c=document.createElement("tr");c.className="bs-table-row-detail",c.id=a+"_detail";var d=document.createElement("td");return d.colSpan=b.childNodes.length,e.append(c,d),c},m=function(a,b){var c=document.createDocumentFragment();return a.forEach(function(a){var b=document.createElement("col");a.options.width&&(b.style.width=a.options.width),a.options.minWidth&&(b.style.minWidth=a.options.minWidth),e.append(c,b)}),c},n=function(a,b,c,d,h,j){var k=document.createDocumentFragment(),l=(j||"").split(" ");return b.forEach(function(a,b){var d,m=document.createElement("th");e.attr(m,"colId",a.$bind),c._useColGrp||(a.options.width&&(m.style.width=a.options.width),a.options.minWidth&&(m.style.minWidth=a.options.minWidth)),d&&(m.className=d.join(" ")),a.isLink||e.append(m,document.createTextNode(f.tt(a.title||String.fromCharCode(160),h))),c.sorting&&g.canSort(a.schema)&&(d=d||[],d.push("bs-cursor-p"),l&&l.length&&l[0]===a.$bind&&i(m,1===j.length)),d&&(m.className=d.join(" ")),e.append(k,m)}),k},o=function(a,b,c,d,f,g,h){var i=document.createDocumentFragment();return b&&b.forEach(function(b,j){e.append(i,p(a,j,b,c,d,f,g,h))}),i},/*
        *  row: {name: fieldName, schema: {}}
        */
p=function(a,b,d,f,g,h,i,j){var k=document.createElement("tr");return"middle"===h.align&&e.addClass(k,"bs-va-middle"),g.forEach(function(a,g){var i=document.createElement("td");if(0==g)e.append(i,document.createTextNode(d.schema.title||String.fromCharCode(160)));else{e.attr(i,"rowId",a.id),e.attr(i,"colId",d.name),i.rowIndex=b,i.colIndex=g-1;var l=f.get(g-1),m=c.Utils.displayValue(l.getRelativeValue(d.name),d.schema,j,{html:!0,useSymbol:!0,editable:d.canEdit,check:d.check,avanced:null,tableOptions:h});if(m.html){var n=$(m.value);e.append(i,n.get(0))}else e.append(i,document.createTextNode(m.value))}e.append(k,i)}),k},q=function(a,b,d,f,h,i,j,k){var l=document.createElement("tr");if(l.id=d.$id,l.className="bs-table-row","middle"===h.align&&e.addClass(l,"bs-va-middle"),!h._useStripedCss){var m=b%2===1;m||e.addClass(l,"even")}return f.forEach(function(a,f){var i=document.createElement("td");0===b&&h.headerIsHidden&&!h._useColGrp&&(a.options.width&&(i.style.width=a.options.width),a.options.minWidth&&(i.style.minWidth=a.options.minWidth));var k=[];a.schema&&g.isNumber(a.schema)&&k.push("nowrap"),a.options.align&&("center"==a.options.align?k.push("align-center"):"right"==a.options.align&&k.push("align-end")),k.length&&(i.className=k.join(" ")),e.attr(i,"colId",a.$bind);var m=d.getRelativeState(a.$bind);if(m.isHidden);else if(a.isLink){var n=void 0,o=void 0;if(a.options.button){var p="";n=document.createElement("button"),n.type="button",m.isDisabled&&(n.disabled=!0);var q="normal"===a.options.size?"":" btn-"+(h.size||"sm");if(n.className="bs-button btn btn-"+(a.options.type||"link")+q+(m.isDisabled?" disabled":""),a.options.icon&&(o=document.createElement("span"),o.className=e.iconClass(a.options.icon),e.append(n,o),p=" "),a.schema.title){var r=document.createTextNode(p+a.schema.title);e.append(n,r)}}else if(a.options.icon){n=document.createElement("center"),m.isDisabled&&e.addClass(n,"bs-disabled"),o=document.createElement("span");var s=["text-"+(a.options.type||"default")];s.push("bs-basictable-btn"),s.push(e.iconClass(a.options.icon)),o.className=s.join(" "),e.append(n,o)}n&&(n.$link=a.$bind,e.append(i,n))}else{var t=i,u=a.options||{},v=u.editable&&!m.isDisabled&&!m.isReadOnly,w=c.Utils.displayValue(d.getRelativeValue(a.$bind),a.schema,j,{html:!0,useSymbol:!1,selectable:u.selectable,editable:v,check:u.check,avanced:u,tableOptions:h});if(w.html){var x=$(w.value);e.append(t,x.get(0))}else e.append(t,document.createTextNode(w.value))}e.append(l,i)}),l},r=function(a,b,c,d,f,g){var h=document.createDocumentFragment();return b&&b.forEach(function(b,i){var j=i%2===1;e.append(h,q(a,i,b,c,d,f,g,j))}),h},s=function(a){for(var b=!0,c=0,d=a.length;d>c;c++){var e=a[c];if(e.options.editable&&!g.isBoolean(e.schema)){b=!1;break}}return b},t=function(a,b){
// all columns have width defined (but not minWidth)
for(var c=!0,d=0,e=b.length;e>d;d++){var f=b[d];if(!f.options.width||f.options.minWidth){c=!1;break}}if(c=c&&"auto"!==a.width,!c){var g=a.scrolling&&a.scrolling.vertical;if(g)throw"To support scrolling vertical, all columns must have explicit widths but not explicit minWidth.";if(a.editing&&!s(b))throw"To support inline editing, all columns must have explicit widths but not explicit minWidth."}return c},u=function(a,b){var c=["table"];
//adde
//remove 
...
//    css.push('nowrap');
//}
return b&&c.push("table-header"),!b&&a._useStripedCss&&c.push("table-striped"),a._useColGrp&&c.push("bs-fixed"),b||!a.editing&&!a.nowrap||c.push("nowrap"),c.push("bs-theme"),a.border&&c.push("table-bordered"),a.small&&c.push("bs-style-small-table"),c},v=function(a,b){var c=[];return a.width&&"auto"!==a.width&&c.push("min-width: "+a.width),c},w=function(a,b,c){var d=b.scrolling&&b.scrolling.vertical,e=u(b,c);a.push("<table"),e.length&&a.push(' class="'+e.join(" ")+'"'),a.push(' id="{0}_table'),c&&a.push("_header"),a.push('"');var f=v(b,c);f.length&&a.push(' style="'+f.join(";")+'"'),a.push(">"),
//if (options.description) {
//    html.push("<caption>");
//    _ui.Utils.addTooltip(html, options.description, options);
//    html.push("</caption>");
//}
b._useColGrp&&a.push('<colgroup id="{0}_colgrp'+(c?"_header":"")+'"></colgroup>'),b.headerIsHidden||(c?a.push('<thead><tr id="{0}_cols"></tr></thead>'):d||a.push('<thead><tr id="{0}_cols"></tr></thead>')),c||(a.push('<tbody id="{0}_rows">'),a.push("</tbody>")),a.push("</table>")},x=function(a,b,f,g,i,j){g=g||"",b._useColGrp=t(b,j),b._useStripedCss=!(b.rows&&b.rows.detail),b=$.extend({right:!1,icon:null,type:"default",width:"auto",height:"auto",size:null,scrolling:{horizontal:!1}},b),void 0!==b.title&&(g=b.title);var k=[],l=["bs-field-group bs-island"];k.push('<div id="{0}" '),k.push(' class="'),f&&l.push("design"),k.push(l.join(" ")),k.push('"'),h(a,b,f,k),k.push(">"),
//create header div
k.push('<div id="{0}_header"></div>'),l=["bs-basictable-group"];var m=b.scrolling&&b.scrolling.horizontal,n=b.scrolling&&b.scrolling.vertical;
//create div table container
if(m&&!n&&l.push("bs-scroll-x"),k.push('<div id="{0}_focus" class="'),k.push(l.join(" ")),k.push('"'),b.selecting&&(b.selecting.cell||b.selecting.row)&&k.push(' tabindex="0" '),k.push(">"),n&&!b.headerIsHidden&&(k.push('<div id="{0}_table_header" class="bs-table-header" style="padding-right:'),k.push(e.scrollbar()),k.push('px;">'),k.push('<div id="{0}_table_header_content" class="bs-table-header-content">'),w(k,b,!0),k.push("</div></div>")),n){var o=[];k.push('<div  class="bs-table-content-scroll"'),k.push(">")}if(l=["bs-table-content"],n&&l.push("vscroll"),k.push('<div id="{0}_masterscroll" class="'+l.join(" ")+'"'),n){var o=[];if(!b.height||"auto"===b.height)throw"To support scrolling vertical, the grid must have an explicit height.";o.push("height: "+b.height),o.length&&k.push(' style="'+o.join(";")+'"')}
// create table
return k.push(">"),w(k,b,!1),k.push("</div>"),n&&k.push("</div>"),k.push("</div>"),k.push('<center id="{0}_pagination"></center>'),c.Utils.addErrorDiv(k),k.push("</div>"),d.format(k.join(""),a)},y=function(a,b,c,e,f,g,h,i){var j=e.filter?h.schema.filters[e.filter]||[]:h.schema["enum"],k=j.indexOf(c);0>k?(d.nextTick(function(){g.item.setValue(h.$bind,j[0])}),a.input.selectedIndex=0):a.input.selectedIndex=k},z=function(a,b,c,d,e,f,h,i){if(h.schema["enum"])return y(a,b,c,d,e,f,h,i);var j=!1;g.isNumber(h.schema)&&i.nativeNumber?j=!0:b=b||"",a.input.value=j?c:b},A=function(a,b,f,g,h,i,j){var k=document.createElement("select");k.type="text";var l=["bs-inplace-edit bs-inplace-edit-size"];k.className=l.join(" ");var m=f.filter?i.schema.filters[f.filter]||[]:i.schema["enum"],n=m.indexOf(b);return c.Utils.fillSelect(m,k,i.schema),e.empty(g),e.addClass(g,"focused"),e.append(g,k),0>n?(d.nextTick(function(){h.item.setValue(i.$bind,m[0])}),k.selectedIndex=0):k.selectedIndex=n,{input:k,parent:k,td:g,isInputElement:!0,canSelect:!1,schema:i.schema}},B=function(a,b,c,d,f,g,h){var i=document.createElement("span");i.className="bs-inplace-parent ";var j=!0,k=i;j&&(k=document.createElement("div"),k.className="bs-input-group",i.appendChild(k));var l=document.createElement("input");l.type="text";var m=["bs-inplace-edit bs-inplace-edit-size"];if(j&&m.push("bs-input-group-main"),l.className=m.join(" "),e.append(k,l),j){var n=document.createElement("span");n.tabIndex=-1,n.className="bs-input-group-addon bs-cursor-d";var o=document.createElement("span");o.className=e.iconClass("calendar"),e.append(n,o),e.append(k,n)}return e.empty(d),e.addClass(d,"focused"),e.append(d,i),{input:l,parent:i,td:d,isInputElement:!0,canSelect:!0,schema:g.schema}},C=function(a,b,c,d,f,h,i){if(h.schema["enum"])return A(a,b,c,d,f,h,i);if("boolean"===h.schema.type)return{input:null,parent:null,td:d,isInputElement:!1,canSelect:!1,schema:h.schema};if(g.isDate(h.schema)&&!i.nativeDate)return B(a,b,c,d,f,h,i);var j=document.createElement("input"),k=!1;g.isNumber(h.schema)&&i.nativeNumber?(k=!0,b=b||0,j.type="number"):j.type="text";var l=["bs-inplace-edit bs-inplace-edit-size"];return h.options.align&&("center"===h.options.align?l.push("align-center"):"right"===h.options.align&&l.push("align-end")),"text"===j.type&&h.schema.maxLength&&(j.maxLength=h.schema.maxLength),j.className=l.join(" "),e.empty(d),e.addClass(d,"focused"),e.append(d,j),j.value=k?b:a,{input:j,parent:j,td:d,isInputElement:!0,canSelect:!0,schema:h.schema}},D={createCols:n,createColGroup:m,updSorting:k,gridContainer:x,createRows:r,createRow:q,createGridRows:o,createInplaceEdit:C,updateInplaceEdit:z,createDetail:l};b.GridUtil=D}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/browser.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="../../../core/locale.ts" />
/// <reference path="./absfield.control.ts" />
...
var Phoenix;!function(a){var b;!function(b){var c=b,d=(a.utils,a.dom),c=b,e=a.ulocale,f=c.GridUtil,g=a.Observable.errorsUtils,h=a.link,i=a.locale,j=a.Observable.SchemaUtils,k=function(a,b){return b===d.keys.VK_TAB&&a.shiftKey?!1:a.altKey||a.ctrlKey||a.metaKey||a.shiftKey};b.glbGridFilter=null;var l=function(a){function l(b,c,d){a.call(this,b,c,d);var e=this;d.registerListenerFor(e.$bind+".$item",e),e._state(),e.columns=e._initCols(b.options||{}),e._mapCols={},e._details=[],e.columns.forEach(function(a,b){e._mapCols[a.$bind]={column:a,index:b}})}return __extends(l,a),l.prototype._inplaceEditValue2Model=function(a,b,c){var d=j.text2Value(a,c.schema),e=b.getValue(c.$bind);return d!==e?(b.setValue(c.$bind,d),!0):!1},l.prototype._inplaceEditAcceptKeys=function(a){var b=this;return!b.inplace.schema["enum"]||a!==d.keys.VK_UP&&a!==d.keys.VK_DOWN},l.prototype._inplaceEditAddEvents=function(){var a=this;a.inplace.schema["enum"]&&$(a.inplace.input).on("change",function(b){var c=a.inplace.td,d=a._td2value(c),e=a._inplaceEditGetValue(d);a._inplaceEditValue2Model(e,d.item,d.col)||a._modifyCell(d.item,d.col.$bind,c)})},l.prototype._inplaceEditRemoveEvents=function(){var a=this;a.inplace.schema["enum"]&&$(a.inplace.input).off("change")},l.prototype._inplaceEditGetValue=function(a){var b=this;if(b.inplace.schema["enum"]){if(!a.item)return null;var c=b.inplace.input.selectedIndex,d=a.item.getState(a.col.$bind);return d.filter?b.inplace.schema.filters[d.filter][c]:b.inplace.schema["enum"][c]}return b.inplace.input.value},l.prototype._inpaceEditShow=function(a,b){var e=this,g=e._td2value(a),h=g.item.getValue(g.col.$bind),i=g.item.getState(g.col.$bind),k=j.value2Text(h,g.col.schema);a.tabIndex=-1;var l={nativeNumber:c.Utils.nativeNumber(),nativeDate:c.Utils.nativeDate()};e.inplace=f.createInplaceEdit(k,h,i,a,g,g.col,l),e._inplaceEditAddEvents(),e.inplace.isInputElement?(e.inplace.input.tabIndex=0,e.inplace.input.focus(),e.inplace.canSelect&&d.select(e.inplace.input)):(
// focus on td ?
a.tabIndex=0,a.focus())},l.prototype._inplaceEditRemove=function(a,b){var c=this;if(c.inplace&&!b){var e=c.inplace.td;a&&(e.tabIndex=0);var f=c._td2value(e);c._inplaceEditRemoveEvents(),c.inplace.parent&&d.remove(c.inplace.parent),d.removeClass(e,"focused");var g=!!c.inplace.input;if(g){var h=c._inplaceEditGetValue(f);if(c.inplace=null,!f.item)return;c._inplaceEditValue2Model(h+"",f.item,f.col)||c._modifyCell(f.item,f.col.$bind,e)}}c.inplace=null},l.prototype._inplaceEditModel2Control=function(a,b,d){var e=this,g=e._td2value(d),h=(e._inplaceEditGetValue(g),a.getValue(g.col.$bind)),i=a.getState(g.col.$bind),k=j.value2Text(h,g.col.schema),l={nativeNumber:c.Utils.nativeNumber(),nativeDate:c.Utils.nativeDate()};f.updateInplaceEdit(e.inplace,k,h,i,d,g,g.col,l)},l.prototype.removeEvents=function(){var a=this;a.scrollableMaster&&$(a.scrollableMaster).off("scroll"),a.scrollableMaster=null,a.scrollableHeaderOfMaster=null},l.prototype.setEvents=function(a){var b=this,c=a.scrolling&&a.scrolling.vertical;if(c&&!a.headerIsHidden){var e=b.$element.get(0);b.scrollableMaster=d.find(e,b.id+"_masterscroll"),b.scrollableHeaderOfMaster=d.find(e,b.id+"_table_header_content"),b.scrollableMaster&&b.scrollableHeaderOfMaster&&$(b.scrollableMaster).on("scroll",b._hscroll.bind(b))}},l.prototype.destroy=function(){var b=this;b._destroyDetails(),b.columns&&(b.columns.forEach(function(a){a.schema=null}),b.columns=null),b.form.unRegisterListenerFor(b.$bind+".$item",b),b._inplaceEditRemove(!1,!0),b._pager&&(b._pager.destroy(),b._pager=null),b._details=null,b._mapCols=null,a.prototype.destroy.call(this)},l.prototype._moveToPage=function(a){var b=this;b.state.value.currentPage(a)},l.prototype._onselectPage=function(a){var b=this;switch(a){case"next":b._moveToPage(Math.min(b._pager.props.totalPages,b._pager.props.currentPage+1));break;case"prev":b._moveToPage(Math.max(0,b._pager.props.currentPage-1));break;case"first":b._moveToPage(1);break;case"last":b._moveToPage(b._pager.props.totalPages);break;default:b._moveToPage(a)}},l.prototype._onSelectToolElement=function(a){var c=this,d=a.name||a.id;return"filter"===a.name&&b.glbGridFilter?b.glbGridFilter(c.filtrableColumns(),c.state.value,c.form.$locale):void c.form.execAction(c.$bind+".$toolbar."+d,a)},l.prototype._state=function(){a.prototype._state.call(this);var b=this;if(b.state.value.isQueryable()){
// create pager
var d=$.extend({size:"default",selectPage:b._onselectPage.bind(b)},b.renderOptions.pager||{});b._pager=new c.Pager(d);var e=b._pager;e.props.totalPages=b.state.value.totalPages(),e.props.currentPage=b.state.value.currentPage()}var f=[];if(b.renderOptions.toolbar&&b.renderOptions.toolbar.items){var g=$.extend(!0,{},b.renderOptions.toolbar);g.items.forEach(function(a){"count"===a.type&&(a=$.extend({name:"count",right:!0,value:b.state.value.totalCount()},a)),"filter"===a.type&&(a=$.extend({name:"filter",value:b.state.value.filter||"",icon:"filter"},a)),f.push(a)})}if(f.length){var d=$.extend({selectToolElement:b._onSelectToolElement.bind(b)});b._toolBar=new c.ToolBar(f,d)}},l.prototype._destroyDetails=function(){
//Destroy all inline "forms" 
var a=this;if(a._details){var b=c.formManager();a._details.forEach(function(a){var c=b.formByName(a);c&&c.destroy()}),a._details=[]}},l.prototype._destroyDetailById=function(a){var b=this,d=b._details.indexOf(a);d>=0&&b._details.splice(d,1);var e=c.formManager().formByName(a);e&&e.destroy()},l.prototype._initCols=function(a){var b=this;return a.columns&&a.columns.length||(a.columns=[{$bind:"$index",title:"#",schema:{type:"integer"}}]),a.columns.map(function(a){var c=$.extend({},a);return c.options=c.options||{},c.schema?c:(c.schema=j.getSchema(a.$bind,b.$schema.items),c.title=e.tt(c.options.title||c.schema.title,b.form.$locale),j.isLink(a.$bind)&&(c.isLink=!0),c)})},l.prototype._colByField=function(a){var b=this._mapCols[a];return b?b.column:null},l.prototype.changed=function(a,b,c,d,e){var f=this,g=!1;switch(d){case"count":if(a===e.propName){var h=f._toolBar;h&&h.setValue&&h.setValue("count",f.state.value.totalCount())}break;case"filter":if(a===e.propName){var h=f._toolBar;h&&h.setValue&&h.setValue("filter",f.state.value.filter.title)}break;case"pagination":if(a===e.propName){var i=f._pager;i&&(i.props.totalPages=f.state.value.totalPages(),i.props.currentPage=f.state.value.currentPage())}break;case"sorting":a===e.propName&&f._updateSorting();break;case"set":case"propchange":a===e.propName&&f._renderRows();break;case"add":f._createRow(e.$id),g=!0;break;case"remove":f._removeRow(e.$id),g=!0;break;case"upd":if(a===e.propName){var j=e&&e.$id?f.state.value.findById(e.$id):null;j&&f._modifyCell(j,e.property)}}g&&f._updOddEven()},l.prototype._modifyTD=function(a,b,e){var f=this,g=f._colByField(b),h=a.getState(b),i=g.options||{},j=i.editable&&!h.isDisabled&&!h.isReadOnly,k=c.Utils.displayValue(a.getValue(b),g.schema,f.form.$locale,{html:!0,useSymbol:!1,editable:j,selectable:i.selectable,check:i.check,avanced:i,tableOptions:f.config.options});if(d.empty(e),k.html){var l=$(k.value);d.append(e,l.get(0))}else d.append(e,document.createTextNode(k.value))},l.prototype._modifyCell=function(a,b,c){var e=this;if(e.$element){if(c)return e.inplace&&e.inplace.input&&e.inplace.td===c?void e._inplaceEditModel2Control(a,b,c):e._modifyTD(a,b,c);var f=e._colByField(b);if(f){var g=d.find(e.$element.get(0),a.$id);if(g)for(var h=0,i=g.childNodes.length;i>h;h++){var j=g.childNodes[h],k=d.attr(j,"colid");if(k===b){if(e.inplace&&e.inplace.input&&e.inplace.td===j)return void e._inplaceEditModel2Control(a,b,j);e._modifyTD(a,b,j)}}}}},l.prototype._grid=function(){return this.$element.get(0)},l.prototype._gridParentFocus=function(){var a=this;return d.find(a.$element.get(0),a.id+"_focus")},l.prototype._setErrors=function(a,b){var c=this,d=c.state.errors;c.showErrors(b,d)},l.prototype.focusIn=function(a){var b=this;if(b.$element){var c=d.find(b.$element.get(0),b.id+"_table");if(c&&d.addClass(c,"focused"),b.selectedCell){var e=b._cell(b.selectedCell,!0),f=b.canEdit(b.selectedCell);f&&!b.inplace&&b._inpaceEditShow(e.td,!0)}else b._inplaceEditRemove(!1,!1)}},l.prototype.focusOut=function(a){var b=this;if(b.$element){var c=d.find(b.$element.get(0),b.id+"_table");c&&d.removeClass(c,"focused"),b._inplaceEditRemove(!0,!1)}},l.prototype._doTab=function(a){var b=this;return a?b._moveDownSelectedCell(1):b._moveUpSelectedCell(1)},l.prototype.keypress=function(a){var b=this;if(b.selectedCell&&b.inplace&&d.isChildOf(b.inplace.td,a.target)){var e=b._td2value(b.inplace.td);if(j.isNumber(b.inplace.schema)){if(c.Utils.keyPressNumber(a)===!1)return!1}else if(j.isBoolean(b.inplace.schema)){if(" "===String.fromCharCode(a.which)&&b.fieldOptions.editing){var f=e.item.getRelativeState(e.col.$bind);if(!f.isDisabled&&!f.isReadOnly){var g=e.item.getValue(e.col.$bind);e.item.setValue(e.col.$bind,!g)}}a.preventDefault()}}},l.prototype.keydown=function(a){var b=this,c=a.which||a.keyCode,e=!1;if(!k(a,c)&&(!b.inplace||!d.isChildOf(b.inplace.td,a.target)||b._inplaceEditAcceptKeys(c))){if(b.fieldOptions.selecting&&b.fieldOptions.selecting.cell)switch(c){case d.keys.VK_TAB:e=b._doTab(!a.shiftKey);break;case d.keys.VK_UP:e=b._moveUpSelectedCell(1);break;case d.keys.VK_DOWN:e=b._moveDownSelectedCell(1)}e&&a.preventDefault()&&a.stopPropagation()}},l.prototype._td2cell=function(a){var b=this,c=a.parentNode,e=(c.parentNode,b.state.value.findById(c.id)),f=b._colByField(d.attr(a,"colid"));return e&&f?{row:c.id,col:d.attr(a,"colid")}:null},l.prototype._td2value=function(a){var b=this,c=a.parentNode,e=(c.parentNode,b.state.value.findById(c.id)),f=b._colByField(d.attr(a,"colid"));return{item:e,col:f}},l.prototype.mousedown=function(a){var b=this,c=d.parentByTag(b.$element.get(0),a.target,"td");if(c){var e=b._td2cell(c);e&&b._selectCell(e,a,!0)&&a.preventDefault()}return!0},l.prototype.click=function(a){var b=this,c=d.parentByTag(b.$element.get(0),a.target,"td");if(c){var e=b._td2cell(c);if(e){
//that._selectCell(cell, event, false);
var f=b.state.value.findById(e.row),g=b._colByField(e.col);if(f){var i=a&&a.target&&a.target.$link||a.target.parentNode.$link;if(i){var k=f.getRelativeState(g.$bind);if(k.isDisabled||k.isHidden)return;g.schema.$widgetAction?b[g.schema.$widgetAction]&&b[g.schema.$widgetAction](f):b.form.execAction(b.$bind+".$item."+i,f)}else if(g){if(g.options.$link){var l=d.findByAttribute(a.target,c,"data-phoenix-href");if(l){var m=f.getRelativeState(g.$bind);m.isDisabled||h.execLink(g.options.$link,{$item:f},null)}}if(b.fieldOptions.editing&&g.options.editable&&j.isBoolean(g.schema)&&d.attr(a.target,"data-clickable")){var m=f.getRelativeState(g.$bind);if(!m.isDisabled&&!m.isReadOnly){var n=f.getValue(g.$bind);f.setValue(g.$bind,!n)}}}}}}else{var o=d.parentByTag(b.$element.get(0),a.target,"th");if(o){var p=d.attr(o,"colid");if(p){var q=b._colByField(p);if(q&&j.canSort(q.schema)){var r=q.$bind,s=b.state.value.$orderby();s===q.$bind&&(r=q.$bind+" desc"),b.state.value.$orderby(r)}}}}},l.prototype._setDisabled=function(a,b){var c=this;a.disabled=c.state.isDisabled},l.prototype._showSelected=function(a,b,c,e){var f=this;if(!a)return null;var g=f._cell(a,!1);g.td&&(b?(d.addClass(g.td,"bs-cell-selected"),f._inplaceEditRemove(!1,!1),c&&(f.focused||e)?f._inpaceEditShow(g.td,!1):(g.td.tabIndex=0,g.td.focus())):(d.removeClass(g.td,"bs-cell-selected"),g.td.tabIndex=-1))},l.prototype.canSelect=function(a){var b=this,c=b.selectedCell;if(c&&c.col===a.col&&c.row===a.row)return!1;if(!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var d=b._colByField(a.col);return d&&d.options.selectable},l.prototype.canEdit=function(a){var b=this;if(!b.fieldOptions.editing||!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var c=b._colByField(a.col),d=c&&c.options.editable;if(d){var e=b.state.value.findById(a.row),f=e.getState(c.$bind);return!f.isReadOnly&&!f.isDisabled}return d},l.prototype.clearSelected=function(){var a=this,b=a.selectedCell;a.selectedCell=null,b&&a._showSelected(b,!1,!0,!1),a._gridParentFocus().tabIndex=0},l.prototype._selectCell=function(a,b,c){var d=this;if(!d.canSelect(a))return!1;var e=d.selectedCell,f=d.canEdit(a);return d._showSelected(a,!0,f,c),e?d._showSelected(e,!1,!0,c):d._gridParentFocus().tabIndex=-1,d.selectedCell=a,!0},l.prototype._selectFirstCell=function(){var a=this;if(!a.fieldOptions.selecting||!a.fieldOptions.selecting.cell)return!1;var b=d.find(a.$element.get(0),a.id+"_rows");if(!b.childNodes.length)return!1;for(var c=null,e=0,f=a.columns.length;f>e;e++){var g=a.columns[e];if(g.options.selectable){var h=b.firstChild;c={col:g.$bind,row:h.id};break}}return c?a._selectCell(c,null,!1):!1},l.prototype._cell=function(a,b){var c=this,e=d.find(c.$element.get(0),a.row),f=c._mapCols[a.col].index,g=e.childNodes[f],h={td:g,tr:e,rIndex:-1,cIndex:-1};return b&&(h.rIndex=d.indexOf(e.parentNode,e),h.cIndex=f),h},l.prototype._moveUpSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._cell(b.selectedCell,!0),e=Math.max(c.rIndex-a,0);if(e!=c.rIndex){var f=d.find(b.$element.get(0),b.id+"_rows");return b._selectCell({row:f.childNodes[e].id,col:b.selectedCell.col},null,!1)}return!1},l.prototype._hscroll=function(a){var b=this,c=b.scrollableMaster.scrollLeft,d=b.scrollableHeaderOfMaster.scrollLeft;c!==d&&(b.scrollableHeaderOfMaster.scrollLeft=c)},l.prototype._moveDownSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._cell(b.selectedCell,!0),e=d.find(b.$element.get(0),b.id+"_rows"),f=Math.min(c.rIndex+a,e.childNodes.length-1);return f!=c.rIndex?b._selectCell({row:e.childNodes[f].id,col:b.selectedCell.col},null,!1):!1},l.prototype._moveLeftSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},l.prototype._moveRightSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},l.prototype._state2UI=function(){var a=this,b=a._grid(),c=a.$element?a.$element.get(0):null;if(b){if(a._setDisabled(b,c),a.setHidden(c),a._setErrors(b,c),a._selectFirstCell(),a._toolBar){var e=$(d.find(c,a.id+"_header"));a._toolBar.render(e)}if(a._pager){var f=$(d.find(c,a.id+"_pagination"));a._pager.render(f)}}},l.prototype.stateChanged=function(a,b){var c=this,d=c.form.getState(c.$bind),e=c._grid(),f=c.$element?c.$element.get(0):null;a&&"isHidden"!==a||d.isHidden!==c.state.isHidden&&(c.state.isHidden=d.isHidden,e&&c.setHidden(f)),a&&"isDisabled"!==a||d.isDisabled!=c.state.isDisabled&&(c.state.isDisabled=d.isDisabled,e&&c._setDisabled(e,f)),a&&"errors"!==a||g.errorChanged(c.state.errors,d.errors)&&(c.state.errors=d.errors,c._setErrors(e,f))},l.prototype.stopProppagation=function(a){for(var b=this,c=a.target,d=b.$element.get(0);c;){if(c==d)return;c.href&&(a.preventDefault(),a.stopPropagation()),c=c.parentNode}},l.prototype._renderRows=function(){var a=this;if(a.$element){var b=d.find(a.$element.get(0),a.id+"_rows");a._destroyDetails();var c=f.createRows(a.id,a.state.value,a.columns,a.renderOptions,a.options.design,a.form.$locale);d.empty(b),d.append(b,c)}},l.prototype.editDetail=function(a){var b=this,e=a.$id;if(b.$element){var g=d.find(b.$element.get(0),b.id+"_rows"),h=d.find(g,e+"_detail");if(h)return;var j=d.find(g,e);if(j){h=f.createDetail(e,j);
// prepare layout
var k=b.renderOptions.rows;if(!k||!k.detail||!k.detail.layout)throw new Error('Grid options missing: "options.rows.detail.layout".');var l=k.detail.layout;"string"==typeof l&&b.renderOptions.layouts&&b.renderOptions.layouts[l]&&(l=b.renderOptions.layouts[l]),"object"==typeof l&&(l=$.extend(!0,{},l),l.name&&(l._name=l.name),l.name=e);
// prepare schema
var m=a.getSchema();"object"==typeof m&&(m.links=m.links||{},m.links.$updateChanges=m.links.$updateChanges||{title:i.ui.ApplyDetailChanges});var n={};k.detail.spacing&&(n.verticalSpacing=!0),n.closeButtonHandler=function(){b.closeDetail(e)},l._name&&(n.externalLayout=l._name,n.externalSchema=b.form.options.externalSchema,n.externalLocale=b.form.options.externalLocale),n.path=b.$bind,b._details.push(e),c.OpenForm($(h.firstChild),l,b.form.$schema,a.model(),b.form.$locale,function(c,d,f){switch(c.property){case"$links.$updateChanges":if(!b.state.value.updateItem(a,d))return;a.update(d.model()),b.closeDetail(e)}},n),d.after(j,h)}}},l.prototype.closeDetail=function(a){var b=this;if(b._destroyDetailById(a),b.$element){var c=d.find(b.$element.get(0),a+"_detail");c&&d.remove(c)}},l.prototype._removeRow=function(a){var b=this;if(b._destroyDetailById(a),b.$element){var c=d.find(b.$element.get(0),a);if(!c)return;var e=c.parentNode,f=d.find(e,a+"_detail");if(f&&d.remove(f),e.firstChild===c&&b.renderOptions.headerIsHidden&&!b.renderOptions._useColGrp&&e.childNodes.length>1){
//no header &&  not useColGrp ==> update cols width on first row
var g=e.childNodes[1];b.columns.forEach(function(a,b){var c=g.childNodes[b];a.options.width&&(c.style.width=a.options.width),a.options.minWidth&&(c.style.minWidth=a.options.minWidth)})}d.remove(c)}},l.prototype._updOddEven=function(){var a=this;if(!a.renderOptions._useStripedCss&&a.$element){var b=d.find(a.$element.get(0),a.id+"_rows");if(b.childNodes.length)for(var c=!1,e=0,f=b.childNodes.length;f>e;e++){var g=b.childNodes[e];d.hasClass(g,"bs-table-row")&&(c?d.removeClass(g,"even"):d.addClass(g,"even"),c=!c)}}},l.prototype._createRow=function(a){var b=this;if(b.$element){var c=d.find(b.$element.get(0),b.id+"_rows"),e=b.state.value.findById(a),g=b.state.value.indexOf(e),h=f.createRow(b.id,g,e,b.columns,b.renderOptions,b.options.design,b.form.$locale,c.childNodes.length%2===1);d.append(c,h)}},l.prototype.filtrableColumns=function(){var a=this,b=a.$schema;return b&&"array"===b.type&&b.items&&"object"===b.items.type?j.filtrableFields(b.items,a.form.$locale):[]},l.prototype._updateSorting=function(){var a=this,b=a.renderOptions;if(b&&b.sorting&&!b.headerIsHidden){var c=d.find(a.$element.get(0),a.id+"_cols");c&&f.updSorting(b,c,a._colByField,a.state.value.$orderby())}},l.prototype.render=function(a){var b=this,g=b._initOptions(c.Utils.defaultOptions);if(!b.$element){if(b.$schema.description&&(g.description=e.tt(b.$schema.description,b.form.$locale)),b.$element=$(f.gridContainer(b.id,g,b.options.design,b.$schema.title,b.form.$locale,b.columns)),g._useColGrp){var h=g.scrolling&&g.scrolling.vertical,i=h&&!g.headerIsHidden?d.find(b.$element.get(0),b.id+"_colgrp_header"):null;i&&d.append(i,f.createColGroup(b.columns,g)),i=d.find(b.$element.get(0),b.id+"_colgrp"),d.append(i,f.createColGroup(b.columns,g))}if(!g.headerIsHidden){var j=d.find(b.$element.get(0),b.id+"_cols");d.append(j,f.createCols(b.id,b.columns,g,b.options.design,b.form.$locale,b.state.value.$orderby()))}b._renderRows(),b._state2UI(),b.setEvents(g)}return b.appendElement(a,g),b.$element},l}(b.AbsField);b.BasicGrid=l,c.registerControl(l,"array",!1,"",null),c.registerControl(l,"array",!1,"basicgrid",null)}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/browser.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="./absfield.control.ts" />

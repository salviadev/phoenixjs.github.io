...
//    css.push('nowrap');
//}
return b&&d.push("table-header"),!b&&a._useStripedCss&&d.push("table-striped"),a._useColGrp&&d.push("bs-fixed"),b||!a.editing&&!a.nowrap?!b&&a.allowFrozenColumns&&d.push("nowrap"):d.push("nowrap"),d.push("bs-theme"),a.border&&d.push("table-bordered"),a.small&&d.push("bs-style-small-table"),d},w=function(a,b,c){var d=[];return c?d:(a.width&&"auto"!==a.width&&d.push("min-width: "+l(a.width)),d)},x=function(a,b,c,d){var e=b.scrolling&&b.scrolling.vertical,f=v(b,c,d);a.push("<table"),f.length&&a.push(' class="'+f.join(" ")+'"'),a.push(' id="{0}_table'),d&&a.push("_frozen"),c&&a.push("_header"),a.push('"');var g=w(b,c,d);g.length&&a.push(' style="'+g.join(";")+'"'),a.push(">"),
//if (options.description) {
//    html.push("<caption>");
//    _ui.Utils.addTooltip(html, options.description, options);
//    html.push("</caption>");
//}
b._useColGrp&&a.push('<colgroup id="{0}_colgrp'+(d?"_frozen":"")+(c?"_header":"")+'"></colgroup>'),b.headerIsHidden||(c?a.push('<thead><tr id="{0}'+(d?"_frozen":"")+'_cols"></tr></thead>'):e||a.push('<thead><tr id="{0}NaN')),c||(a.push('<tbody id="{0}'),d&&a.push("_frozen"),a.push('_rows"></tbody>')),a.push("</table>")},y=function(a){var b=0;return a.forEach(function(a){b+=parseInt(a.options.width+"",10)}),b},z=function(a,b,f,g,i,j,k){g=g||"",b._useColGrp=u(b,j),b._useStripedCss=!(b.rows&&b.rows.detail),b=$.extend({right:!1,icon:null,type:"default",width:"auto",height:"auto",size:null,scrolling:{horizontal:!1}},b),void 0!==b.title&&(g=b.title);var l=[],m=["bs-field-group bs-island"];l.push('<div id="{0}" '),l.push(' class="'),f&&m.push("design"),l.push(m.join(" ")),l.push('"'),h(a,b,f,l),l.push(">"),
//create header div
l.push('<div id="{0}_header"></div>'),m=["bs-basictable-group"];var n=b.scrolling&&b.scrolling.horizontal,o=b.scrolling&&b.scrolling.vertical;if(n&&!o&&m.push("bs-scroll-x"),l.push('<div id="{0}_focus" class="'),l.push(m.join(" ")),l.push('"'),b.selecting&&(b.selecting.cell||b.selecting.row)&&l.push(' tabindex="0" '),l.push(">"),b.allowFrozenColumns){l.push('<div class="bs-table-cols">');var p=y(k);if(l.push('<div class="bs-table-frozen-cols" style="width:'+p+'px;">'),o&&!b.headerIsHidden&&(
// parent of frozen header table
l.push('<div id="{0}_table_frozen_header" class="bs-table-header">'),
// frozen header table 
x(l,b,!0,!0),l.push("</div>")),m=["bs-table-content-scroll frozen"],l.push('<div  class="'+m.join(" ")+'">'),m=["bs-table-content frozen"],l.push('<div id="{0}_frozen_scroll" class="'+m.join(" ")+'"'),o){var q=[];if(!b.height||"auto"===b.height)throw"To support scrolling vertical, the grid must have an explicit height.";q.push("height: "+parseInt(b.height+"",10)+"px"),q.length&&l.push(' style="'+q.join(";")+'"')}l.push(">"),l.push('<div  class="'+m.join(" ")+'">'),x(l,b,!1,!0),l.push("</div>"),l.push("</div>"),l.push("</div>"),l.push("</div>"),// bs-table-frozen-cols
l.push('<div class="bs-table-cols-sep"></div>'),l.push('<div class="bs-table-free-cols">')}if(o&&!b.headerIsHidden&&(l.push('<div id="{0}_table_header" class="bs-table-header" style="padding-right:'),l.push(e.scrollbar()),l.push('px;">'),l.push('<div id="{0}_table_header_content" class="bs-table-header-content">'),x(l,b,!0,!1),l.push("</div></div>")),

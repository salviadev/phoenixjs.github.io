...
/// <reference path="./schema.data.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a){return"on"+a.charAt(0).toUpperCase()+a.slice(1)}var d=a.ajax,e=a.utils,f=a.application,g=a.Observable.SchemaUtils,h=a.external,i=function(a){function c(c,d,e,f,g,h){a.call(this,c,g);var i=this,j=c.opts?c.opts:{};c.validators&&(j.validators=c.validators,delete c.validators),i.render=new b.Form(d,j,f,e,g,h),i.render.$locale=g}return __extends(c,a),c.prototype.on=function(a){var b=this,c=function(c,d,e){return a(b,c,d,e)};this._clickHnd=function(a){b.render.afterchanged(a,"modal-action",{})},b.render.on(c)},c}(b.Modal);b.ModalForm=i;var j=function(a,b,c){g.loadSchemaRefs(b.schema,b.data,b.layout,function(d){var e=new i(a,b.layout,b.schema,d,b.locale,b.preferences);e.open(),c&&e.on(c)})},k=function(a,b){return a&&f.name?f.name+"_form_"+a:""},l=function(a,b,c,g,i,j){var l=0,m=-1,n=-1,o=[],p={locale:g},q=-1,r=-1,s=f.config(f.name);i=i||{},g&&g.$name&&(i.externalLocale=g.$name),c&&c.then?(o.push(c),q=0,l++):p.data=$.extend(!0,{},c);var t;"object"==typeof a?(p.layout=$.extend(!0,{},a),t=p.layout.name):(m=l,l++,i.externalLayout=a,t=a,o.push(d.get(s.forms+"/"+a+".json"))),"object"==typeof b?p.schema=$.extend(!0,{},b):(n=l,l++,i.externalSchema=b,o.push(d.get(s.prototypes+"/"+b+".json")));var u=k(t,s);u&&h.preferenceLoadHandler&&(r=l,l++,i.preferenceName=u,o.push(h.preferenceLoadHandler(u))),o.length?e.Promise.all(o).then(function(a){m>=0&&(p.layout=a[m]),n>=0&&(p.schema=a[n]),q>=0&&(p.data=a[q]),r>=0&&(p.preferences=a[r]),j(i,p)}).catch(function(a){console.log("TODO : show errors "),console.log(a)}):j(i,p)},m=function(a,b,c,d,e,f){l(b,c,d,e,null,function(b,c){a=a||{},a.opts=b,j(a,c,f)})},n=function(a,c,d,e){var f=new b.Form(c.layout,e||{design:!1},c.data,c.schema,c.locale,c.preferences);return f.$locale=c.locale,f.render(a),d&&f.on(d),f},o=function(a,b,c,d,e){g.loadSchemaRefs(b.schema,b.data,b.layout,function(f){b.data=f;var g=n(a,b,c,d);e&&e(g)})},p=function(a,b,c,d,e,f,g,h){l(b,c,d,e,g,function(b,c){o(a,c,f,b,h)})},q=function(){function a(){}return a.prototype.data=function(){return null},a.prototype.initObjectState=function(a){},a.prototype.onModelChanged=function(a,b,d){var e=this,f=a.property;if(f){var g=f.indexOf("$links.");g>=0&&(f=f.replace(/\$links\./,""));var h=c(f);if(e[h])return e[h](a,b,d)}},a}();b.FormController=q,b.OpenModalForm=m,b.OpenForm=p}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/index.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="../../../ui/layout.control.ts" />
/// <reference path="../schema.data.ts" />
...
var Phoenix;!function(a){var b;!function(b){var c=(a.ulocale,a.utils),d=(a.ajax,a.dom),e=(a.link,a.render,function(){/*******************************
            ************ METHODS
            *******************************/
function a(a,b){this._oldFilter=null,this._id=c.allocID(),this._fieldList=this._completeFieldList($.extend(!0,[],a)),this._cb=b}
// Called at instanciation of component
// Constants
// "Valider"
return a.prototype.destroy=function(){
// Events
this._nodeSelect.off("click"),this._nodeValidate.off("click"),this._nodeMain.off("blur"),this._removeEditEvents(),
// Nodes
d.find(this._nodeParent[0],this._id).remove(),
// Variables
this._id=null,this._fieldList=null,this._cb=null,this._selectedField=null,this._nodeMain=null,this._nodeSelect=null,this._nodeSelectButtonTxt=null,this._nodeEdit=null,this._nodeValidate=null,this._nodeSelectedLi=null},a.prototype.render=function(a){var b=this;b._nodeParent=a,a.append(b._internalRender()),
// Change field event
b._nodeSelect.click(function(a){var c=a.target.attributes.code.value,d=b._getFieldByCode(c);d&&b._changeField(d)}),
// Validate filter event
b._nodeValidate.click(function(){b._applyFilter()}),
// focusOut event
b._nodeMain.get(0).addEventListener("blur",function(a){var c=!1;if(a.relatedTarget){var e=a.relatedTarget;do{if(d.hasClass(e,"bs-filterexpress")){c=!0;break}e=e.parentNode}while(e&&!c)}!c&&a.target==b._nodeEdit.get(0)&&b._oldFilter&&b._oldFilter.code&&(b._selectedField.code!==b._oldFilter.code&&b._changeField(b._getFieldByCode(b._oldFilter.code)),b._nodeEdit.val(b._oldFilter.value))},!0)},a.prototype._internalRender=function(){var b=this;
// Create nodes
b._nodeMain=$("<div class='bs-filterexpress' id='"+b._id+"'></div>");var c=$("<div class='input-group'></div>"),e=$("<div class='input-group-btn'></div>"),f="<button type='button' ";f+="class='btn btn-default dropdown-toggle' data-toggle='dropdown' ",f+="aria-haspopup='true' aria-expanded='false'></button>";var g=$(f);b._nodeSelectButtonTxt=$("<span>"+a.FIELD_SELECT_TEXT_DEFAULT+" </span>");var h=$("<span class='caret'></span>");
// Fill fields in selectNode
b._nodeSelect=$("<ul class='dropdown-menu'></ul>"),b._fieldList.forEach(function(a){var c=$("<li class='bs-cursor-p'><a code='"+a.code+"'>"+a.lib+"</a></li>");b._nodeSelect.append(c)}),
// Add editNode
b._nodeEdit=$("<input type='text' class='form-control' aria-label='...'>");
// Add validateNode
var i=$("<div class='input-group-btn'></div>");
// Append nodes to mainNode
return b._nodeValidate=$("<button class='btn btn-default' type='submit'><span class='"+d.iconClass(a.VALIDATE_ICON_DEFAULT)+"'></span> "+a.VALIDATE_TEXT_DEFAULT+"</button>"),b._nodeMain.append(c),c.append(e),c.append(b._nodeEdit),c.append(i),e.append(g),e.append(b._nodeSelect),g.append(b._nodeSelectButtonTxt),g.append(h),i.append(b._nodeValidate),b._fieldList&&b._fieldList[0]&&b._changeField(b._fieldList[0]),b._nodeMain},a.prototype._getFieldByCode=function(a){var b=this,c=null;return b._fieldList.forEach(function(b){b.code===a&&(c=b)}),c},a.prototype._changeEditField=function(a){var b=this;b._removeEditEvents();var c,e;e=b._getEditField(a).get(0),c=b._nodeEdit.get(0);var f=c.parentNode;f.replaceChild(e,c),b._nodeEdit=$(e),e.focus(),
// events 
a.enum?(d.addClass(b._nodeValidate.get(0),"bs-none"),b._nodeEdit.change(function(a){a.target===b._nodeEdit.get(0)&&b._applyFilter()}),b._nodeEdit.get(0).style.borderTopRightRadius="4px",b._nodeEdit.get(0).style.borderBottomRightRadius="4px"):(d.removeClass(b._nodeValidate.get(0),"bs-none"),
// touch enter event
b._nodeEdit.keyup(function(a){13==a.keyCode&&b._applyFilter()}),
// input focus event
b._nodeEdit.focus(function(a){b._nodeEdit.get(0).select()}))},a.prototype._getEditField=function(b){var c;switch(b.format){case a.FORMAT_INTEGER:c="<input type='number' class='form-control' aria-label='...'>";break;case a.FORMAT_STRING:c="<input type='text' class='form-control' aria-label='...'>";break;case a.FORMAT_ENUM:c="<select class='form-control'>",b.enum&&b.enum.forEach(function(a,d){var e=b.enumNames&&b.enumNames[d]?b.enumNames[d]:a;c+="<option value='"+a+"'>"+e+"</option>"}),c+="</select>"}return $(c)},a.prototype._removeEditEvents=function(){this._nodeEdit.off("focus"),this._nodeEdit.off("keyup"),this._nodeEdit.off("change")},a.prototype._getOpField=function(b){var c;switch(b.format){case a.FORMAT_INTEGER:c=a.OP_INTEGER;break;case a.FORMAT_STRING:c=a.OP_STRING;break;case a.FORMAT_ENUM:c=a.OP_ENUM;break;default:c=""}return c},a.prototype._checkFilter=function(a){return!a||""!=a.code&&""!=a.op},a.prototype._completeFieldList=function(a){return a.forEach(function(a){a.enum&&Array.isArray(a.enum)?(a.format="enum",a.enum.splice(0,0,""),a.enumNames&&a.enumNames.splice(0,0,"")):a.format="number"===a.type?"integer":a.type}),a},a.prototype._changeField=function(a){var b=this;if(a&&(b._nodeSelectButtonTxt.text(a.lib+" "),b._changeEditField(a),b._selectedField=a),
// Style changed
b._nodeSelectedLi&&b._nodeSelectedLi.removeClass("bs-row-selected"),a){var c=d.query(b._nodeSelect.get(0),"a[code='"+a.code+"']");c&&(b._nodeSelectedLi=$(c.parentNode),b._nodeSelectedLi.addClass("bs-row-selected"))}},a.prototype._applyFilter=function(){var a=this;if(a._selectedField){var b=a._nodeEdit.val(),c=""===b?null:{code:a._selectedField.code,op:a._getOpField(a._selectedField),values:[a._nodeEdit.val()]};a._cb&&a._checkFilter(c)&&(a._oldFilter={code:a._selectedField.code,value:b},a._cb(c))}},a.FIELD_SELECT_TEXT_DEFAULT="Choix du champ",a.VALIDATE_TEXT_DEFAULT="",a.VALIDATE_ICON_DEFAULT="search",a.FORMAT_STRING="string",a.FORMAT_INTEGER="integer",a.FORMAT_ENUM="enum",a.OP_STRING="like",a.OP_INTEGER="in",a.OP_ENUM="in",a}());b.FilterExpress=e}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../typings/index.d.ts" />
...
var Phoenix;!function(a){var b;!function(b){var c=a.dom,d=b,e=(a.utils,a.locale,a.link),f=function(){function b(a,b){var c=this;c.config=a||{},c.options=b||{},c.data={value:a.value},c.props={},c._defineProps()}return b.prototype._defineProps=function(){var b=this,c=a.utils.defineProperty;c("value",b)},b.prototype._notifyChange=function(a){var b=this;switch(a){case"value":b.update()}},b.prototype.createElement=function(a,b,c){return'<div class="bs-toolbar-item">A</div>'},b.prototype._setEvents=function(){},b.prototype.update=function(){},b.prototype.getValue=function(){},b.prototype.after=function(){},b.prototype.render=function(a){var b=this;return b.$element||(b.$element=$(b.createElement(b.config.id,b.config,b.data.value)),b._setEvents()),a&&c.append(a.get(0),b.$element.get(0)),b.$element},b.prototype.destroy=function(){var a=this;a.$element=null,a.options=null,a.config=null},b}();b.ToolElement=f;var g=function(a){function b(b,c){a.call(this,b,c)}return __extends(b,a),b.prototype.createElement=function(a,b,d){var e=["bs-button btn btn-default"];b.style&&e.push("btn-"+b.style),b.right&&e.push("pull-right");var f=['<div class="bs-toolbar-item '+(b.right?"pull-right":"")+'">','<button toolClick="'+a+'" type="button" class="'+e.join(" ")+'">',b.icon?'<span class="'+c.iconClass(b.icon)+'" toolClick="'+a+'" ></span>':"",b.title?"&nbsp;"+b.title:"","</button>","</div>"];return f.join("")},b}(f);b.ToolElementButton=g;var h=function(a){function b(b,c){a.call(this,b,c)}return __extends(b,a),b.prototype.createElement=function(a,b,c){var d=["label label-default form-control-static bs-toolbar-item bs-toolbar-item-count"];b.right&&d.push("pull-right");var e=['<span tool="'+a+'" class="'+d.join(" ")+'">'+c+"</span>"];return e.join("")},b.prototype.update=function(){var a=this;a.$element&&c.text(a.$element.get(0),a.data.value)},b}(f);b.ToolElementCount=h;var i=function(a){function b(b,c){a.call(this,b,c)}return __extends(b,a),b.prototype.createElement=function(a,b,d){var e=["bs-toolbar-item dropdown"];b.right&&e.push("pull-right");var f=[];
// action : {name, events}
b.actions&&b.actions.forEach(function(a){f.push('<li data-id="'+a.code+'"><a href="#" data-id="'+a.code+'">'+(a.lib||a.code)+"</a></li>")});var g=[];b.title||b.icon||g.push('<span class="'+c.iconClass("menu-hamburger")+'"></span> '),b.icon&&g.push('<span class="'+c.iconClass(b.icon)+'"></span> '),b.title&&g.push(" "+b.title+" ");var h=['<div tabindex="'+a+'" class="'+e.join(" ")+'">','<button class="btn btn-default dropdown-toogle" id="tooltip-dropdown-'+a+'" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">',g.join(""),' <span class="caret"></span>',"</button>",'<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="tooltip-dropdown-'+a+'" data-id="toolCommands">',f.join(""),"</ul>","</div>"];return h.join("")},b.prototype._setEvents=function(){var a=this,b=c.query(a.$element.get(0),"ul[data-id='toolCommands']");b&&b.addEventListener("click",function(b){var d=b.target,e=c.attr(d,"data-id");e&&a.options.callback&&a.options.callback({id:a.config.id,name:a.config.name,type:a.config.type,value:e,toolData:a.config}),a.after()},!1)},b.prototype.after=function(){var a=this;c.removeClass(a.$element.get(0),"open")},b}(f);b.ToolElementDropdownAction=i;var j=function(a){function b(b,c){a.call(this,b,c);b.value=b.value||{},
// Test
b.value.default=e.context().$url.idTra,
// Test

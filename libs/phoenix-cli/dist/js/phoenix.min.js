var __extends=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)},Phoenix;!function(a){function b(){p(a.$mem)}function c(a,b){var c=null;try{c=JSON.parse(window.sessionStorage.getItem("preferences"))}catch(d){}if(void 0===b)return c?c[a]:void 0;c=c||{},c[a]=b;try{window.sessionStorage.setItem("preferences",JSON.stringify(c))}catch(d){}}function d(a,b){var c=null;try{c=JSON.parse(window.localStorage.getItem("preferences"))}catch(d){}if(void 0===b)return c?c[a]:void 0;c=c||{},c[a]=b;try{window.localStorage.setItem("preferences",JSON.stringify(c))}catch(d){}}a.bootstrap4=!1;var e;!function(a){a.hashHandler=null,a.logoutHandler=null,a.forbiddenHandler=null,a.changePasswordHandler=null,a.checkLoggedInHandler=null,a.historyChangedHandler=null}(e=a.external||(a.external={}));var f;!function(a){var b,c=[],d=function(){c.pop(),e.historyChangedHandler&&e.historyChangedHandler()},f=function(a,b){if(b)return c=[a],void(e.historyChangedHandler&&e.historyChangedHandler());var d=c.length,f=d?c[d-1]:"";if(f!=a){var g=d>=2?c[d-2]:"";a==g?c.pop():c.push(a),e.historyChangedHandler&&e.historyChangedHandler()}},g=function(){return c.length>1};/* replaceHash */
if("replaceState"in window.history)b=function(a){"#"!==(""+a).charAt(0)&&(a="#"+a),window.location.hash!=a&&(d(),window.history.replaceState("","",a))};else{var h=window.location.hash;b=function(a){"#"!==(""+a).charAt(0)&&(a="#"+a),location.hash!==a&&(d(),location.hash!==h&&window.history.back(),window.location.hash=a)}}a.removeLast=d,a.add=f,a.hasBack=g,a.value=c,a.replaceHash=b}(f=a.history||(a.history={}));var g;!function(a){var b={},c=function(a,c){for(var d=a.split("."),e=b,f=0,g=d.length-1;g>f;f++){var h=d[f];e[h]=e[h]||{},e=e[h]}e[d[d.length-1]]=c},d=function(a){for(var c=a.split("."),d=b,e=null,f=0,g=c.length;g>f;f++){if(e=d[c[f]],!e)return e;d=e}return e};a.register=c,a.get=d}(g=a.customData||(a.customData={}));var h;!function(a){var b={},c=function(a,c,d){b[a]=b[a]||{},b[a][c]=d},d=function(a,c){return b[a]?b[a][c]:null};a.register=c,a.get=d}(h=a.render||(a.render={}));var i;!function(a){var b=function(){return window.Promise||(window.ES6Promise?window.ES6Promise.Promise:null)},c=function(a){var b=(Math.random().toString(16)+"000000000").substr(2,8);return a?"-"+b.substr(0,4)+"-"+b.substr(4,4):b},d=function(){return c(!1)+c(!0)+c(!0)+c(!1)},e=function(){return"I"+c(!1)+c(!1)+c(!1)+c(!1)},f=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];return a[0].replace(/{(\d+)}/g,function(b,c){return c=parseInt(c,10),a[c+1]})},g=function(a,b){return a.replace(/{([^{]*)}/g,function(a,c){return b[c]||""})},h=function(a,b){for(var c in a)b[c]=a[c]},i={scope:!1,destroy:!1,menu:!1,proxydata:!1},j=function(a){var b={};for(var c in a)b[c]=a[c];return b},k=function(a,b){if(!a&&b||!b&&a)return!1;if(a===b)return!0;if(!a&&!b)return!1;if(Array.isArray(a)){if(a.length!=b.length)return!1;for(var c=0,d=a.length;d>c;c++)if(!k(a[c],b[c]))return!1}else if("object"==typeof a){if(typeof a!=typeof b)return!1;var e=Object.keys(a),f=Object.keys(b);if(e.length!==f.length)return!1;for(var g=0,h=e.length;h>g;g++)if(!k(a[e[g]],b[e[g]]))return!1;return!0}return!1},l=function(a,b){return void 0!==b&&(i[a]=b),i[a]},m=function(a,b){i&&i[b]&&console.log(a)},n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"},o=function(a){return(a||"").replace(/[&<>"'\/]/g,function(a){return n[a]})},p=function(){for(var a=document.getElementsByTagName("script"),b=a.length-1;b>=0;--b){var c=a[b].src.split("?")[0],d=c.split("/"),e=d.length,f=d[e-1].toLowerCase();if("phoenix.js"==f||"phoenix.min.js"==f||"core.js"==f&&"core"==d[e-2]){var g=e-1;return"core.js"==f&&g--,d.slice(0,g).join("/")}}throw"Invalid script Name"},q=function(a,b){if(a.indexOf(".")>=0){var c=b;return a.split(".").forEach(function(a){c&&(c=c[a])}),(c||"")+""}return void 0===b[a]?a:b[a]},r=function(a){return(a||"").indexOf("{{")>=0},s=function(a,b){return a.replace(/{{([^{]*)}}/g,function(a,c){return q(c,b)})},t=function(a,b){return a.replace(/{{([^{]*)}}/g,function(a,c){return b.push({name:c}),""})},u=function(a,b){switch(a){case"uppercase":return b.toUpperCase();case"lowercase":return b.toLowerCase();case"firstChar":return b&&b.length?b[0]:""}return b},v=function(a,b){return a.replace(/{{([^{]*)}}/g,function(a,c){for(var d=c.split("|"),e=(d[0]||"").trim(),f=q(e,b),g=1,h=d.length;h>g;g++)f=u((d[g]||"").trim(),f);return f})},w=function(a,b){var c=b||this;Object.defineProperty(c.props,a,{get:function(){return c.data[a]},set:function(b){b!=c.data[a]&&(c.data[a]=b,c._notifyChange(a))},enumerable:!0})},x=function(a,b){b.forEach(function(b){Object.getOwnPropertyNames(b.prototype).forEach(function(c){a.prototype[c]=b.prototype[c]})})},y=function(){return function(a){setTimeout(function(){a()},200)}},z=function(){var a;return a=window.setImmediate?function(a){setImmediate(function(){a()})}:function(a){setTimeout(function(){a()},0)}},A=function(a,b){return a=a||{},Object&&Object.assign?Object.assign(a,b):(Object.keys(b).forEach(function(c){a[c]=b[c]}),a)},B=function(a){var c=z(),d=b();return new d(function(b,d){c(function(){b(a)})})};a.Promise=b(),a.allocUuid=d,a.allocID=e,a.format=f,a.merge=h,a.formatNames=g,a.extend=A,a.logModule=l,a.log=m,a.equals=k,a.copy=j,a.escapeHtml=o,a.phoenixPath=p,a.parseExpression=s,a.hasExpression=r,a.parseVariable=q,a.defineProperty=w,a.applyMixins=x,a.nextTick=z(),a.focusDelay=y(),a.dataAsPromise=B,a.extractAngularVars=t,a.execAngularExpression=v,a.confirm=function(a,b,c){window.confirm(b)&&c()},a.alert=function(a,b,c){window.alert(b)},a.prompt=function(a,b,c){var d=window.prompt(a,b);c(d)}}(i=a.utils||(a.utils={})),a.build={version:"0.1.0.0",release:!1};var j;!function(b){var c={},d={setItem:function(a,b){c[a]=b},getItem:function(a){return c[a]}},e=[],f=function(){var b=null;try{b=a.build.release?window.sessionStorage:window.localStorage}catch(c){b=null}return b||(b=d),b},g=function(a,b){b||(a.basic="Basic "+window.btoa((a.login||"")+":"+(a.password||""))),f().setItem("authentication",JSON.stringify(a))},h=function(){try{return JSON.parse(f().getItem("authentication"))}catch(a){return null}},i=function(a){e.push(a)},j=function(){f().setItem("authentication","null"),e.forEach(function(a){a()})};b.db=f,b.save=g,b.load=h,b.clear=j,b.registerAfterLogout=i}(j=a.authentication||(a.authentication={}));var k;!function(a){var b,c=function(a){b=a},d=function(){return b};a.setData=c,a.getData=d}(k=a.drag||(a.drag={}));var l;!function(a){var b={},c=function(a,c){var d="on"+a,e=b[d];e&&e.forEach(function(a){var b=a.listener?a.handler.bind(a.listener):a.handler;b(c)})},d=function(a,c,d){b[a]=b[a]||[];var e=b[a];e.push({listener:d,handler:c})},e=function(a,c){function d(b){if(b)for(var c=b.length;c--;){var d=b[c];d.listener==a&&b.splice(c,1)}}c?d(b[c]):Object.keys(b).forEach(function(a){d(b[a])})};a.emit=c,a.listen=d,a.unlisten=e}(l=a.ipc||(a.ipc={})),a.locale={};var m;!function(b){var c=[],d=function(a){c.push(a)},e=function(b,d){$.extend(!0,a.locale,b),c.forEach(function(a){a(d)})},f=function(a,b){return b=b||{},a&&"{{"==a.substring(0,2)?a.replace(/{{(.*)}}/g,function(a,c){for(var d=c.split("."),e=b,f=0,g=d.length;g>f&&e;f++)e=e[d[f]];return void 0===e?"["+c+"]":e}):a};b.register=d,b.translate=e,b.tt=f}(m=a.ulocale||(a.ulocale={}));var n;!function(a){function b(b,c){return b=b||a.name,void 0==c?h("application_"+b):g("application_"+b,c)}function c(b,c,d){if(a.name=b,a.title=c,d&&d.homes&&d.homes[b]&&(a.homeName=d.homes[b]),a.configuration=d,angular){var e=d?d.angularModules||[]:[];Array.isArray(e)||"object"!=typeof e||(e=e[b]||[]),a.angularApplication=angular.module(b,e)}}function d(){return a.configuration&&a.configuration.portailName?a.configuration.portailName:"portail"}function e(){return a.name===d()}var f={},g=function(a,b){return f[a]=b,b},h=function(a){return f[a]};a.core="phoenix",a.name="",a.support="",a.homeName="home",a.title="",a.licences={},a.configuration=null,a.config=b,a.init=c,a.portailName=d,a.isPortail=e}(n=a.application||(a.application={})),a.device={phone:!1,tablet:!1,deviceType:""};var o=function(){try{if(window.sessionStorage)return JSON.parse(window.sessionStorage.getItem("$mem"))||{}}catch(a){return{}}},p=function(a){a=a||{};try{window.sessionStorage&&window.sessionStorage.setItem("$mem",JSON.stringify(a))}catch(b){}};a.$mem=o(),a.save$mem=b;var q;!function(b){var c={"times-circle":"remove-sign","times-circle-o":"remove-circle",times:"remove","chevron-left":"chevron-left","chevron-right":"chevron-right",backward:"backward",forward:"forward","file-o":"file",floppy:"floppy-save","power-off":"off",user:"user",pencil:"pencil",trash:"trash","check-square-o":"check","square-o":"unchecked","plus-circle":"plus-sign",search:"search","chevron-down":"menu-down","ellipsis-v":"option-vertical",bars:"menu-hamburger",plus:"plus","thumb-tack":"pushpin",calendar:"calendar","exclamation-circle":"exclamation-sign",cloud:"cloud","caret-up":"triangle-top","caret-down":"triangle-bottom",cog:"cog",lock:"lock","question-circle":"question-sign","info-circle":"info-sign"},d=function(a,b){if(a){var c=a.split(" ");c.forEach(function(a,c){a=a.trim(),a&&"$"===a.charAt(0)&&(a="bs-style-"+a.substring(1)),b.push(a)})}},e=function(a){a&&a.select()},f=function(a,b,c){var d=(a||"").split(" "),e=d.indexOf(c);return b?0>e&&d.push(c):e>=0&&d.splice(e,1),d.join(" ")},g=function(b,d){void 0===d&&(d=!1);var e=c[b]?c[b]:b;return d?(a.bootstrap4?"fa-":"glyphicon-")+e:(a.bootstrap4?"fa fa-":"glyphicon glyphicon-")+e},h=function(){return a.bootstrap4?"fa":"glyphicon"},i=function(a){var b=document.createElement("span");return b.className=g(a,!1),b},j=function(a,b){return a?a.querySelectorAll(b):document.querySelectorAll(b)},k=function(a,b){return a?a.id==b?a:a.querySelector("#"+b):document.getElementById(b)},l=function(a,b){return a?a.querySelector(b):null},m=function(a,b){a.classList?a.classList.add(b):a.className=f(a.className,!0,b)},n=function(a,b){a.classList?a.classList.remove(b):a.className=f(a.className,!1,b)},o=function(a,b){return a.classList?a.classList.contains(b):(a.className||"").split(" ").indexOf(b)>=0},p=function(a){a.parentNode.removeChild(a)},q=function(a){return a.parentNode.removeChild(a),a},r=function(a){for(var b=a.childNodes.length-1;b>=0;b--)a.removeChild(a.childNodes[b])},s=function(a,b){a.appendChild(b)},t=function(a,b){a.parentNode.insertBefore(b,a)},u=function(a,b,c){for(var d=a;d;){if(!d.getAttribute)return null;var e=d.getAttribute(c);if(e)return d;d=d==b?null:d.parentNode}return null},v=function(a){var b=document.body.firstElementChild;b&&o(b,"bs-content")||(b=document.body);for(var c=b.className||"",d=a?"bs-body-theme-"+a:"",e=c.split(" "),f=!1,g=e.length;g--;){var h=e[g];if(0==h.indexOf("bs-body-theme-")){if(h==d)return!1;f=!0,e.splice(g,1)}}d&&(f=!0,e.push(d)),f&&(b.className=e.join(" "))},w=function(a,b){var c=a.parentNode;a=a.nextSibling,a?c.insertBefore(b,a):c.appendChild(b)},x=function(a){return null!=a&&a===a.window?a:9===a.nodeType&&a.defaultView},y=function(a){var b;if(3!=a.nodeType&&(b=a.getBoundingClientRect(),b.width||b.height)){var c=a.ownerDocument,d=x(c),e=c.documentElement;return{top:b.top+d.pageYOffset-e.clientTop,left:b.left+d.pageXOffset-e.clientLeft,width:b.width,height:b.height,bottom:0,right:0}}return b||{top:0,left:0,width:0,height:0,bottom:0,right:0}},z=function(a,b,c){for(c=c.toUpperCase();b;){if(b.tagName===c)return b;if(b=b.parentNode,b==a)break}return null},A=function(a,b,c){for(;b;){if(o(b,c))return b;if(b=b.parentNode,b==a)break}return null},B=function(a,b){for(var c=0,d=a.childNodes.length;d>c;c++)if(a.childNodes[c]==b)return c;return-1},C=function(a,b){for(;b;){if(b===a)return!0;b=b.parentNode}return!1},D=function(a,b,c){return void 0===c&&(c=void 0),void 0===c?a.getAttribute(b):void a.setAttribute(b,c)},E=function(a,b){if(void 0===b)return a.textContent;if(a.childNodes.length){for(var c=!1,d=0,e=a.childNodes.length;e>d;d++){var f=a.childNodes[d];if(3==f.nodeType){f.nodeValue=b,c=!0;break}}c||s(a,document.createTextNode(b))}else a.textContent=b},F=function(){var a=!1,b=0;return function(){if(a)return b;var c,d=document.createElement("div");return d.style.cssText="overflow:scroll; overflow-x:hidden; zoom:1; clear:both",d.innerHTML="&nbsp;",document.body.appendChild(d),c=d.offsetWidth-d.scrollWidth,document.body.removeChild(d),a=!0,b=c,c}},G=null,H=0,I=function(){return null!=G},J=function(a){a?(H++,G||(H=1,G=$('<div class="bs-cover"></div>').get(0),G.style.height=$(document).height()-1+"px",s(document.body,G))):(H--,0>=H&&(H=0),G&&0===H&&(p(G),G=null))},K=function(){$(window).trigger("global-phoenix-resize")},L=null,M=function(){$(window).on("resize.phoenix",function(){L&&clearTimeout(L),L=setTimeout(K,50)})};b.readyHandlers=[M],b.keys={VK_TAB:9,VK_UP:38,VK_DOWN:40,VK_INSERT:45,VK_DELETE:46,VK_LEFT:37,VK_RIGHT:39,VK_ENTER:13,VK_ESCAPE:27,VK_F1:112,VK_HOME:36,VK_END:35,VK_PGUP:33,VK_PGDOWN:34,VK_SPACE:32,VK_F2:113,VK_F3:114,VK_F4:115,VK_BACKSPACE:8,VK_F10:121},b.queryAll=j,b.find=k,b.query=l,b.addClass=m,b.removeClass=n,b.hasClass=o,b.icon=i,b.iconClass=g,b.iconPrefix=h,b.bodyTheme=v,b.offset=y,b.before=t,b.after=w,b.parentByTag=z,b.parentByClass=A,b.indexOf=B,b.append=s,b.select=e,b.empty=r,b.remove=p,b.detach=q,b.attr=D,b.text=E,b.findByAttribute=u,b.isChildOf=C,b.parseStyle=d,b.ignoreKeys=[0,b.keys.VK_UP,b.keys.VK_DOWN,b.keys.VK_HOME,b.keys.VK_END,b.keys.VK_PGUP,b.keys.VK_PGDOWN,b.keys.VK_ENTER,b.keys.VK_ESCAPE,b.keys.VK_DELETE,b.keys.VK_BACKSPACE,b.keys.VK_INSERT],b.processing=J,b.inProcessing=I,b.scrollbar=F()}(q=a.dom||(a.dom={}));var r;!function(b){var c=function(a){if(!a)return"";var b=[];return Object.keys(a).forEach(function(c){null!==a[c]&&b.push(c+"="+encodeURIComponent(a[c]||""))}),b.length>0?"?"+b.join("&"):""},d=function(a){var b={},c=a,d=a.indexOf("?");if(d>=0){var e=a.substring(d+1);if(c=a.substring(0,d),e){var f=e.split("&");f.forEach(function(a){if(a){var c=a.split("=");b[c[0]]=decodeURIComponent(c[1])}})}}return{path:c,search:b}},g=function(a,b){if(null==a)return d(window.location.href).search;var e=c(a);if(window.location.hash){var g=window.location.hash,h=g.indexOf("?");if(h>0&&(g=g.substring(0,h),g+=e),b)f.replaceHash(g);else if(window.location.hash!=g&&window.history)try{window.history.replaceState(void 0,void 0,g)}catch(i){window.location.hash=g}}else window.location.search!=e&&(window.location.search=e)},h=function(b){var c=b.$page;return a.device.phone&&b.$pageMobile?c=b.$pageMobile:a.device.tablet&&b.$pageTablet&&(c=b.$pageTablet),c},k=function(){var b=null;try{b=JSON.parse(j.db().getItem("authentication"))}catch(c){}return{$url:g(null,!1),$mem:a.$mem,$user:{name:b?b.name||b.nom||b.login:"",firstName:b?b.firstName||b.prenom||b.login:"",lastName:b?b.lastName||b.nom||"":""},$item:null}},l=function(a,b,c){if(a.$page){var d=h(a),e="#/"+d,f=[];if(b&&a.$search&&a.$search.length){var g=k();Object.keys(b).forEach(function(a){g[a]=b[a]}),a.$search.forEach(function(a){a&&a.left&&f.push(a.left+"="+encodeURIComponent(i.parseVariable(a.right,g)))})}return c&&Object.keys(c).forEach(function(a){f.push(a+"="+encodeURIComponent(c[a]))}),f.length&&(e=e+"?"+f.join("&")),e}return"#"},m={},o=function(a){var b=a.indexOf("://");if(b>0){var c=m[a.substring(0,b)];if(c)return c.protocol}return null},p=function(a,b,c,d){var e=m[a.protocol];e&&e.handler&&e.handler(a.value,b,c,d)},r=function(a,b){m[a]={protocol:a,handler:b}},s=function(a,b,c){for(var d=b.target;d&&d!=a;){var e=q.attr(d,"data-phoenix-href")||q.attr(d,"href");if(e){if("#"===e){c||(b.preventDefault(),b.stopPropagation());break}var f=o(e);if(f)return c||(b.preventDefault(),b.stopPropagation()),{protocol:f,value:e}}d=d.parentNode}return null},t=function(a,b,c,d){var e,f=location.pathname,g=f.split("/"),h="";g[g.length-1].indexOf(".html")>0&&(h=g.pop());var i=g.pop();h||""!=i||g.pop(),g.push(b),h&&g.push(h),e=g.join("/"),a&&"#"===(""+a).charAt(0)||(a="#"+a),e+=a,d?location.replace(e):location.href=e},u=function(a,b){a&&"#"===(""+a).charAt(0)||(a="#"+a),window.location.hash!=a&&(e.hashHandler?e.hashHandler(a,b):(f.removeLast(),b&&"replaceState"in window.history?window.history.replaceState(void 0,void 0,a):location.hash=a))},v=function(a){if(a.name&&a.schema){var b="/authoring/forms/"+a.name,c=[];a.schema!==a.name&&c.push("prototype="+encodeURIComponent(a.schema)),a.locale&&c.push("locale="+encodeURIComponent(a.locale)),a.path&&c.push("path="+encodeURIComponent(a.path));var d=window.location.href.lastIndexOf("?");d>0&&c.push(window.location.href.substr(d+1)),c.length&&(b=b+"?"+c.join("&")),window.location.hash="#"+b}},w=function(a,b){var c="/authoring",d="/authoring/forms/",e=window.location.hash;"#"==e.charAt(0)&&(e=e.substring(1)),b||0!==e.indexOf(c)?window.location.hash="#"+c+(a?"/"+a:e):0===e.indexOf(d)?window.history.back():window.location.hash="#"+e.substring(c.length)},x=function(a,b,c){var d=n,f=d.configuration&&d.configuration.application?d.configuration.application.modules:null;if(a.$page){var g=a.$module?a.$module:d.name;if(f&&f[g]&&d.licences){var h=d.licences[f[g]];if(h&&!h.hasLicence&&e.forbiddenHandler)return e.forbiddenHandler()}var i=l(a,b,c);if(a.$module&&a.$module!=d.name)return t(i,a.$module,d.name,a.$replace);u(i,a.$replace),a.$authoring&&w()}else if(a.$logout)e.logoutHandler&&e.logoutHandler();else if(a.$formAuthoring)v(a);else if(a.$authoring)w();else if(a.$back)window.history.back();else if(a.href){var j=document.createElement("a");j.href=a.href,a.target&&(j.target=a.target),document.body.appendChild(j),j.click(),document.body.removeChild(j)}};b.search=g,b.object2search=c,b.parseUrl=d,b.hashLink=l,b.pageName=h,b.isCustomLink=s,b.registerCustomProtocol=r,b.execCustomProtocol=p,b.isCustomProtocol=o,b.doAuthoring=w,b.doFormAuthoring=v,b.setHash=u,b.execLink=x,b.context=k}(r=a.link||(a.link={})),a.sessionPreferences=c,a.preferences=d,function(){var a=Array.prototype;a.find||(a.find=function(a,b){if(null===this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof a)throw new TypeError("predicate must be a function");for(var c,d=Object(this),e=d.length>>>0,b=arguments[1],f=0;e>f;f++)if(c=d[f],a.call(b,c,f,d))return c}),a.findIndex||(a.findIndex=function(a,b){if(null===this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof a)throw new TypeError("predicate must be a function");for(var c,d=Object(this),e=d.length>>>0,b=arguments[1],f=0;e>f;f++)if(c=d[f],a.call(b,c,f,d))return f;return-1})}(),$(document).ready(function(){q.readyHandlers.length&&q.readyHandlers.forEach(function(a){a()})})}(Phoenix||(Phoenix={}));
...
var Phoenix;!function(a){var b;!function(b){var c=(a.utils,a.application),d=d,e=a.locale,f={},g=function(a){var b=f["s"+a];return b&&!b.disabled?(b.handlers.forEach(function(a){a()}),!0):!1},h=function(a,b){var c="s"+a,d=f[c]||{disabled:!1,handlers:[]};d.handlers.push(b),f[c]=d},i=function(a,b){var c=f["s"+a];c&&(c.disabled=!b)},j=function(a){return a&&"function"==typeof a},k=function(a){var b=null;if(a.responseText&&(b={responseText:a.responseText}),a.responseJSON)if(b=b||{},"object"==typeof a.responseJSON)b.json=a.responseJSON;else try{b.json=JSON.parse(a.responseJSON)}catch(c){}return b},l=function(a){var b={message:"",list:[]};a&&"object"!=typeof a&&(a={message:a}),a=a||{},b.status=a.status,a.message=a.message||e.errors.unknownError;var c;if(a.detail)if(a.detail.json&&a.detail.json.error){var d=a.detail.json.error,f=void 0;if(void 0!==d.details&&(f=d),c=d.message,d.innererror&&d.innererror.message&&"Json"===d.innererror.type&&(f=JSON.parse(d.innererror.message)),f)return b.message=f.message,f.details&&f.details.forEach(function(a){b.list.push({message:a.message,target:a.target})}),b}else c=a.detail.json&&a.detail.json.exceptionMessage?a.detail.json.exceptionMessage:a.detail.responseText;return b.message=c||a.message,b},m=function(b,c,f){!f&&j(c)&&(f=c,c=null);var h={type:"GET",url:b,dataType:"json",accept:"application/json"},i=null;c&&(i=c.$errors,delete c.$errors,Object.keys(h).forEach(function(a){c[a]=h[a]}),h=c);var l=a.utils.Promise;return new l(function(a,b){$.ajax(h).done(function(b,c,d){f&&(b=f(b)),a(b)}).fail(function(f,h,j){if(c&&c.ignore&&c.ignore[""+f.status])return a({});if(i&&i[f.status+""]){var l=f.status+"";if("string"!=typeof i[l])return a(i[l]);var m=d.get(i[l]);m&&a(m())}if(g(f.status))return a({});f.status>=500&&e&&e.errors&&(h=e.errors.error500,j=null);var n=k(f);n&&(j=null),j&&"string"==typeof j&&(j={message:j}),j=j||{message:h,detail:n},j.status=f.status,b(j)})})},n=function(b,c,d,f){var h=a.utils.Promise,i={type:b,contentType:"application/json",accept:"application/json",url:c,data:null};return f&&f.headers&&(i.headers=f.headers),d&&(i.data=JSON.stringify(d)),new h(function(a,b){$.ajax(i).done(function(b,c,d){a(b)}).fail(function(c,d,h){if(f&&f.ignore&&f.ignore[""+c.status])return a({});if(g(c.status))return a({});c.status>=500&&e&&e.errors&&(d=e.errors.error500,h=null);var i=k(c);i&&(h=null),h&&"string"==typeof h&&(h={message:h}),h=h||{message:d,detail:i},h.status=c.status,b(h)})})},o=function(a,b,c){return n("PUT",a,b,c)},p=function(a,b,c){return n("PATCH",a,b,c)},q=function(a,b,c){return n("POST",a,b,c)},r=function(a,b){return n("DELETE",a,null,b)},s={},t=function(){var b=a.application.config(c.name),d={headers:null};if(b&&b.odata&&b.odata.headers&&(d.headers=b.odata.headers),d.headers=d.headers||{},d.headers.Accept="application/json",b&&b.odata&&b.odata.authentication){var e=a.authentication.load();if(e)switch(b.odata.authentication){case"basic":d.headers.Authorization=e.basic;break;case"header-session":d.headers.Authorization="Bearer "+e.token}else delete d.headers.Authorization}return d},u=function(a,b,c,d){var e=s[a];if(e){if(e.loaded)return c(null);if(e.error)return c(e.error,null);
//status.loading == true
window.setTimeout(function(){u(a,b,c,d)},20)}else s[a]={loading:!0},d?d.execute(function(b){b?s[a]={error:b}:s[a]={loaded:!0},c(b)}):$.ajax({url:b,dataType:"script",cache:!0}).done(function(b,d,e){s[a]={loaded:!0},c(null)}).fail(function(b,d,e){var f=e||{message:d};s[a]={error:f},c(f)})},v=function(b){var c=a.utils.Promise;return new c(function(a,c){$.ajax({url:b,dataType:"script",cache:!0}).done(function(b,c,d){a(!0)}).fail(function(a,b,d){c(d||{message:b})})})},w=function(b,d){var f=a.utils.Promise,h=t(),i=c.config(c.name)||{},j=i.rest?i.rest.base||"":"";return b&&"/"===b.charAt(0)&&(j=""),j&&(b=j+"/"+b),new f(function(a,c){var f=function(b){var d=b.statusText;if(g(b.status))return a({});b.status>=500&&e&&e.errors&&(d=e.errors.error500);var f=null;// _parseError(xhr);
c({message:d,detail:f})},i=new XMLHttpRequest;i.open("POST",b,!0),i.responseType="arraybuffer",i.onload=function(){if(200===this.status||201===this.status){var b="",d=i.getResponseHeader("Content-Disposition");if(d&&-1!==d.indexOf("attachment")){var e=/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/,g=e.exec(d);null!=g&&g[1]&&(b=g[1].replace(/['"]/g,""))}var h=i.getResponseHeader("Content-Type");try{var j=new Blob([this.response],{type:h})}catch(k){return c(k)}if("undefined"!=typeof window.navigator.msSaveBlob)window.navigator.msSaveBlob(j,b),a({});else{var l=window.URL||window.webkitURL,m=l.createObjectURL(j);if(b){
// use HTML5 a[download] attribute to specify filename
var n=document.createElement("a");
// safari doesn't support this yet
"undefined"==typeof n.download?window.location=m:(n.href=m,n.download=b,document.body.appendChild(n),n.click(),document.body.removeChild(n))}else window.location=m;setTimeout(function(){l.revokeObjectURL(m),a({})},100)}}else f(this)},i.onerror=function(){f(i)},i.setRequestHeader("Content-type","application/json"),h&&h.headers&&Object.keys(h.headers).forEach(function(a){i.setRequestHeader(a,h.headers[a])}),i.send(JSON.stringify(d))})};b.extractAjaxErrors=l,b.get=m,b.getScript=v,b.getDefaultAjaxOptions=t,b.put=o,b.patch=p,b.post=q,b.remove=r,b.postAndDownload=w,b.loadScript=u,b.interceptError=h,b.activateInterceptError=i}(b=a.ajax||(a.ajax={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core.ts" />
...
var Phoenix;!function(a){var b;!function(b){function c(c){var d=a.utils.phoenixPath();c!=b.currentLang&&e.getScript(d+"/locale/phoenix_"+b.lang+".min.js").then(function(){b.currentLang=c})["catch"](function(a){})}var d=a.locale,e=a.ajax,f=["en","fr"],g=function(a,b){return a=Math.round(Math.abs(a)),isNaN(a)?b:a},h=function(a,b){b=g(b,2);var c=Math.pow(10,b);return(Math.round(a*c)/c).toFixed(b)},i=function(a,b,c,d){if(null===a)return"";var e=g(b,0),f=0>a?"-":"",i=parseInt(h(Math.abs(a||0),e),10)+"",j=i.length>3?i.length%3:0;return f+(j?i.substr(0,j)+c:"")+i.substr(j).replace(/(\d{3})(?=\d)/g,"$1"+c)+(e?d+h(Math.abs(a),e).split(".")[1]:"")},j=function(a,b,c,d,e,f){return null===a?"":(f=f||"%v %s",f.replace("%s",e).replace("%v",i(a,b,c,d)))},k=function(a){if(a instanceof Date)return a;if(!a)return null;var b=Date.parse(a);return isNaN(b)?null:new Date(b)},l=function(a){return a?Date.UTC(parseInt(a.substr(0,4),10),parseInt(a.substr(5,2),10)-1,parseInt(a.substr(8,2),10),0,0,0):0},/**
        * @param {string} val
        * @param {number || null} len
        */
m=function(a,b){for(var c=a+"";c.length<b;)c="0"+a;return c},n=function(a,b){var c=/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,e=a.getDate(),f=a.getDay(),g=a.getMonth(),h=a.getFullYear(),i={d:e,dd:m(e,2),ddd:d.date.weekdaysShort[f],dddd:d.date.weekdays[f],m:g+1,mm:m(g+1,2),mmm:d.date.monthsShort[g],mmmm:d.date.months[g],yy:(h+"").slice(2),yyyy:h};return b.replace(c,function(a){return a in i?i[a]:a.slice(1,a.length-1)})},/**
        * Date to ISO8601
        * @param {Date} value
        */
o=function(a){var b=a.getFullYear(),c=a.getMonth()+1,d=a.getDate();return m(b,4)+"-"+m(c,2)+"-"+m(d,2)},p=function(a){var b=d.date.dateShort.split("/");if(3!=b.length)return"";var c=a.split(d.date.daySep),e=[0,0,0];b.forEach(function(a,b){var d=0;"m"===a.charAt(0)?d=1:"y"===a.charAt(0)&&(d=2),e[d]=parseInt(c[b],10),2==d&&e[d]<100&&c[b].length<3&&(e[d]+=100*Math.round((new Date).getFullYear()/100))});var f=m(e[2],4)+"-"+m(e[1],2)+"-"+m(e[0],2),g=Date.parse(f);return isNaN(g)?"":f},q=function(a){if(!a)return"";var b=k(a);if(!b)return"";var c=d.date.dateShort;return"/"!=d.date.daySep&&(c=c.replace(/\//g,d.date.daySep)),n(b,c)},r=function(a){if(!a)return"";var b=k(a);if(!b)return"";var c=d.date.dateLong;return"/"!=d.date.daySep&&(c=c.replace(/\//g,d.date.daySep)),n(b,c)},s=function(a){if(!a)return"";var b=k(a);if(!b)return"";var c=d.date.monthYear;return"/"!=d.date.daySep&&(c=c.replace(/\//g,d.date.daySep)),n(b,c)},t=function(a){return parseFloat(a.toFixed(d.number.decimal))},u=function(a,b){return a=a||0,b?j(a,d.number.places,d.number.thousand,d.number.decimal,d.number.symbol,d.number.format):i(a,d.number.places,d.number.thousand,d.number.decimal)},v=function(a,b,c){if(null===a)return"";a=a||0;var e=c?"%v %s":"%v";return j(a,b,d.number.thousand,d.number.decimal,c,e)},w=function(a,b){if(!a||!b)return b;var c=[];if(Object.keys(a).forEach(function(b){var d=a[b];"date"!=d.type&&"money"!=d.type&&"decimal"!=d.type&&"number"!=d.type||c.push({name:b,type:d.type,symbol:d.symbol,longdate:d.longdate,decimals:d.decimals,useSymbol:void 0===d.useSymbol?!0:d.useSymbol})}),!c.length)return b;var d=Array.isArray(b)?b:[b];return d.forEach(function(a){c.forEach(function(b){switch(b.type){case"date":a[b.name]=q(a[b.name]);break;case"money":a[b.name]=u(a[b.name],b.useSymbol);break;case"integer":a[b.name]=v(a[b.name],0,b.symbol);break;case"decimal":case"number":a[b.name]=v(a[b.name],b.decimals,b.symbol)}})}),b},x=function(a){var b=a||"",c=b.indexOf("T");return c>0&&(b=b.substr(0,c)),b},y=function(b){var c=b.replace(new RegExp(a.locale.number.thousand,"g"),"");"."!=a.locale.number.decimal&&(c=c.replace(new RegExp(a.locale.number.decimal,"g"),"."));var d=parseFloat(c);return isNaN(d)&&(d=0),d};b.currentLang="en",b.defCountry="US",b.lang="fr",//(navigator.language || navigator.userLanguage || currentLang).split('-')[0];
b.country="FR",b.money=u,b.truncMoney=t,b.decimal=v,b.format=w,b.parseISODate=k,b.parseISODateAsUTC=l,b.isoDatePart=x,b.shortDate=q,b.longDate=r,b.monthYear=s,b.localeDate2ISO=p,b.date2ISO=o,b.string2Float=y,b.localeTitle=function(a){return"object"==typeof a?a[b.currentLang]:a},b.loadLocale=c,f.indexOf(b.lang)<0&&(b.lang=b.currentLang),c(b.lang)}(b=a.ulocale||(a.ulocale={}));var c;!function(a){var c=function(a){a&&a.filter&&(a.filter("money",[function(){return function(a,c){var d=null===a?null:a?parseFloat(a):0;return b.money(d,c)}}]),a.filter("decimal",[function(){return function(a,c,d){var e=null===a?null:a?parseFloat(a):0;return b.decimal(e,c||0,d)}}]),a.filter("shortdate",[function(){return function(a){return b.shortDate(a)}}]),a.filter("longdate",[function(){return function(a){return b.longDate(a)}}]),a.filter("monthyear",[function(){return function(a){return b.monthYear(a)}}]))};a.registerFilters=c}(c=a.angularjs||(a.angularjs={}))}(Phoenix||(Phoenix={}));
/// <reference path="./core.ts" />
var Phoenix;!function(a){var b=a.link,c=a.$mem,d=a.utils;b.registerCustomProtocol("page",function(a,d,e,f){d.$url||(d.$url=b.search(null,!1)),d.$mem||(d.$mem=c);var g=a.indexOf("://");if(!(0>=g)){var h,i=a.substring(g+3),j=b.parseUrl(i),k=j.path.split("/");j.search.$replace&&(h=!0,delete j.search.$replace);var l={$page:k[0],$search:[],$replace:h,$menu:null};k.length>1&&(l.$menu=k[1]),Object.keys(j.search).forEach(function(a){l.$search.push({left:a,right:j.search[a]})}),b.execLink(l,d,null)}}),b.registerCustomProtocol("link",function(a,c,e,f){var g=a.substring("link://".length),h=g.indexOf("/");if(0>=h&&(h=g.indexOf("?")),h>0){var i=b.parseUrl(g.substring(h));g=g.substring(0,h),i.search&&(f?d.extend(f,i.search):f=i.search)}e.links&&e.links[g]&&b.execLink(e.links[g],c,f)}),b.registerCustomProtocol("click",null)}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
/// <reference path="../core/locale.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.application,d={get:function(b,d,e){d&&a.ulocale.lang&&(b=b+"_"+a.ulocale.lang);var f=c.config(e);if(!f)throw"Application configuration not found.";return a.ajax.get(f.menus+"/"+b+".json",{cache:!0},null)}};b.menu=d}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
/// <reference path="../core/locale.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.application,d={get:function(b,d,e){d&&a.ulocale.lang&&(b=b+"_"+a.ulocale.lang);var f=c.config(e);if(!f)throw"Application configuration not found.";return a.ajax.get(f.locales+"/"+b+".json",{cache:!0},function(a){return a&&(a.$name=b),a.$view&&(a.$view.$name=b),a})}};b.schema=d}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
...
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.application,d={getRessources:function(b,d){var e=function(a){return d&&(a=d(a)),a},f=c.config(c.name);if(!f)throw"Application configuration not found.";var g=f.localData+"/"+b.$url,h=b.$query;return g+=a.link.object2search(h),a.ajax.get(g,{},function(a){return e(a)})}};b.local=d}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
/// <reference path="../core/ajax.ts" />
/// <reference path="../core/locale.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.application,d=a.utils,e=a.ajax,f={},g=function(a){return a},h={v4:!0,transport:{doPost:e.post,doPut:e.put,doDelete:e.remove,doGet:function(a,b,c,d){return e.get(a,b,c)},doPatch:e.patch},afterLogout:function(){
//clear cache
f={}},urlResEntity:function(a,b){var e=c.config(c.name)||{};e.odata=e.odata||{};var f=e.odata.base||"/data",g={};if(void 0===a.$module&&e.odata.$module&&(a.$module=e.odata.$module),a.$module?g.$module=a.$module:f=f.replace("{$module}/",""),e.odata.$context?g.$context=e.odata.$context:f=f.replace("{$context}/",""),f=d.formatNames(f,g),!a.$entity)throw"Invalid odata entity.";if(b&&!a.$entityId)throw"Invalid odata entity id.";var h=f+"/"+a.$entity;return a.$entityId&&(h=h+"("+a.$entityId+")"),a.$propertyName&&(h=h+"/"+a.$propertyName),h},doDelete:function(a,b){var c=h.urlResEntity(a,!0),d=e.getDefaultAjaxOptions();return b&&(d.headers["If-Match"]=b),d.ignore={410:!0},c=g(c),h.transport.doDelete(c,d)},doPost:function(a,b){var c=e.getDefaultAjaxOptions(),d=h.urlResEntity(a,!1);return d=g(d),h.transport.doPost(d,b,c)},doPut:function(a,b,c,d){var f=h.urlResEntity(a,!0),i=e.getDefaultAjaxOptions();return i.headers=i.headers||{},c&&(i.headers["If-Match"]=c),d&&(i.headers.Prefer="return=representation"),f=g(f),h.transport.doPut(f,b,i)},doPatch:function(a,b,c,d){var f=h.urlResEntity(a,!0),i=e.getDefaultAjaxOptions();return i.headers=i.headers||{},c&&(i.headers["If-Match"]=c),d&&(i.headers.Prefer="return=representation"),f=g(f),h.transport.doPatch(f,b,i)},getRessources:function(i,j,k){var l=function(a){return j&&(a=j(a)),a},m=!1,n=i.$cache;delete i.$cache;var o=c.config(c.name)||{};o.odata=o.odata||{},void 0!=o.odata.v4&&(h.v4=o.odata.v4);var p=o.odata?o.odata.base||"/data":"/data",q={};void 0===i.$module&&o.odata.$module&&(i.$module=o.odata.$module),i.$module?q.$module=i.$module:p=p.replace("{$module}/",""),o.odata.$context?q.$context=o.odata.$context:p=p.replace("{$context}/",""),p=d.formatNames(p,q),delete i.$module;var r=i.$entity;i.$entityId&&(r=r+"("+i.$entityId+")",delete i.$entityId,m=!0),i.$propertyName&&(r=r+"/"+i.$propertyName,delete i.$propertyName);var s=r;delete i.$entity,m||(h.v4?(i.$top&&!i.nocount&&(i.$count=!0),delete i.nocount):i.$inlinecount="allpages");var t=!1;i.$aggregation&&"$count"==i.$aggregation&&(s=s+"/"+i.$aggregation,delete i.$aggregation,t=!0);var u=e.getDefaultAjaxOptions();return u.$errors=k,s=p+"/"+s+a.link.object2search(i),n&&f[r]&&f[r].uri==s?new d.Promise(function(a,b){var c=l(t||m?f[r].data:$.extend(!0,{},f[r].data));a(c)}):(s=g(s),b.odata.transport.doGet(s,u,function(a){var b={};return h.v4&&a&&delete a["@odata.context"],t||m?b=a:(b.documents=h.v4?a.value:a.d.results,b.dataCount=b.documents?b.documents.length:0,b.documents.forEach(function(a){delete a.__metadata}),b&&(b.pageSize=i.$top,b.skip=i.$skip||0,b.count=h.v4?a["@odata.count"]:a.d.__count,b.nodata=0==b.dataCount)),n&&(f[r]={uri:s,data:t?b:$.extend(!0,{},b)}),l(b)},{entity:r,params:i}))}};b.odata=h,a.authentication.registerAfterLogout(h.afterLogout)}(b=a.data||(a.data={}))}(Phoenix||(Phoenix={}));
/// <reference path="../core/core.ts" />
...
h&&(c.rotate?(f=Math.max(a-Math.floor(c.maxSize/2),1),g=f+c.maxSize-1,g>b&&(g=b,f=g-c.maxSize+1)):(f=(Math.ceil(a/c.maxSize)-1)*c.maxSize+1,g=Math.min(f+c.maxSize-1,b)));
// Add page number links
for(var i=f;g>=i;i++){var j=d(i,i,null,i===a,!1);e.push(j)}
// Add links to move between page sets
if(h&&!c.rotate){if(f>1){var k=d(f-1,"...",null,!1,!1);e.unshift(k)}if(b>g){var l=d(g+1,"...",null,!1,!1);e.push(l)}}var m;
//Add Previous
//Add First
//Add Next
//Add last
...
/// <reference path="../../data/datasets.ts" />
/// <reference path="../datasets-plugin.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a,b,d,e,f,g){f(b,a,e,d)&&Object.keys(a.properties).forEach(function(d){var h=a.properties[d];if(!h.$reference)if("object"===h.type){var i=b?b+"."+d:d;c(h,i,!1,e?e[d]:null,f,g)}else if("array"===h.type&&"object"===h.items.type){var i=b?b+"."+d:d;c(h.items,i,!0,e?e[d]:null,f,g)}})}var d=a.ulocale,e=(a.application,a.ajax,a.dom),f=(a.link,a.data),g=a.utils,d=a.ulocale,h=a.locale,i=a.customData,j=a.locale.schema,k=a.DatasetPlugin,l=function(){var a={};return{register:function(b,c){a[b]=c},get:function(b){return a[b]}}},m=function(){var a={};return{register:function(b,c){a[b]=c},get:function(b){return a[b]}}},n=function(a){a.features||(a.features={},a.capabilities&&a.capabilities.split(",").forEach(function(b){a.features[b]=!0}))},o=m(),p=l(),q={_getDefault:function(a){return"@date"==a?d.date2ISO(new Date):a},checkLookup:function(a){return a?(a=$.extend({},a),a.data&&"odata"==a.data.$type||(a.pagination=!1,a.cache=!0),a.pagination!==!1&&(a.pagination=!0),a.pagination&&(a.cache=!1),a):null},schema2Authoring:function(a,b){var e=[];return c(a,"",!1,null,function(a,c,f,g){return g?!1:(Object.keys(c.properties).forEach(function(f){var g=c.properties[f];if(q.inModel(g)&&!q.isCompositionRef(g))
//if (_sutils.isCompositionRef(ps) || _sutils.isCompositionList(ps)) return;
{var h=a?a+"."+f:f,i={$type:"field",$bind:h,$title:d.tt(g.title,b)||h,$widget:g.$widget,options:g.$widgetOptions};e.push(i)}}),c.links&&Object.keys(c.links).forEach(function(f){var g=c.links[f],h="$links."+f;h=a?a+"."+h:h;var i={$type:"action",$bind:h,$title:d.tt(g.title,b)||h,$widget:g.widget,options:g.$widgetOptions};e.push(i)}),!0)}),e},filtrableFields:function(a,b){var e=[];return c(a,"",!1,null,function(a,c,f,h){return h?!1:(Object.keys(c.properties).forEach(function(f){var h=c.properties[f];if(q.inModel(h)&&!q.isCompositionRef(h)&&!q.isCompositionList(h,!0)){var i=a?a+"."+f:f;if(q.canFilter(h)){var j={name:i,schema:g.copy(h)};j.schema.title=d.tt(j.schema.title||"",b),e.push(j)}}}),!0)}),e},allData:function(a){return!a.pagination},pkFields:function(a){return a.split(",").map(function(a){return a.trim()})},entityId:function(a){if("object"==typeof a){return Object.keys(a).map(function(b){var c=a[b];return"string"==typeof c?b+"='"+c+"'":b+"="+c}).join(",")}return"string"==typeof a?"'"+a+"'":a+""},extractPkValue:function(a,b){if(1==b.length)return a[b[0]];var c={};return b.forEach(function(b){c[b]=a[b]}),c},odataId:function(a,b){if(1==a.length)return b[a[0]];var c=[];return a.forEach(function(a){c.push(a+"="+encodeURIComponent(b[a]+""))}),c.join("")},pk2Id:function(a,b){return 1===b.length?a:JSON.stringify(a)},id2Pk:function(a,b){return 1===b.length?a:JSON.parse(a)},equals:function(a,b,c){if(1===c.length)return a===b[c[0]];for(var d=0,e=c.length;e>d;d++){var f=c[d];if(a[f]!==b[f])return!1}return!0},extractBase:function(a){var b=a.split(".");return b.pop(),b.length?b.join(".")+".":""},parentPath:function(a){var b=a.split(".");return b.pop(),b.length?b.join("."):""},findByPk:function(a,b,c){if(c&&a)for(var d=0,e=c.length;e>d;d++){var f=c[d];if(q.equals(a,f,b))return f}return null},supportPagination:function(a){
//TODO
return!1},executeLookup:function(a,b,c){var d=f.execData(a.data,b,null);return c?void(d?d.then(c):c(null)):d},remoteSearch:function(a,b){return b.mapping?b.mapping[a]:a},lastSegment:function(a,b){var c=a.split("."),d=c.pop();return b&&b!=a&&(d=b.substring(c.join(".").length)),d},findFirst:function(a,b,c){if(!a||!c)return null;for(var d=a.toLocaleLowerCase(),e=d.length,f=0,g=c.length;g>f;f++){var h=c[f][b]||"";if(h.toLowerCase().substr(0,e)===d)return{item:c[f],index:f}}return null},_states:["$states","$links"],isMetaProp:function(a){return"$$"===a.substr(0,2)},removeMeta:function(a){Array.isArray(a)||Object.keys(a).forEach(function(b){q.isMetaProp(b)&&delete a[b]})},removeStates:function(a){Array.isArray(a)?a.forEach(function(a){a&&"object"==typeof a&&q.removeStates(a)}):(q._states.forEach(function(b){delete a[b]}),delete a.$errors,Object.keys(a).forEach(function(b){var c=a[b];c&&"object"==typeof c&&q.removeStates(c)}))},isMeta:function(a){var b="$$meta-".length;return"$$meta-"===a.substr(0,"$$meta-".length)?{widget:a.substr(b)}:null},getLookup:function(a,b,c){var d=a.split(".");d.pop();for(var e=c,f=0,g=d.length;g>f&&e;f++){var h=d[f];e="array"==e.type&&q.arrayProps.indexOf(h)>=0?e.items:e.properties?e.properties[h]:null}return e&&e.lookups?q.checkLookup(e.lookups[b]):null},getSchema:function(a,b,c){if(!a)return b;for(var d=a.split("."),e=b,f=!1,g=0,i=d.length;i>g&&e;g++){var j=d[g];if("array"==e.type&&q.arrayProps.indexOf(j)>=0)
// $item, $new 
e=e.items;else if("$links"===j)e=e.links,f=!0;else if(f)f=!1,e=e[j];else if(e=e.properties?e.properties[j]:null,!e&&g===i-1){if("$index"===j)return{type:"integer",title:"#"};if("$selected"===j)return{type:"boolean",title:h.ui.Selected}}}return c&&e&&"array"===e.type&&e.items&&(e=e.items),e},states:["isHidden","isDisabled","isReadOnly","isMandatory"],statesAndErrors:["isHidden","isDisabled","isReadOnly","isMandatory","errors","filter"],linksStates:["isHidden","isDisabled"],isLink:function(a){return a.split(".").indexOf("$links")>=0},_isMoney:function(a){return q.isNumber(a)&&"money"==a.format},_extractEnums:function(a,b){var c=function(c,d){if(d=d||a,d.enums&&d.enums[c]){var e=d.enums[c].type||"default";b[e]=b[e]||{},b[e][c]=d.enums[c]}else{
//$enumref = "Satut.codif"
var f=c.split(".");2===f.length&&(b[f[1]]=b[f[1]]||{},b[f[1]][f[0]]={type:f[1]})}};a.lookups&&Object.keys(a.lookups).forEach(function(b){var d=a.lookups[b];"enum"==d.data.$type&&d.data.$enumref&&c(d.data.$enumref)}),Object.keys(a.properties).forEach(function(d){var e=a.properties[d];if(q.inModel(e))if(q.isCompositionRef(e))q._extractEnums(e,b);else if(q.isCompositionList(e,!0))q._extractEnums(e.items,b);else{var f=a;q.isSimpleList(e)&&(e=e.items,f=e),e.$enumref&&c(e.$enumref,f)}})},_fillEnums:function(a,b){a.lookups&&Object.keys(a.lookups).forEach(function(c){var d=a.lookups[c];if("enum"==d.data.$type&&d.data.$enumref){var e=d.data.$enumref.split("."),f=2===e.length?b[e[1]]:b[a.enums[d.data.$enumref].type||"default"],h=2===e.length?e[0]:d.data.$enumref;if(f){d.data.$value=[];var i=f[h];i["enum"].forEach(function(a,b){var c={code:a,title:i.enumNames[b]};i.fields&&g.extend(c,i.fields[b]),d.data.$value.push(c)})}}}),Object.keys(a.properties).forEach(function(c){var d=a.properties[c];if(q.inModel(d))if(q.isCompositionRef(d))q._fillEnums(d,b);else if(q.isCompositionList(d,!0))q._fillEnums(d.items,b);else{var e=a;if(q.isSimpleList(d)&&(d=d.items,e=d),d.$enumref){var f=d.$enumref.split(".");if(e.enums&&e.enums[d.$enumref]||2===f.length){var g=2===f.length?b[f[1]]:b[e.enums[d.$enumref].type||"default"],h=2===f.length?f[0]:d.$enumref;if(g){var i=g[h];i&&(d["enum"]=i["enum"],d.enumNames=i.enumNames,d.filters=i.filters)}}}}})},loadEnums:function(a){var b={};q._extractEnums(a,b);var c=Object.keys(b).map(function(a){var c=p.get(a);if(!c)throw"Invalid enum type: "+a;return c.promise(b[a],a)});return c.length?c:null},arrayProps:["$item","$new"],init:function(a,b,c){var d=c||{};return d.$states=d.$states||{},Object.keys(a.properties).forEach(function(c){var e=a.properties[c];if(q.inModel(e)){var f=q.isMetaProp(c),g=a.states?a.states[c]:null,h=d.$states[c]=d.$states[c]||{};if(f||g&&Object.keys(g).forEach(function(a){void 0===h[a]&&(h[a]=g[a])}),q.isCompositionRef(e))
// recursive	
h.isMandatory&&(d[c]=q.init(e,b,d[c]||{}));else if(q.isCompositionList(e)||q.isSimpleList(e))d[c]=d[c]||[];else if(q.isList(e))d[c]=d[c]||[];else if(void 0===d[c])if(void 0!==e["default"])d[c]=q._getDefault(e["default"]);else if(e["enum"])d[c]=e["enum"][0];else switch(e.type){case"number":case"integer":d[c]=0}}}),d},
//
isCompositionRef:function(a){return"object"===a.type&&!a.$reference},isRef:function(a){return"object"===a.type&&a.$reference},isList:function(a){return"array"===a.type&&a.$reference},isCompositionList:function(a,b){var c="array"===a.type&&a.items&&("object"===a.items.type||"array"===a.items.type)&&(!a.$reference||b&&a.$reference);return c},isSimpleList:function(a){var b="array"===a.type&&a.items&&("object"!==a.items.type||"array"===a.items.type)&&!a.$reference;return b},inModel:function(a){return!q.isRef(a)},formatNumber:function(a,b){return"money"==a.format?d.money(b,!1):d.decimal(b,a.decimals||0,null)},_title:function(a,b){return b?d.tt(a,b):a},canSort:function(a){return a?(n(a),a.features.sortable):!1},canFilter:function(a){return a?(n(a),a.features.filtrable):!1},checkNumber:function(a,b,c,d){var e=!0;return b.exclusiveMinimum?void 0!=b.minimum&&a<=b.minimum&&(d.push({message:g.format(j.minNumberExclusive,q._title(b.title,c),q.formatNumber(b,b.minimum))}),e=!1):void 0!=b.minimum&&a<b.minimum&&(d.push({message:g.format(j.minNumber,q._title(b.title,c),q.formatNumber(b,b.minimum))}),e=!1),b.exclusiveMaximum?void 0!=b.maximum&&a>=b.maximum&&(d.push({message:g.format(j.maxNumberExclusive,q._title(b.title,c),q.formatNumber(b,b.maximum))}),e=!1):void 0!=b.maximum&&a>b.maximum&&(d.push({message:g.format(j.maxNumber,q._title(b.title,c),q.formatNumber(b,b.maximum))}),e=!1),e},_validateEmail:function(a,b){var c=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return c.test(a)},_validateJson:function(a,b){try{JSON.parse(a)}catch(c){return b.ex=c,!1}return!0},checkString:function(a,b,c,d,e){var f=!0,h=a||"";if(c.minLength&&h.length<c.minLength&&(e.push({message:g.format(j.minLength,q._title(c.title,d),c.minLength)}),f=!1),b.isMandatory&&""===h&&(e.push({message:g.format(j.required,q._title(c.title,d))}),f=!1),c.format)if("email"===c.format)a&&!q._validateEmail(a,{})&&(e.push({message:j.invalidEmail}),f=!1);else if("json"===c.format){var i={};a&&!q._validateJson(a,i)&&(e.push({message:i.ex.message}),f=!1)}return f},validatePassword:function(a,b,c,d,e,f){var g=!0;return d.isHidden||d.isDisabled?g:(a!==b&&(f.push({message:j.passwordMismatch}),g=!1),g)},validateSchema:function(a,b,c,d,e){var f=!0;if(c&&(c.isHidden||c.isDisabled))return f;switch(b.type){case"number":case"integer":f=q.checkNumber(a,b,d,e);break;case"string":f=q.checkString(a,c,b,d,e)}return f},loadEnumsPromise:function(a){var b=q.loadEnums(a);return b?g.Promise.all(b).then(function(b){var c={};return b.forEach(function(a){c[a.type]=a.enums}),q._fillEnums(a,c),a}):new g.Promise(function(b,c){b(a)})},loadSchemaRefs:function(a,b,c,d){if(!a)return d();var f=q.loadEnums(a),h=f?f:[],i=f?f.length:0,j=r.loadMainData(c);j&&h.push(j);var k=j?i+1:0;return h.length?(e.processing(!0),void g.Promise.all(h).then(function(c){e.processing(!1);var f={};c.forEach(function(a,c){i>c?f[a.type]=a.enums:k>c&&$.extend(!0,b,a)}),i&&q._fillEnums(a,f),d(b)})["catch"](function(a){throw e.processing(!1),a})):d(b)},stateProps:function(a){return a["enum"]&&a.filters?["filter"]:a.items&&a.items["enum"]&&a.items.filters?["filter"]:null},isPassword:function(a){return"string"===a.type&&"password"===a.format},isDate:function(a){return"string"===a.type&&"date"===a.format},isBoolean:function(a){return"boolean"===a.type},isNumber:function(a){return"number"===a.type||"integer"===a.type},isText:function(a){return"string"===a.type&&("json"===a.format||"memo"===a.format)},isMoney:function(a){return q.isNumber(a)&&"money"==a.format},text2Value:function(a,b){if(q.isNumber(b)){var c=q.isMoney(b)?h.number.places:b.decimals,e=d.string2Float(a);return e=parseFloat(e.toFixed(c))}return a},value2Text:function(a,b){return q.isNumber(b)?q.isMoney(b)?d.money(parseFloat(a||"0"),!1):d.decimal(a,b.decimals,null):a||""},registerValidator:o.register,getValidator:o.get,registerEnumManager:p.register,getEnumManager:p.get},r={extractDatasets:function(a){if(a.datasets){var b=Object.keys(a.datasets);if(b.length)return b.map(function(b){var c=$.extend({},a.datasets[b],!0);return c.name=b,c})}return null},isQuery:function(a){return!("odata"!==a.$type||a.$method&&"GET"!==a.$method.toUpperCase()||a.$params.hasOwnProperty("$entityId"))},isCreateOrUpdate:function(a){return"odata"===a.$type&&a.$params.hasOwnProperty("$entityId")},extractMainDataSource:function(a){var b=null;if(a.datasets){var c=Object.keys(a.datasets);c.length&&(c.forEach(function(c){a.datasets[c].$main&&(b=$.extend({},a.datasets[c],!0))}),b||(b=$.extend({},a.datasets[c[0]],!0)))}return b},datasetsAsPromise:function(a,b){return new g.Promise(function(c,d){var f={};e.processing(!0);var g=null;a.forEach(function(a){a.$main&&(g=a)}),g||(g=a[0]),r.isCreateOrUpdate(g)&&(g.$create=g.$create||{}),k.executeDatasets(a,{},f,{},function(a,h){if(e.processing(!1),h)d(h);else{if(b){var j=i.get(b);j&&j(f)}c(f[g.name])}})})},datasetAsPromise:function(a,b){return new g.Promise(function(c,d){var f={};a.name=a.name||"data",e.processing(!0),k.executeDatasets([a],b||{},f,{},function(b,g){e.processing(!1),g?d(g):c(f[a.name])})})},loadMainData:function(a){var b=r.extractDatasets(a);return b&&b.length?r.datasetsAsPromise(b,a.transform):g.Promise.resolve(null)},dsConfig:function(a,b,c){var d=b.$reference;if(a&&d){var e=Object.keys(a);if(1===e.length){var f=a[e[0]];return f.$main=!0,f}if("string"==typeof d)return a[d]}return null}},s={_enums:{},promise:function(a,b){var c={};return Object.keys(a).forEach(function(b){var d=a[b];s._enums[b]||(s._enums[b]={"enum":d["enum"],enumNames:d.enumNames,filters:d.filters}),c[b]=s._enums[b]}),new g.Promise(function(a,d){a({type:b,enums:c})})}};q.registerEnumManager("default",s),b.SchemaUtils=q,b.DataUtils=r}(b=a.Observable||(a.Observable={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../core/core.ts" />
/// <reference path="./schema.data.ts" />
var Phoenix;!function(a){var b;!function(a){var b=a.SchemaUtils,c=function(){function a(a,b,c){}return a.prototype.destroy=function(){var a=this;a._state&&(a._state=null),a.parent=null},a.prototype.state=function(){return this._state},a.prototype._init=function(a,b,c,d){var e=this;d=d||[],e._state=c||{},e.name=b,e.parent=a,d.forEach(function(a){void 0===e._state[a]&&(e._state[a]=!1),Object.defineProperty(e,a,{get:function(){return this._state[a]||!1},set:function(b){var c=this,d=c._state[a]||!1;if(d!==b){if(c._state[a]=b,"filter"===a&&c.parent){var f=c.parent.getValue(e.name),g=c.parent.getSchema(e.name);if(g&&g["enum"]&&g.filters){var h=b?g.filters[b]:g["enum"];if(h){var i=h.indexOf(f);0>i&&c.parent.setValue(e.name,h.length?h[0]:null)}}}c.parent&&c.parent.notifyStateChanged&&c.parent.notifyStateChanged(e.name+"."+a,{})}},enumerable:!0})})},a}();a.BaseState=c;var d=function(a){function c(c,d,e){a.call(this,c,d,e);var f=c.getSchema("").properties[d],g=b.states;if(f){var h=b.stateProps(f);h&&h.length&&(g=h.concat(g))}this._init(c,d,e,g)}return __extends(c,a),c}(c);a.DataStates=d;var e=function(a){function c(c,d,e){a.call(this,c,d,e),this._init(c,"$links."+d,e,b.linksStates)}return __extends(c,a),c}(c);a.LinkStates=e}(b=a.Observable||(a.Observable={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../core/core.ts" />
/// <reference path="./schema.data.ts" />
var Phoenix;!function(a){var b;!function(a){var b={errorChanged:function(a,b){if(b&&b.length){if(a.length!=b.length)return!0;for(var c=!1,d=0,e=a.length;e>d;d++){var f=a[d],g=b[d];if(f.code&&g.code){if(f.code!==g.code){c=!0;break}}else{if(!f.code||!g.code){c=!0;break}if(f.message!==g.message){c=!0;break}}}return c}return a.length?!0:void 0}},c=function(){function a(a,b,c,d){this._init(a,b,c,d)}return a.prototype.destroy=function(){var a=this;a._errors&&(a._errors=null),a.parent=null},a.prototype.errors=function(){return this._errors},a.prototype.clear=function(a){var b=this;return b._errors.length?(b._errors.length=0,a&&b.notify(),!0):!1},a.prototype.hasErrors=function(){var a=this;return!(!a._errors||!a._errors.length)},a.prototype.addErrors=function(a,c){var d=this;d.nostore?d.parent&&d.parent.addErrors&&d.parent.addErrors(a,c):(c||b.errorChanged(d._errors,a))&&(d._errors=a||[],d.notify())},a.prototype.addError=function(a,b){var c=this;c.addErrors([{severity:"error",message:a}],b)},a.prototype.addSuccess=function(a,b){var c=this;c.addErrors([{severity:"success",message:a,timeout:2}],b)},a.prototype.addWarning=function(a,b){var c=this;c.addErrors([{severity:"warning",message:a,timeout:2}],b)},a.prototype.notify=function(){var a=this;a.parent&&a.parent.notifyStateChanged&&a.parent.notifyStateChanged(a.name+".errors",{})},a.prototype._init=function(a,b,c,d){var e=this;e._errors=c||[],e.name=b,e.parent=a,e.nostore=d},a}();a.Errors=c,a.errorsUtils=b}(b=a.Observable||(a.Observable={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../core/core.ts" />
/// <reference path="./schema.data.ts" />
/// <reference path="../datasets-plugin.ts" />
...
var Phoenix;!function(a){var b;!function(b){var c=b,d=c.SchemaUtils,e=c.DataUtils,f=a.utils,g=a.ajax,h=(a.locale,a.ulocale),i=a.locale.schema,j=function(a,b){d.inModel(a._schema.properties[b])&&Object.defineProperty(a,b,{get:function(){var a=this,c=a._children[b];if(c){if(c.isNull)return null;if(c.isUndefined)return;return c}return a._model[b]},set:function(a){var c=this,e=c._model[b];if(e!==a&&c._beforeChange(b,e,a)){c._model[b]=a;var f=c._schema.properties[b];d.isCompositionRef(f)?(c._setRefChild(b,e,a,{}),c._notifyChanged(b,e,a,"propchange",{},!0),c.notifyStateChanged(b,{})):d.isCompositionList(f)?(c._setListChild(b,e,a,"propchange",{}),c._notifyChanged(b,e,a,"propchange",{},!0),c.notifyStateChanged(b,{})):d.isSimpleList(f)?(c._setSimpleListChild(b,e,a,"propchange",{}),c._notifyChanged(b,e,a,"propchange",{},!0),c.notifyStateChanged(b,{})):d.isList(f)||c._notifyChanged(b,e,a,"propchange",{},!0)}},enumerable:!0})},k=function(a,b,e){var f=a._schema.properties[b];d.inModel(f)&&(a.$states[b]=new c.DataStates(a,b,e))},l=function(a,b,e){var f=a._schema.properties[b];d.inModel(f)&&(a.$errors[b]=new c.Errors(a,b,e,d.isCompositionRef(f)))},m=function(a,b,d){a.$links[b]=new c.LinkStates(a,b,d)},n={setValue:function(a,b,c,d){c.setValue(a,b,d)},getValue:function(a,b,c){return b.getValue(a,c)},getState:function(a,b,c){return b.getState(a,c)},_resolveSegment:function(a,b,c,d,e,f){if("$item"!==a)return"$new"===a?(f&&(c[a]=e),c[a]):c&&c[a]&&"function"==typeof c[a]?f?c[a](e):c[a]():(f&&(c[a]=e),c[a]);if(d){var g=d[b];if(g&&void 0!=g.$index)return f&&(c[g.$index]=e),c[g.$index]}}},o=function(){function a(a,b,c,d,e,f){var g=this;g._map={},g._selected=[],g._model=[],g._items=[],g._path=c,g._parent=b,g._locale=f,g._arrayParent=e,g._schema=a,g.frozen=!1,g._setModel(d,!1),g._createCustomProps()}return a.prototype.pushSelected=function(a){var b=this,c=b._selected.indexOf(a);0>c&&b._selected.push(a)},a.prototype.removeSelected=function(a){var b=this,c=b._selected.indexOf(a);c>=0&&b._selected.splice(c,1)},a.prototype.notifyChangedProperty=function(a){var b=this;b._parent._notifyChanged(b._path,void 0,void 0,a,{},!1)},a.prototype.addAjaxException=function(a){var b=this;return b._parent.addAjaxException(a)},a.prototype.notifyPaginationChanged=function(){},a.prototype.notifyCountChanged=function(){this.notifyChangedProperty("count")},a.prototype.notifySortingChanged=function(){},a.prototype.isQueryable=function(){return this._queryable||!1},a.prototype.addErrors=function(a){var b=this,c=b._parent.$errors[b._path];c?c.addErrors(a):b._parent.addErrors(a)},a.prototype.addError=function(a){var b=this,c=[{severity:"error",message:a}];b.addErrors(c)},a.prototype._createCustomProps=function(){var a=this;Object.defineProperty(a,"length",{get:function(){return this._items.length},enumerable:!0})},a.prototype._destroyItems=function(){var a=this;a._items&&(a._model=[],a._items=[])},a.prototype.$orderby=function(a){return""},a.prototype.totalPages=function(){return 1},a.prototype.totalCount=function(){return this._items.length},a.prototype.destroy=function(){var a=this;a._parent=null,a._arrayParent=null,a._destroyItems(),a._model=null,a._schema=null},a.prototype._fillItems=function(){var a=this;a._model.forEach(function(b,c){a._items.push(b)})},a.prototype._setModel=function(a,b){var c=this;c.isNull=null===a,c.isUndefined=void 0===a,a=a||[];var d=c.frozen;b&&(c.frozen=!0),
// remove && destroy items 
c._destroyItems(),c._model=a,c._fillItems(),c.frozen=d},a.prototype.setModel=function(a){var b=this;b._setModel(a,!0),b._parent._notifyChanged(b._path,void 0,void 0,"set",{},!1),b.notifyCountChanged(),b._parent.notifyStateChanged(b._path,{})},a.prototype.updateParams=function(a,b,c){var d=this,e=d._items.indexOf(a);b=b?"$item."+b:"$item";var f=[];return a._getFullPath(f),c[f.join(".")]={$index:e,$value:a},b},a.prototype.indexOf=function(a){return this._items.indexOf(a)},a.prototype.find=function(a){for(var b=[],c=1;c<arguments.length;c++)b[c-1]=arguments[c];for(var d=a.split(","),e=d.length,f=0,g=this._items.length;g>f;f++){for(var h=!0,i=this._items[f],j=0;e>j;j++)if(b[j]!==i[d[j]]){h=!1;break}if(h)return i}return null},a.prototype.forEach=function(a){return this._items.forEach(a)},a.prototype.get=function(a){return this._items[a]},a}();b.DataListCore=o;var p=function(a){function b(){a.apply(this,arguments)}return __extends(b,a),b.prototype._fillItems=function(){var a=this;a._map={},a._selected=[],a._model.forEach(function(b,c){var d=new t(a._schema.items,a._parent,a._path,b,a,!1,a._locale,null);a._items.push(d),a._map[d.$id]=d})},b.prototype._destroyItems=function(){var a=this;a._map={},a._selected=[],a._items&&(a._items.forEach(function(a){a.destroy()}),a._model=[],a._items=[])},b.prototype.selectRow=function(a,b,c){var d=this,e=d.findById(a);if(b&&!e.$selected){if(c){var f=d._selected.slice(0);f.forEach(function(a){var b=d.findById(a);b&&(b.$selected=!1)})}e.$selected=!0}},b.prototype.findById=function(a){return this._map[a]},b.prototype.indexOf=function(a){var b=this;return"object"!=typeof a&&(a=b.findById(a)),a?b._items.indexOf(a):null},b}(o);b.DataListBase=p;var q=function(a){function c(c,d,f,g,h,i,j,k,l,m){a.call(this,d,f,g,h,l,m);var n=this,o=n._parent.getRootModel(),p=e.dsConfig(o.datasets,d,!0);if(!p)throw'Invalid config! You must define a dataset in form for the property: "'+g+'".';n._main=p.$main,n._queryable=!0,n._query=new b.QueryableDataSource(p,n),n._query.initPagination(i,j,k),n._main&&o&&(o.onRefresh=function(a){var b=a&&a.resetPagination;n.$refresh(b)})}return __extends(c,a),Object.defineProperty(c.prototype,"filter",{get:function(){return this._query.filter},set:function(a){this._query.filter=a,this.notifyChangedProperty("filter")},enumerable:!0,configurable:!0}),c.prototype.totalPages=function(){return this._query.totalPages()},c.prototype.totalCount=function(){return this._query.totalCount()},c.prototype.$refresh=function(a){this._query.refresh(a)},c.prototype.$orderby=function(a){return this._query.orderBy(a)},c.prototype.notifyPaginationChanged=function(){this.notifyChangedProperty("pagination")},c.prototype.notifyFilterChanged=function(){this.notifyChangedProperty("filter")},c.prototype.notifySortingChanged=function(){this.notifyChangedProperty("sorting")},c.prototype.currentPage=function(a){return void 0!=a?this._query.currentPage(a):this._query.currentPage()},c.prototype._removeItem=function(a,b){var c=this;if(c._query){var d=c._query.remove(a,b);d.then&&d.then(function(){c.$refresh(!(c._items.length>1))})}},c.prototype.remove=function(a){var b=this,c=a.model(!0),e=c?c["@odata.etag"]:null;if(b._schema.items&&b._schema.items.primaryKey){var g=d.odataId(d.pkFields(b._schema.items.primaryKey),a);if(b._schema.items.links&&b._schema.items.links.$remove&&b._schema.items.links.$remove.confirm){var i=b._schema.items.links.$remove.confirm;b._locale&&(i=h.tt(i||"",b._locale)),f.confirm(null,i,function(){b._removeItem(g,e)})}else b._removeItem(g,e)}},c.prototype.destroy=function(){var b=this;if(b._query&&(b._query.destroy(),b._query=null),b._main){var c=b._parent.getRootModel();c&&(c.onRefresh=null)}a.prototype.destroy.call(this)},c}(p);b.QueryList=q;var r=function(a){function b(){a.apply(this,arguments)}return __extends(b,a),b.prototype.push=function(a){var b=this;b._model.push(a),b._items.push(a),b._parent._notifyChanged(b._path,void 0,a,"add",{$index:b._items.length-1,$value:a,$id:a},!1),b.notifyCountChanged()},b.prototype.remove=function(a){var b=this,c=b._items.indexOf(a);c>=0&&(b._items.splice(c,1),b._model.splice(c,1),b._parent._notifyChanged(b._path,void 0,a,"remove",{$index:c,$value:a,$id:a},!1),b.notifyCountChanged())},b}(o);b.SimpleTypeList=r;var s=function(a){function b(b,c,d,e,f,g){a.call(this,b,c,d,e,f,g);var h=this;h._createNewItem(!0)}return __extends(b,a),b.prototype._createNewItem=function(a){var b=this,c=d.init(b._schema.items,null);a&&Object.defineProperty(b,"$new",{get:function(){return this._new},set:function(a){this._new._setModel(a,!0),this._new._notifyChanged("",void 0,a,"propchange",{}),this._new.notifyStateChanged("",{})},enumerable:!0}),b._new=new t(b._schema.items,b._parent,b._path+".$new",c,null,!0,b._locale,null),b._new._notifyChanged("",void 0,c,"propchange",{},!1),b._new.notifyStateChanged("",{})},b.prototype.updateItem=function(a,b){var c=this;
// validate
if(!b.validate())return!1;
// clear errors 
b.$errors.$.addErrors([],!1);
// validate primary key
var e=b._getModel(!0);if(c._schema.items.primaryKey){var g=d.pkFields(c._schema.items.primaryKey),h=d.extractPkValue(e,g),j=(d.extractPkValue(a._getModel(!0),g),d.findByPk(h,g,c._items));if(j&&j!==a){
...
/// <reference path="../schema.data.ts" />
/// <reference path="../form.control.ts" />
var Phoenix;!function(a){var b;!function(b){var c=(a.render,b),d=a.dom,e=a.device,f=a.Observable,g=a.bootstrap4,h=a.ulocale,i=a.locale,j=a.customData,k=f.SchemaUtils,l=function(a,b,c,d,e){c=c||!1,d=d||"",c&&(b="*"),e=e||{};var f=e.lookup||!1;e.readOnly?j.register("ui-controls-readonly-"+d,a):j.register("ui-controls-"+b+"-"+c+"-"+f+"-"+d,a)},m=function(a,b,c,d){b=b||!1,b&&(a="*"),c=c||"";var e=!(!d||!d.lookup),f=!(!d||!d.readOnly);return f?j.get("ui-controls-readonly-"+c):j.get("ui-controls-"+a+"-"+b+"-"+e+"-"+c)},n=function(){var a=!1,b=!1;return function(){if(b)return a;if(b=!0,e.phone||e.tablet){var c=document.createElement("input");return c.setAttribute("type","date"),a="date"===c.type}return!1}},o=function(){var a=!1,b=!1;return function(){if(b)return a;if(b=!0,e.phone||e.tablet){var c=document.createElement("input");return c.setAttribute("type","number"),a="number"===c.type}return!1}},p=function(a,b,c){var d=j.get("ui.html."+c);return d?{value:d(a,b),html:!0}:{value:b,html:!1}},q=function(a,b){var c=a.avanced.icons[b],e=[];c&&e.push(d.iconClass(c));var f=a.tableOptions&&a.tableOptions.small?" small-table":"",g='<center class="bs-image-center'+f+'"><span class="'+e.join(" ")+'"> </span></center>';return{value:g,html:!0}},r={useDatePicker:function(){return!r.nativeDate()&&null!=$.fn.datepicker},nativeDate:n(),nativeNumber:o(),addErrorDiv:function(a){a.push('<div class="small text-danger bs-none" id="{0}_errors"></div>')},keyPressPassword:function(a){var b=a.which;return b===d.keys.VK_SPACE?(a.preventDefault(),!1):!0},keyPressCode:function(a){var b=a.which;return b===d.keys.VK_SPACE?(a.preventDefault(),!1):!0},keyPressNumber:function(a){var b="-0123456789,."+i.number.decimal,c=a.which;if(!a.metaKey&&d.ignoreKeys.indexOf(c)<0){var e=String.fromCharCode(c);if(b.indexOf(e)<0)return a.preventDefault(),!1}return!0},getRegisterdControl:m,addContainerId:function(a,b){b&&a.push(' draggable="true"'),a.push(' data-render="{0}"'),a.push(' id="{0}"')},containerBaseClass:function(a,b,c){var d=[a,c.groupFieldClass||"bs-field-group","bs-island"];return c.inline&&d.push(c.inlineFieldClass||"bs-field-inline"),b&&d.push(" design"),d.join(" ")},fieldWrapper:function(a,b,c,d,e){b.inline&&(b.columns=!1);var f=e&&e.formGroup?e.formGroup:"form-group",h=[r.containerBaseClass(f,c,b)],i=e&&e.tag?e.tag:"div";a.push("<"+i+' class="'),b.size&&!g&&h.push("form-group-"+b.size),b.columns&&(g||h.push("form-horizontal"),h.push("row")),b.styles&&h.push(b.styles),b.right&&h.push(" pull-right"),a.push(h.join(" ")),a.push('"'),r.addContainerId(a,c),a.push(">"),d(),a.push("</"+i+">")},fillSelect:function(a,b,c){if(b){var e=c.enumNames||c["enum"],f=c["enum"];d.empty(b);var g=document.createDocumentFragment();a.forEach(function(a){var b=f.indexOf(a),c=e[b]||a+"",h=document.createElement("option");d.attr(h,"value",a),h.textContent=c,d.append(g,h)}),d.append(b,g)}},datePickerSetValue:function(a,b){a.datepicker("update",h.parseISODate(b||"")||"")},datePickerInitialize:function(a,b,c){d.addClass(a.get(0),"date");var e=$.extend({language:h.currentLang,autoclose:!0},b||{});a.datepicker(e),c&&a.datepicker().on("hide",c)},datePickerDestroy:function(a){a.datepicker("destroy")},text2value:function(a,b){return k.isDate(b)?c.Utils.nativeDate()?a:h.localeDate2ISO(a):k.isNumber(b)?k.text2Value(a+"",b):a},defaultOptions:{titleIsHidden:!1,placeHolder:!1,labelCol:3},displayValue:function(b,c,e,f){var g;if(f=f||{},void 0===b&&(b=""),c["enum"]){var j=c["enum"].indexOf(b),k=j>=0?c.enumNames?h.tt(c.enumNames[j],e):b:"";g=f.avanced&&f.avanced.transform?p(b,k,f.avanced.transform):f.avanced&&f.avanced.icons?q(f,b):{value:k,html:!1}}else switch(c.type){case"string":if(c.format)switch(c.format){case"date":var k=h.shortDate(b||"");g=f.avanced&&f.avanced.transform?p(b,k,f.avanced.transform):{value:k,html:!1}}g||(g=f.avanced.transform?p(b,b,f.avanced.transform):{value:b,html:!1});break;case"number":var l="money"===c.format?a.ulocale.money(b||0,f.useSymbol):h.decimal(b||0,c.decimals||0,f.useSymbol?c.symbol:"");g=f.avanced&&f.avanced.transform?p(b,l,f.avanced.transform):{value:l,html:!1};break;case"integer":var m=h.decimal(b||0,0,"");g=f.avanced&&f.avanced.transform?p(b,m,f.avanced.transform):{value:m,html:!1};break;case"boolean":if(f.avanced&&f.avanced.transform)g=p(b,b?i.ui.Yes:i.ui.No,f.avanced.transform);else if(f.html){var n=[];if(f.avanced&&f.avanced.editable||f.editable||f.check||f.avanced&&f.avanced.icons){var o="",r="bs-cursor-d";f.editable?(o="bs-bool-edit",r="bs-cursor-p"):o="bs-bool";var s=f.tableOptions&&f.tableOptions.small?" small-table":"",t=f.avanced?f.avanced.icons:null;t||(t={"true":"check-square-o","false":"square-o"});var u=t[!!b+""],v=[o,r];u&&v.push(d.iconClass(u)),n.push('<center class="bs-image-center'+s+'"><span data-clickable="true" class="'+v.join(" ")+'"> </span></center>'),g={value:n.join(""),html:!0}}else g={value:b?i.ui.Yes:i.ui.No,html:!1}}else g={value:b?i.ui.Yes:i.ui.No,html:!1}}if(g||(g={value:b,html:!1}),f.html&&f.avanced&&f.avanced.$link){var w=['<a class="bs-cursor-p" data-phoenix-href="link://$link">'];w.push(g.value),w.push("</a>"),g.value=w.join(""),g.html=!0}return g},addTooltip:function(a,b,c){a.push('<span id="{0}_tooltip" data-toggle="tooltip" data-phoenix-tooltip="true" data-placement="auto" title="'+b+'" class="'+d.iconClass("question-circle")+" bs-tooltip-icon"),c&&c.inline&&a.push(" bs-tooltip-icon-inline"),a.push('"></span>')}},s=function(){function a(a,b,c){var d=this;d.config=a,d.form=c,d.parent=d.form.getLayoutById(a.$parentId),d.$bind=a.$bind,d.$display=d.config.$display||d.$bind,a.$lookup&&(d.useDisplay=d.$display!==d.$bind,d.$lookup=d.form.getLookupForSchema(d.$bind,a.$lookup));var e=k.isMeta(d.$bind);e&&(d.$bind=d.getCustomBind()),d.$bind&&c.registerListenerFor(d.$bind,d),d.useDisplay&&c.registerListenerFor(d.$display,d),d._defineProps(),d.options=b||{},d.fieldOptions=a.options||{},d.renderOptions=d.fieldOptions,d.$schema=d.$bind?c.getSchema(d.$bind):{},d.id=a.$id}return a.prototype.targetInControl=function(a){var b=this;if(b.$element){var c=b.$element.get(0);return d.isChildOf(c,a)}return!1},a.prototype.getCustomBind=function(){return""},a.prototype.setHidden=function(a){this.state.isHidden?d.addClass(a,"bs-none"):d.removeClass(a,"bs-none")},a.prototype._state=function(){var a=this;a.state=a.state||{};var b=a.form.getState(a.$bind);a.state.value=a.form.getValue(a.$bind),Object.keys(b).forEach(function(c){a.state[c]=b[c]})},a.prototype._defineProps=function(){},a.prototype.render=function(a){},a.prototype.appendElement=function(a,b){var c=this;a&&(c.options.replaceParent?a.replaceWith(c.$element):a.append(c.$element))},a.prototype.setEvents=function(a){},a.prototype.removeEvents=function(){},a.prototype.customOptions=function(a){},a.prototype._initOptions=function(a){var b=this,c={};
// init default options from parent layout ($fieldsOptions)
b.parent&&b.parent.$fieldsOptions&&(b.parent.$fieldsOptions.columns&&(void 0===c.columns&&(c.columns=b.parent.$fieldsOptions.columns),void 0===c.labelCol&&b.parent.$fieldsOptions.labelCol&&(c.labelCol=b.parent.$fieldsOptions.labelCol)),b.parent.$fieldsOptions.titleIsHidden&&void 0===c.titleIsHidden&&(c.titleIsHidden=!0));var d=$.extend({},a,c,b.fieldOptions);return b.parent.$inline&&(d.inline=!0),b.customOptions(d),b.renderOptions=d,d},a.prototype.destroy=function(){var a=this;a.destroyed=!0,a.$schema=null,a.parent=null,a.$element||(a.removeEvents(),a.$element=null),a.$bind&&a.form.unRegisterListenerFor(a.$bind,a),a.useDisplay&&a.form.unRegisterListenerFor(a.$display,a)},a.prototype.showErrors=function(a,b){var c=this,e=b&&b.length,f=d.find(a,c.id+"_errors");f&&(e?(d.text(f,b[0].message),d.removeClass(f,"bs-none")):d.addClass(f,"bs-none"))},a}();if(b.AbsField=s,r.useDatePicker){var t=function(a){$.fn.datepicker.dates[a]={days:i.date.weekdays,daysShort:i.date.weekdaysShort,daysMin:i.date.weekdaysMin,months:i.date.months,monthsShort:i.date.monthsShort,today:i.date.today,clear:i.date.clear,format:i.date.dateShort.replace(/\//g,i.date.daySep),titleFormat:"MM yyyy",weekStart:i.date.weekStart}};t(h.currentLang),h.register(t)}b.Utils=r,b.registerControl=l}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/index.d.ts" />
/// <reference path="../../../core/core.ts" />
...
/// <reference path="../schema.data.ts" />
/// <reference path="../../../core/locale.ts" />
var Phoenix;!function(a){var b;!function(b){var c=b,d=a.utils,e=a.dom,c=b,f=a.ulocale,g=a.Observable.SchemaUtils,h=function(a,b,c,d){c&&d.push(' draggable="true"'),d.push(' data-render="{0}"')},i=function(a,b){var c=e.icon(b?"caret-up":"caret-down");e.addClass(c,"bs-basictable-sort"),e.attr(c,"sort","true"),e.append(a,c)},j=function(a){a.lastElementChild&&"true"===e.attr(a.lastElementChild,"sort")&&e.remove(a.lastElementChild)},k=function(a,b,c,d){if(a.sorting&&b&&b.childElementCount){var f=(d||"").split(" ");f.length||(f=[""]);for(var g=0,h=b.children.length-1;h>g;g++){var k=b.children[g],l=e.attr(k,"colId");f[0]===l?(j(k),i(k,1==f.length)):j(k)}}},l=function(a){return"number"==typeof a?a+"px":parseInt(a,10)+" "===a.trim()?a.trim()+"px":a},m=function(a,b){var c=document.createElement("tr");c.className="bs-table-row-detail",c.id=a+"_detail";var d=document.createElement("td");return d.colSpan=b.childNodes.length,e.append(c,d),c},n=function(a,b,c){var d=document.createDocumentFragment();return a.forEach(function(a){var b=document.createElement("col");a.options.width&&(b.style.width=l(a.options.width)),a.options.minWidth&&(b.style.minWidth=l(a.options.minWidth)),e.append(d,b)}),d},o=function(a,b,c,d,h,j,k){var m=document.createDocumentFragment(),n=(j||"").split(" ");return b.forEach(function(a,b){var d,k=document.createElement("th");e.attr(k,"colId",a.$bind),c._useColGrp||(a.options.width&&(k.style.width=l(a.options.width)),a.options.minWidth&&(k.style.minWidth=l(a.options.minWidth))),d&&(k.className=d.join(" ")),a.isLink||e.append(k,document.createTextNode(f.tt(a.title||String.fromCharCode(160),h))),c.sorting&&g.canSort(a.schema)&&(d=d||[],d.push("bs-cursor-p"),n&&n.length&&n[0]===a.$bind&&i(k,1===j.length)),d&&(k.className=d.join(" ")),e.append(m,k)}),m},p=function(a,b,c,d,f,g,h){var i=document.createDocumentFragment();return b&&b.forEach(function(b,j){e.append(i,q(a,j,b,c,d,f,g,h))}),i},/*
        *  row: {name: fieldName, schema: {}}
        */
q=function(a,b,d,f,g,h,i,j){var k=document.createElement("tr");return"middle"===h.align&&e.addClass(k,"bs-va-middle"),g.forEach(function(a,g){var i=document.createElement("td");if(0==g)e.append(i,document.createTextNode(d.schema.title||String.fromCharCode(160)));else{e.attr(i,"rowId",a.id),e.attr(i,"colId",d.name),i.rowIndex=b,i.colIndex=g-1;var l=f.get(g-1),m=c.Utils.displayValue(l.getRelativeValue(d.name),d.schema,j,{html:!0,useSymbol:!0,editable:d.canEdit,check:d.check,avanced:null,tableOptions:h});if(m.html){var n=$(m.value);e.append(i,n.get(0))}else e.append(i,document.createTextNode(m.value))}e.append(k,i)}),k},r=function(a,b){var c=!!(a.allowFrozenColumns&&b&&b.length);return c},s=function(a,b,c,d){if(c.selecting&&c.selecting.row){var f=[],g=e.find(d,a);g&&f.push(g),c.allowFrozenColumns&&(g=e.find(d,a+"_frozen"),g&&f.push(g)),f.forEach(function(a){b?e.addClass(a,"bs-row-selected"):e.removeClass(a,"bs-row-selected")})}},t=function(a,b,d,f,h,i,j,k,m){var n=document.createElement("tr");n.id=d.$id+(m?"_frozen":"");var o=["bs-table-row"];if("middle"===h.align&&o.push("bs-va-middle"),d.$selected&&h.selecting&&h.selecting.row&&o.push("bs-row-selected"),n.className=o.join(" "),!h._useStripedCss){var p=b%2===1;p||e.addClass(n,"even")}return f.forEach(function(a,f){var i=document.createElement("td");0===b&&h.headerIsHidden&&!h._useColGrp&&(a.options.width&&(i.style.width=l(a.options.width)),a.options.minWidth&&(i.style.minWidth=l(a.options.minWidth)));var k=[];a.schema&&g.isNumber(a.schema)&&k.push("nowrap"),a.options.align&&("center"==a.options.align?k.push("align-center"):"right"==a.options.align&&k.push("align-end")),k.length&&(i.className=k.join(" ")),e.attr(i,"colId",a.$bind);var m=d.getRelativeState(a.$bind);if(m.isHidden);else if(a.isLink){var o=void 0,p=void 0;if(a.options.button){var q="";o=document.createElement("button"),o.type="button",m.isDisabled&&(o.disabled=!0);var r="normal"===a.options.size?"":" btn-"+(h.size||"sm");if(o.className="bs-button btn btn-"+(a.options.type||"link")+r+(m.isDisabled?" disabled":""),a.options.icon&&(p=document.createElement("span"),p.className=e.iconClass(a.options.icon),e.append(o,p),q=" "),a.schema.title){var s=document.createTextNode(q+a.schema.title);e.append(o,s)}}else if(a.options.icon){o=document.createElement("center"),m.isDisabled&&e.addClass(o,"bs-disabled"),p=document.createElement("span");var t=["text-"+(a.options.type||"default")];t.push("bs-basictable-btn"),t.push(e.iconClass(a.options.icon)),p.className=t.join(" "),e.append(o,p)}o&&(o.$link=a.$bind,e.append(i,o))}else{var u=i,v=a.options||{},w=v.editable&&!m.isDisabled&&!m.isReadOnly,x=c.Utils.displayValue(d.getRelativeValue(a.$bind),a.schema,j,{html:!0,useSymbol:!1,selectable:v.selectable,editable:w,check:v.check,avanced:v,tableOptions:h});if(x.html){var y=$(x.value);e.append(u,y.get(0))}else e.append(u,document.createTextNode(x.value))}e.append(n,i)}),n},u=function(a,b,c,d,f,g,h){var i=document.createDocumentFragment();return b&&b.forEach(function(b,j){var k=j%2===1;e.append(i,t(a,j,b,c,d,f,g,k,h))}),i},v=function(a){for(var b=!0,c=0,d=a.length;d>c;c++){var e=a[c];if(e.options.editable&&!g.isBoolean(e.schema)){b=!1;break}}return b},w=function(a,b){
// all columns have width defined (but not minWidth)
for(var c=!0,d=0,e=b.length;e>d;d++){var f=b[d];if(!f.options.width||f.options.minWidth){c=!1;break}}if(c=c&&"auto"!==a.width,!c){var g=a.scrolling&&a.scrolling.vertical;if(g)throw"To support scrolling vertical, all columns must have explicit widths but not explicit minWidth.";if(a.editing&&!v(b))throw"To support inline editing, all columns must have explicit widths but not explicit minWidth."}return c},x=function(a,b,c){var d=["table"];
//adde
//remove 
...
//    css.push('nowrap');
//}
return b&&d.push("table-header"),!b&&a._useStripedCss&&d.push("table-striped"),a._useColGrp&&d.push("bs-fixed"),b||!a.editing&&!a.nowrap?!b&&a.allowFrozenColumns&&d.push("nowrap"):d.push("nowrap"),d.push("bs-theme"),a.border&&d.push("table-bordered"),a.small&&d.push("bs-style-small-table"),d},y=function(a,b,c){var d=[];return c?d:(a.width&&"auto"!==a.width&&d.push("min-width: "+l(a.width)),d)},z=function(a,b,c,d){var e=b.scrolling&&b.scrolling.vertical,f=x(b,c,d);a.push("<table"),f.length&&a.push(' class="'+f.join(" ")+'"'),a.push(' id="{0}_table'),d&&a.push("_frozen"),c&&a.push("_header"),a.push('"');var g=y(b,c,d);g.length&&a.push(' style="'+g.join(";")+'"'),a.push(">"),
//if (options.description) {
//    html.push("<caption>");
//    _ui.Utils.addTooltip(html, options.description, options);
//    html.push("</caption>");
//}
b._useColGrp&&a.push('<colgroup id="{0}_colgrp'+(d?"_frozen":"")+(c?"_header":"")+'"></colgroup>'),b.headerIsHidden||(c?a.push('<thead><tr class="bs-va-middle" id="{0}'+(d?"_frozen":"")+'_cols"></tr></thead>'):e||a.push('<thead><tr class="bs-va-middle" id="{0}_cols"></tr></thead>')),c||(a.push('<tbody id="{0}'),d&&a.push("_frozen"),a.push('_rows"></tbody>')),a.push("</table>")},A=function(a){var b=0;return a.forEach(function(a){b+=parseInt(a.options.width+"",10)}),b},B=function(a,b,c){var d=A(c),f=e.find(a,b+"_frozen_header_parent");f&&(f.style.width=d+"px")},C=function(a,b,f,g,i,j,k){g=g||"",b._useColGrp=w(b,j),b._useStripedCss=!(b.rows&&b.rows.detail),b=$.extend({right:!1,icon:null,type:"default",width:"auto",height:"auto",size:null,scrolling:{horizontal:!1}},b),void 0!==b.title&&(g=b.title);var l=[],m=["bs-field-group bs-island"];l.push('<div id="{0}" '),l.push(' class="'),f&&m.push("design"),l.push(m.join(" ")),l.push('"'),h(a,b,f,l),l.push(">"),
//create header div
l.push('<div id="{0}_header"></div>'),m=["bs-basictable-group"];var n=b.scrolling&&b.scrolling.horizontal,o=b.scrolling&&b.scrolling.vertical;if((o||b.allowFrozenColumns)&&m.push("border"),n&&!o&&m.push("bs-scroll-x"),l.push('<div id="{0}_focus" class="'),l.push(m.join(" ")),l.push('"'),b.selecting&&(b.selecting.cell||b.selecting.row)&&l.push(' tabindex="0" '),l.push(">"),b.allowFrozenColumns){l.push('<div class="bs-table-cols">');var p=A(k);if(l.push('<div id="{0}_frozen_header_parent"  class="bs-table-frozen-cols" style="width:'+p+'px;">'),o&&!b.headerIsHidden&&(
// parent of frozen header table
l.push('<div id="{0}_table_frozen_header" class="bs-table-header">'),
// frozen header table 
z(l,b,!0,!0),l.push("</div>")),m=["bs-table-content-scroll frozen"],l.push('<div  class="'+m.join(" ")+'">'),m=["bs-table-content frozen"],l.push('<div id="{0}_frozen_scroll" class="'+m.join(" ")+'"'),o){var q=[];if(!b.height||"auto"===b.height)throw"To support scrolling vertical, the grid must have an explicit height.";q.push("height: "+parseInt(b.height+"",10)+"px"),q.length&&l.push(' style="'+q.join(";")+'"')}l.push(">"),l.push('<div  class="'+m.join(" ")+'">'),z(l,b,!1,!0),l.push("</div>"),l.push("</div>"),l.push("</div>"),l.push("</div>"),// bs-table-frozen-cols
l.push('<div class="bs-table-cols-sep"></div>'),l.push('<div class="bs-table-free-cols">')}if(o&&!b.headerIsHidden&&(l.push('<div id="{0}_table_header" class="bs-table-header" style="padding-right:'),l.push(e.scrollbar()),l.push('px;">'),l.push('<div id="{0}_table_header_content" class="bs-table-header-content">'),z(l,b,!0,!1),l.push("</div></div>")),
...
//bs-table-free-cols
return l.push(">"),z(l,b,!1,!1),l.push("</div>"),o&&l.push("</div>"),b.allowFrozenColumns&&(l.push("</div>"),l.push("</div>")),l.push("</div>"),l.push('<center id="{0}_pagination"></center>'),c.Utils.addErrorDiv(l),l.push("</div>"),d.format(l.join(""),a)},D=function(a,b,c,e,f,g,h,i){var j=e.filter?h.schema.filters[e.filter]||[]:h.schema["enum"],k=j.indexOf(c);0>k?(d.nextTick(function(){g.item.setValue(h.$bind,j[0])}),a.input.selectedIndex=0):a.input.selectedIndex=k},E=function(a,b,c,d,e,f,h,i){return h.schema["enum"]?D(a,b,c,d,e,f,h,i):(b=b||"",g.isNumber(h.schema)?void(a.input.value=i.nativeNumber?c:b):g.isDate(h.schema)?void(a.input.value=i.nativeDate?c:b):void(a.input.value=b))},F=function(a,b,f,g,h,i,j){var k=document.createElement("select");k.type="text";var l=["bs-inplace-edit bs-edit-border bs-inplace-edit-size"];k.className=l.join(" ");var m=f.filter?i.schema.filters[f.filter]||[]:i.schema["enum"],n=m.indexOf(b);return c.Utils.fillSelect(m,k,i.schema),e.empty(g),e.addClass(g,"focused"),e.append(g,k),0>n?(d.nextTick(function(){h.item.setValue(i.$bind,m[0])}),k.selectedIndex=0):k.selectedIndex=n,{input:k,parent:k,td:g,isInputElement:!0,canSelect:!1,schema:i.schema}},G=function(a,b,d,h,i,j,k){var l=document.createElement("div");l.className="bs-inplace-parent bs-edit-border ";var m=l;k.after&&(m=document.createElement("div"),m.className="bs-input-group",l.appendChild(m));var n=g.isDate(j.schema)&&c.Utils.useDatePicker(),o=document.createElement("input");o.type=k.type||"text";var p=["bs-inplace-edit bs-inplace-edit-size"];if(k.after&&p.push("bs-input-group-main"),o.className=p.join(" "),e.append(m,o),k.after){var q=document.createElement("span");q.tabIndex=-1,q.className="bs-input-group-addon bs-cursor-d add-on";var r=document.createElement("span");r.className=e.iconClass(k.after.icon),e.append(q,r),e.append(m,q)}return e.empty(h),e.addClass(h,"focused"),e.append(h,l),g.isDate(j.schema)&&(n?(c.Utils.datePickerInitialize($(l),{showOnFocus:!1},function(a){}),c.Utils.datePickerSetValue($(l),b)):o.value=f.isoDatePart(b||"")),{input:o,parent:l,td:h,isInputElement:!0,canSelect:!0,schema:j.schema}},H=function(a){if(a.childNodes.length)for(var b=!1,c=0,d=a.childNodes.length;d>c;c++){var f=a.childNodes[c];e.hasClass(f,"bs-table-row")&&(b?e.removeClass(f,"even"):e.addClass(f,"even"),b=!b)}},I=function(a,b,c,d,h,i,j){if(i.schema["enum"])return F(a,b,c,d,h,i,j);if(g.isBoolean(i.schema))return{input:null,parent:null,td:d,isInputElement:!1,canSelect:!1,schema:i.schema};if(j.after||j.before)return G(a,b,c,d,h,i,j);var k=document.createElement("input");k.type=j.type||"text";var l=["bs-inplace-edit bs-edit-border bs-inplace-edit-size"];return i.options.align&&("center"===i.options.align?l.push("align-center"):"right"===i.options.align&&l.push("align-end")),"text"===k.type&&i.schema.maxLength&&(k.maxLength=i.schema.maxLength),k.className=l.join(" "),e.empty(d),e.addClass(d,"focused"),e.append(d,k),g.isDate(i.schema)?j.nativeDate?k.value=f.isoDatePart(b||""):k.value=f.shortDate(b||""):g.isNumber(i.schema)&&j.nativeNumber?k.value=b||0:k.value=a,{input:k,parent:k,td:d,isInputElement:!0,canSelect:!0,schema:i.schema}},J={createCols:o,createColGroup:n,updSorting:k,gridContainer:C,createRows:u,createRow:t,setRowsSelected:s,createGridRows:p,createInplaceEdit:I,updateInplaceEdit:E,createDetail:m,updateEvenOdd:H,ensureWidth:l,updateFrozenWidth:B,hasFrozenColumns:r};b.GridUtil=J}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/index.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="../../../core/locale.ts" />
/// <reference path="./absfield.control.ts" />
...
var Phoenix;!function(a){var b;!function(b){var c=b,d=(a.utils,a.dom),c=b,e=a.ulocale,f=c.GridUtil,g=a.Observable.errorsUtils,h=a.link,i=a.locale,j=a.Observable.SchemaUtils,k=function(a,b){return b===d.keys.VK_TAB&&a.shiftKey?!1:a.altKey||a.ctrlKey||a.metaKey||a.shiftKey},l=function(a){a=(a||"")+"",a=a.trim();var b=parseInt(a,10);return b+""===a||b+"px"===a||b+" px"===a};b.glbGridFilter=null;var m=function(a){function m(b,c,d){a.call(this,b,c,d);var e=this;d.registerListenerFor(e.$bind+".$item",e),e._state(),e._mapCols={},e._initCols(b.options||{}),e._details=[]}return __extends(m,a),m.prototype._inplaceEditValue2Model=function(a,b,c){var d=j.text2Value(a,c.schema),e=b.getValue(c.$bind);return d!==e?(b.setValue(c.$bind,d),!0):!1},m.prototype._inplaceEditAcceptKeys=function(a){var b=this;if(b.inplace.schema["enum"]){if(a===d.keys.VK_UP||a===d.keys.VK_DOWN)return!1}else if(j.isDate(b.inplace.schema)&&c.Utils.useDatePicker()&&(a===d.keys.VK_UP||a===d.keys.VK_DOWN||a===d.keys.VK_LEFT||a===d.keys.VK_RIGHT))return!1;return!0},m.prototype._inplaceEditAddEvents=function(){var a=this;a.inplace.schema["enum"]&&$(a.inplace.input).on("change",function(b){var c=a.inplace.td,d=a._td2value(c),e=a._inplaceEditGetValue(d);a._inplaceEditValue2Model(e,d.item,d.col)||a._modifyCell(d.item,d.col.$bind,c)})},m.prototype._inplaceEditRemoveEvents=function(){var a=this;a.inplace.schema["enum"]?$(a.inplace.input).off("change"):j.isDate(a.inplace.schema)&&c.Utils.useDatePicker()&&b.Utils.datePickerDestroy($(a.inplace.parent))},m.prototype._inplaceEditGetValue=function(a){var b=this;if(b.inplace.schema["enum"]){if(!a.item)return null;var d=b.inplace.input.selectedIndex,e=a.item.getState(a.col.$bind);return e.filter?b.inplace.schema.filters[e.filter][d]:b.inplace.schema["enum"][d]}return c.Utils.text2value(b.inplace.input.value,b.inplace.schema)},m.prototype._inpaceEditShow=function(a,b){var e=this,g=e._td2value(a),h=g.item.getValue(g.col.$bind),i=g.item.getState(g.col.$bind),k=j.value2Text(h,g.col.schema);a.tabIndex=-1;var l={nativeNumber:!1,nativeDate:!1,type:"text",after:null};j.isDate(g.col.schema)?(l.nativeDate=c.Utils.nativeDate(),l.nativeDate?l.type="date":c.Utils.useDatePicker()&&(l.after={icon:"calendar"})):j.isNumber(g.col.schema)&&(l.nativeNumber=c.Utils.nativeNumber(),l.nativeNumber&&(l.type="number")),e.inplace=f.createInplaceEdit(k,h,i,a,g,g.col,l),e._inplaceEditAddEvents(),e.inplace.isInputElement?(e.inplace.input.tabIndex=0,e.inplace.input.focus(),e.inplace.canSelect&&d.select(e.inplace.input)):(
// focus on td ?
a.tabIndex=0,a.focus())},m.prototype._inplaceEditRemove=function(a,b){var c=this;if(c.inplace&&!b){var e=c.inplace.td;a&&(e.tabIndex=0);var f=c._td2value(e);c._inplaceEditRemoveEvents(),c.inplace.parent&&d.remove(c.inplace.parent),d.removeClass(e,"focused");var g=!!c.inplace.input;if(g){var h=c._inplaceEditGetValue(f);if(c.inplace=null,!f.item)return;c._inplaceEditValue2Model(h+"",f.item,f.col)||c._modifyCell(f.item,f.col.$bind,e)}}c.inplace=null},m.prototype._inplaceEditModel2Control=function(a,b,d){var e=this,g=e._td2value(d),h=(e._inplaceEditGetValue(g),a.getValue(g.col.$bind)),i=a.getState(g.col.$bind),k=j.value2Text(h,g.col.schema),l={nativeNumber:c.Utils.nativeNumber(),nativeDate:c.Utils.nativeDate()};f.updateInplaceEdit(e.inplace,k,h,i,d,g,g.col,l)},m.prototype.removeEvents=function(){var a=this;a.scrollableMaster&&$(a.scrollableMaster).off("scroll"),a.scrollableFrozenContent&&a.fieldOptions.editing&&$(a.scrollableFrozenContent).off("scroll"),a.scrollableMaster=null,a.scrollableHeaderOfMaster=null},m.prototype.setEvents=function(a){var b=this,c=a.scrolling&&a.scrolling.vertical;if(c){var e=b.$element.get(0);b.scrollableMaster=d.find(e,b.id+"_master_scroll"),b.scrollableHeaderOfMaster=d.find(e,b.id+"_table_header_content");var g=f.hasFrozenColumns(a,b.frozenColumns);b.scrollableFrozenContent=g?d.find(e,b.id+"_frozen_scroll"):null,b.scrollableMaster&&b.scrollableHeaderOfMaster&&$(b.scrollableMaster).on("scroll",b.syncHeaderAndFrozenScroll.bind(b)),b.scrollableFrozenContent&&b.fieldOptions.editing&&$(b.scrollableFrozenContent).on("scroll",b.syncMasterScroll.bind(b))}},m.prototype.destroy=function(){var b=this;b._destroyDetails(),b.columns&&(b.columns.forEach(function(a){a.schema=null}),b.columns=null),b.frozenColumns&&(b.frozenColumns.forEach(function(a){a.schema=null}),b.frozenColumns=null),b.form.unRegisterListenerFor(b.$bind+".$item",b),b._inplaceEditRemove(!1,!0),b._pager&&(b._pager.destroy(),b._pager=null),b._toolBar&&(b._toolBar.destroy(),b._toolBar=null),b._details=null,b._mapCols=null,a.prototype.destroy.call(this)},m.prototype._moveToPage=function(a){var b=this;b.state.value.currentPage(a)},m.prototype._onselectPage=function(a){var b=this;switch(a){case"next":b._moveToPage(Math.min(b._pager.props.totalPages,b._pager.props.currentPage+1));break;case"prev":b._moveToPage(Math.max(0,b._pager.props.currentPage-1));break;case"first":b._moveToPage(1);break;case"last":b._moveToPage(b._pager.props.totalPages);break;default:b._moveToPage(a)}},m.prototype._onSelectToolElement=function(a){var c=this,d=a.name||a.id;return"filter"===a.name&&b.glbGridFilter?b.glbGridFilter(c.filtrableColumns(),c.state.value,c.form.$locale):void c.form.execAction(c.$bind+".$toolbar."+d,{toolElement:a,grid:c})},m.prototype._state=function(){a.prototype._state.call(this);var b=this,d=b.fieldOptions;if(b.state.value.isQueryable()){
// create pager
var e=$.extend({size:"default",selectPage:b._onselectPage.bind(b)},d.pager||{});b._pager=new c.Pager(e);var f=b._pager;f.props.totalPages=b.state.value.totalPages(),f.props.currentPage=b.state.value.currentPage()}var g=[];if(d.toolbar&&d.toolbar.items){var h=$.extend(!0,{},d.toolbar);h.items.forEach(function(a){"count"===a.type&&(a=$.extend({name:"count",right:!0,value:b.state.value.totalCount()},a)),"filter"===a.type&&(a=$.extend({name:"filter",value:b.state.value.filter||"",icon:"filter"},a)),g.push(a)})}if(g.length){var e=$.extend({selectToolElement:b._onSelectToolElement.bind(b)});b._toolBar=new c.ToolBar(g,e)}},m.prototype._destroyDetails=function(){
//Destroy all inline "forms" 
var a=this;if(a._details){var b=c.formManager();a._details.forEach(function(a){var c=b.formByName(a);c&&c.destroy()}),a._details=[]}},m.prototype._destroyDetailById=function(a){var b=this,d=b._details.indexOf(a);d>=0&&b._details.splice(d,1);var e=c.formManager().formByName(a);e&&e.destroy()},m.prototype._initCols=function(a){var b=this;a.columns&&a.columns.length||(a.columns=[{$bind:"$index"}]),b.columns=[],b.frozenColumns=[];var c=a.columns.findIndex(function(a){return"$selected"===a.$bind}),d=a.selecting&&a.selecting.row&&a.selecting.multiselect;d?0>c&&a.columns.splice(0,0,{$bind:"$selected",options:{width:50,frozen:!0,editable:!0}}):c>=0&&a.columns.splice(c,1),a.columns.forEach(function(c){var d=$.extend({},c);if(d.options=d.options||{},!d.options.isHidden){if(d.schema||(d.schema=j.getSchema(c.$bind,b.$schema.items)),!d.schema)return void console.log("Field (bind) not found : "+c.$bind);if(d.title=e.tt(d.options.title||d.schema.title,b.form.$locale),j.isLink(c.$bind)&&(d.isLink=!0),d.options.frozen&&a.allowFrozenColumns)return d.options.width?(l(d.options.width)||(d.options.width=50),b.frozenColumns.push(d),void(b._mapCols[c.$bind]={column:d,index:b.frozenColumns.length-1})):void console.log('Invalid frozen column "'+d.$bind+'": no explicit width');b.columns.push(d),b._mapCols[c.$bind]={column:d,index:b.columns.length-1}}})},m.prototype._colByField=function(a){var b=this._mapCols[a];return b?b.column:null},m.prototype.changed=function(a,b,c,d,e){var g=this;if(g.$element){var h=!1,i=!1;switch(d){case"count":if(a===e.propName){var j=g._toolBar;j&&j.setValue&&j.setValue("count",g.state.value.totalCount())}break;case"filter":if(a===e.propName){var j=g._toolBar;j&&j.setValue&&j.setValue("filter",g.state.value.filter.title)}break;case"pagination":if(a===e.propName){var k=g._pager;k&&(k.props.totalPages=g.state.value.totalPages(),k.props.currentPage=g.state.value.currentPage())}break;case"sorting":a===e.propName&&g._updateSorting();break;case"set":case"propchange":a===e.propName&&(g._renderRows(),i=!0);break;case"add":g._createRow(e.$id),i=!0,h=!0;break;case"remove":g._removeRow(e.$id),h=!0;break;case"upd":if(a===e.propName){var l=e&&e.$id?g.state.value.findById(e.$id):null;l&&(g._modifyCell(l,e.property),"$selected"===e.property&&f.setRowsSelected(l.$id,l.$selected,g.fieldOptions,g.$element.get(0)))}}h&&g._updOddEven(),i&&g.resize()}},m.prototype._modifyTD=function(a,b,e){var f=this,g=f._colByField(b),h=a.getState(b),i=g.options||{},j=i.editable&&!h.isDisabled&&!h.isReadOnly,k=c.Utils.displayValue(a.getValue(b),g.schema,f.form.$locale,{html:!0,useSymbol:!1,editable:j,selectable:i.selectable,check:i.check,avanced:i,tableOptions:f.config.options});if(d.empty(e),k.html){var l=$(k.value);d.append(e,l.get(0))}else d.append(e,document.createTextNode(k.value))},m.prototype._findTR=function(a,b){var c=this,e=c.renderOptions,f=a+(b.options.frozen&&e.allowFrozenColumns?"_frozen":"");return d.find(c.$element.get(0),f)},m.prototype._id2rowId=function(a){var b=a.indexOf("_frozen");return b>0&&(a=a.substring(0,b)),a},m.prototype._findtBody=function(a){var b=this,c=b.renderOptions,e=b.id+(a.options.frozen&&c.allowFrozenColumns?"_frozen_rows":"_rows");return d.find(b.$element.get(0),e)},m.prototype._modifyCell=function(a,b,c){var e=this;if(e.$element){if(c)return e.inplace&&e.inplace.input&&e.inplace.td===c?void e._inplaceEditModel2Control(a,b,c):e._modifyTD(a,b,c);var f=e._colByField(b);if(f){var g=e._findTR(a.$id,f);if(g)
//TODO: optimize
for(var h=0,i=g.childNodes.length;i>h;h++){var j=g.childNodes[h],k=d.attr(j,"colid");if(k===b){if(e.inplace&&e.inplace.input&&e.inplace.td===j)return void e._inplaceEditModel2Control(a,b,j);e._modifyTD(a,b,j)}}}}},m.prototype._rootElement=function(){return this.$element.get(0)},m.prototype._gridParentFocus=function(){var a=this;return d.find(a.$element.get(0),a.id+"_focus")},m.prototype._setErrors=function(a,b){var c=this,d=c.state.errors;c.showErrors(b,d)},m.prototype._setTableFocus=function(a){var b=this,c=d.find(b.$element.get(0),b.id+"_table");c&&(a?d.addClass(c,"focused"):d.removeClass(c,"focused")),c=d.find(b.$element.get(0),b.id+"_table_frozen"),c&&(a?d.addClass(c,"focused"):d.removeClass(c,"focused"))},m.prototype.focusIn=function(a){var b=this;if(b.$element)if(b._setTableFocus(!0),b.selectedCell){var c=b._cell(b.selectedCell,!0),d=b.canEdit(b.selectedCell);d&&!b.inplace&&b._inpaceEditShow(c.td,!0)}else b._inplaceEditRemove(!1,!1)},m.prototype.focusOut=function(a){var b=this;b.$element&&(b._setTableFocus(!1),b._inplaceEditRemove(!0,!1))},m.prototype._doTab=function(a){var b=this;return a?b._moveDownSelectedCell(1):b._moveUpSelectedCell(1)},m.prototype.keypress=function(a){var b=this;if(b.selectedCell&&b.inplace&&d.isChildOf(b.inplace.td,a.target)){var e=b._td2value(b.inplace.td);if(j.isNumber(b.inplace.schema)){if(c.Utils.keyPressNumber(a)===!1)return!1}else if(j.isBoolean(b.inplace.schema)){if(" "===String.fromCharCode(a.which)&&b.fieldOptions.editing){var f=e.item.getRelativeState(e.col.$bind);if(!f.isDisabled&&!f.isReadOnly){var g=e.item.getValue(e.col.$bind);e.item.setValue(e.col.$bind,!g)}}a.preventDefault()}}},m.prototype.keydown=function(a){var b=this,c=a.which||a.keyCode,e=!1;if(!k(a,c)&&(!b.inplace||!d.isChildOf(b.inplace.td,a.target)||b._inplaceEditAcceptKeys(c))){if(b.fieldOptions.selecting&&b.fieldOptions.selecting.cell)switch(c){case d.keys.VK_TAB:e=b._doTab(!a.shiftKey);break;case d.keys.VK_UP:e=b._moveUpSelectedCell(1);break;case d.keys.VK_DOWN:e=b._moveDownSelectedCell(1)}e&&a.preventDefault()&&a.stopPropagation()}},m.prototype._tr2rowId=function(a,b){var c=a.id;if(b&&b.options.frozen){var d=c.indexOf("_frozen");d>0&&(c=c.substring(0,d))}return c},m.prototype._td2cell=function(a){var b=this,c=a.parentNode,e=(c.parentNode,b._colByField(d.attr(a,"colid")));if(!e)return null;var f=b._tr2rowId(c,e),g=b.state.value.findById(f);return g&&e?{row:f,col:d.attr(a,"colid")}:null},m.prototype._td2value=function(a){var b=this,c=a.parentNode,e=(c.parentNode,b._colByField(d.attr(a,"colid"))),f=b._tr2rowId(c,e),g=b.state.value.findById(f);return{item:g,col:e}},m.prototype.mousedown=function(a){var b=this,c=d.parentByTag(b.$element.get(0),a.target,"td");if(c){var e=b.renderOptions,f=b._td2cell(c);f&&(b._selectCell(f,a,!0)?a.preventDefault():e.selecting&&e.selecting.row&&!e.selecting.cell&&!e.selecting.multiselect&&b._selectRow(f.row))}return!0},m.prototype.click=function(a){var b=this,c=d.parentByTag(b.$element.get(0),a.target,"td");if(c){var e=b._td2cell(c);if(e){
//that._selectCell(cell, event, false);
var f=b.state.value.findById(e.row),g=b._colByField(e.col);if(f){var i=a&&a.target&&a.target.$link||a.target.parentNode.$link;if(i){var k=f.getRelativeState(g.$bind);if(k.isDisabled||k.isHidden)return;g.schema.$widgetAction?b[g.schema.$widgetAction]&&b[g.schema.$widgetAction](f):b.form.execAction(b.$bind+".$item."+i,f)}else if(g){if(g.options.$link){var l=d.findByAttribute(a.target,c,"data-phoenix-href");if(l){var m=f.getRelativeState(g.$bind);m.isDisabled||h.execLink(g.options.$link,{$item:f},null)}}if(b.fieldOptions.editing&&g.options.editable&&j.isBoolean(g.schema)&&d.attr(a.target,"data-clickable")){var m=f.getRelativeState(g.$bind);if(!m.isDisabled&&!m.isReadOnly){var n=f.getValue(g.$bind);f.setValue(g.$bind,!n)}}}}}}else{var o=d.parentByTag(b.$element.get(0),a.target,"th");if(o){var p=d.attr(o,"colid");if(p){var q=b._colByField(p);if(q&&j.canSort(q.schema)){var r=q.$bind,s=b.state.value.$orderby();s===q.$bind&&(r=q.$bind+" desc"),b.state.value.$orderby(r)}}}}},m.prototype._setDisabled=function(a,b){var c=this;a.disabled=c.state.isDisabled},m.prototype._showSelected=function(a,b,c,e){var f=this;if(!a)return null;var g=f._cell(a,!1);g.td&&(b?(d.addClass(g.td,"bs-cell-selected"),f._inplaceEditRemove(!1,!1),c&&(f.focused||e)?f._inpaceEditShow(g.td,!1):(g.td.tabIndex=0,g.td.focus())):(d.removeClass(g.td,"bs-cell-selected"),g.td.tabIndex=-1))},m.prototype.canSelect=function(a){var b=this,c=b.selectedCell;if(c&&c.col===a.col&&c.row===a.row)return!1;if(!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var d=b._colByField(a.col);return d&&d.options.selectable},m.prototype.canEdit=function(a){var b=this;if(!b.fieldOptions.editing||!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var c=b._colByField(a.col),d=c&&c.options.editable;if(d){var e=b.state.value.findById(a.row),f=e.getState(c.$bind);return!f.isReadOnly&&!f.isDisabled}return d},m.prototype.clearSelected=function(){var a=this,b=a.selectedCell;a.selectedCell=null,b&&a._showSelected(b,!1,!0,!1),a._gridParentFocus().tabIndex=0},m.prototype._selectRow=function(a){var b=this;b.state.value.selectRow(a,!0,!0)},m.prototype._selectCell=function(a,b,c){var d=this;if(!d.canSelect(a))return!1;var e=d.selectedCell,f=d.canEdit(a);d._showSelected(a,!0,f,c),d.selectedCell=a,e?d._showSelected(e,!1,!0,c):d._gridParentFocus().tabIndex=-1;var g=d.renderOptions;return g.selecting&&g.selecting.row&&!g.selecting.multiselect&&d._selectRow(a.row),!0},m.prototype._selectFirstCell=function(){var a=this,b=a.fieldOptions;if(!b.selecting||!b.selecting.cell)return!1;var c=d.find(a.$element.get(0),a.id+"_rows");if(!c.childNodes.length)return!1;for(var e=null,f=a.frozenColumns.concat(a.columns),g=0,h=f.length;h>g;g++){var i=f[g];if(i.options.selectable){b.allowFrozenColumns&&i.options.frozen&&(c=d.find(a.$element.get(0),a.id+"_frozen_rows"));var j=c.firstChild,k=a._tr2rowId(j,i);e={col:i.$bind,row:k};break}}return e?a._selectCell(e,null,!1):!1},m.prototype._cell=function(a,b){var c=this,e=c._mapCols[a.col],f=e.index,g=c._findTR(a.row,e.column),h=g.childNodes[f],i={td:h,tr:g,rIndex:-1,cIndex:-1};return b&&(i.rIndex=d.indexOf(g.parentNode,g),i.cIndex=f),i},m.prototype._moveUpSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._colByField(b.selectedCell.col),d=b._cell(b.selectedCell,!0),e=Math.max(d.rIndex-a,0);if(e!=d.rIndex){var f=b._findtBody(c),g=f.childNodes[e];return b._selectCell({row:b._id2rowId(g.id),col:b.selectedCell.col},null,!1)}return!1},m.prototype.resize=function(){var a=this;a._resize()},m.prototype._updateFrozenColumnsHeight=function(){var a=this,b=a.renderOptions;if(a.scrollableFrozenContent){if(!b.height||"auto"===b.height)return;var c=a.scrollableMaster.scrollWidth>a.scrollableMaster.clientWidth,e=void 0;e=c?parseInt(b.height+"",10)-d.scrollbar()+"px":parseInt(b.height+"",10)+"px",a.scrollableFrozenContent.style.height!==e&&(a.scrollableFrozenContent.style.height=e,a._vscroll())}},m.prototype._resize=function(){var a=this,b=a.renderOptions,c=b.scrolling&&b.scrolling.vertical;if(c){var e=f.hasFrozenColumns(b,a.frozenColumns);if(e){var g=d.scrollbar();g&&a._updateFrozenColumnsHeight()}}},m.prototype.syncHeaderAndFrozenScroll=function(a){var b=this;b._scroller&&"master"!==b._scroller||(b._scroller="master",b._hscroll(),b._vscroll(),b._removeScroller())},m.prototype.syncMasterScroll=function(a){var b=this;b._scroller&&"frozen"!==b._scroller||(b._scroller="frozen",b._vsmcroll(),b._removeScroller())},m.prototype._removeScroller=function(){var a=this;return a.fieldOptions.editing?(a._rsTimer&&window.clearTimeout(a._rsTimer),void(a._rsTimer=window.setTimeout(function(){a._scroller=null,a._rsTimer=null},50))):void(a._scroller=null)},m.prototype._vscroll=function(){var a=this;if(a.scrollableFrozenContent){var b=a.scrollableMaster.scrollTop,c=a.scrollableFrozenContent.scrollTop;b!==c&&(a.scrollableFrozenContent.scrollTop=b)}},m.prototype._vsmcroll=function(){var a=this,b=a.scrollableMaster.scrollTop,c=a.scrollableFrozenContent.scrollTop;b!==c&&(a.scrollableMaster.scrollTop=c)},m.prototype._hscroll=function(){var a=this,b=a.scrollableMaster.scrollLeft,c=a.scrollableHeaderOfMaster.scrollLeft;b!==c&&(a.scrollableHeaderOfMaster.scrollLeft=b)},m.prototype._moveDownSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._cell(b.selectedCell,!0),d=b._colByField(b.selectedCell.col),e=b._findtBody(d),f=Math.min(c.rIndex+a,e.childNodes.length-1);if(f!=c.rIndex){var g=e.childNodes[f];return b._selectCell({row:b._id2rowId(g.id),col:b.selectedCell.col},null,!1)}return!1},m.prototype._moveLeftSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},m.prototype._moveRightSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},m.prototype._state2UI=function(){var a=this,b=a._rootElement(),c=a.$element?a.$element.get(0):null;if(b){if(a._setDisabled(b,c),a.setHidden(c),a._setErrors(b,c),a._selectFirstCell(),a._toolBar){var e=$(d.find(c,a.id+"_header"));a._toolBar.render(e)}if(a._pager){var f=$(d.find(c,a.id+"_pagination"));a._pager.render(f)}}},m.prototype.stateChanged=function(a,b){var c=this,d=c.form.getState(c.$bind),e=c._rootElement(),f=c.$element?c.$element.get(0):null;a&&"isHidden"!==a||d.isHidden!==c.state.isHidden&&(c.state.isHidden=d.isHidden,e&&c.setHidden(f)),a&&"isDisabled"!==a||d.isDisabled!=c.state.isDisabled&&(c.state.isDisabled=d.isDisabled,e&&c._setDisabled(e,f)),a&&"errors"!==a||g.errorChanged(c.state.errors,d.errors)&&(c.state.errors=d.errors,c._setErrors(e,f))},m.prototype.stopProppagation=function(a){for(var b=this,c=a.target,d=b.$element.get(0);c;){if(c==d)return;c.href&&(a.preventDefault(),a.stopPropagation()),c=c.parentNode}},m.prototype._renderRows=function(){var a=this;if(a.$element){var b=void 0,c=void 0;a._inplaceEditRemove(!1,!1),a._destroyDetails(),f.hasFrozenColumns(a.renderOptions,a.frozenColumns)&&(b=d.find(a.$element.get(0),a.id+"_frozen_rows"),b&&(c=f.createRows(a.id,a.state.value,a.frozenColumns,a.renderOptions,a.options.design,a.form.$locale,!0),d.empty(b),d.append(b,c))),b=d.find(a.$element.get(0),a.id+"_rows"),c=f.createRows(a.id,a.state.value,a.columns,a.renderOptions,a.options.design,a.form.$locale,!1),d.empty(b),d.append(b,c)}},m.prototype.editDetail=function(a){
//not compatible with rozenColumns
var b=this,e=a.$id;if(b.$element){var g=b.renderOptions,h=f.hasFrozenColumns(g,b.frozenColumns);if(h)return;var j=d.find(b.$element.get(0),b.id+"_rows"),k=d.find(j,e+"_detail");if(k)return;var l=d.find(j,e);if(l){k=f.createDetail(e,l);
// prepare layout
var m=b.renderOptions.rows;if(!m||!m.detail||!m.detail.layout)throw new Error('Grid options missing: "options.rows.detail.layout".');var n=m.detail.layout;"string"==typeof n&&b.renderOptions.layouts&&b.renderOptions.layouts[n]&&(n=b.renderOptions.layouts[n]),"object"==typeof n&&(n=$.extend(!0,{},n),n.name&&(n._name=n.name),n.name=e);
// prepare schema
var o=a.getSchema();"object"==typeof o&&(o.links=o.links||{},o.links.$updateChanges=o.links.$updateChanges||{title:i.ui.ApplyDetailChanges});var p={};m.detail.spacing&&(p.verticalSpacing=!0),p.closeButtonHandler=function(){b.closeDetail(e)},n._name&&(p.externalLayout=n._name,p.externalSchema=b.form.options.externalSchema,p.externalLocale=b.form.options.externalLocale),p.path=b.$bind,b._details.push(e),c.OpenForm($(k.firstChild),n,b.form.$schema,a.model(),b.form.$locale,function(c,d,f){switch(c.property){case"$links.$updateChanges":if(!b.state.value.updateItem(a,d))return;a.update(d.model()),b.closeDetail(e)}},p),d.after(l,k)}}},m.prototype.closeDetail=function(a){
//not compatible with rozenColumns
var b=this;if(b._destroyDetailById(a),b.$element){var c=d.find(b.$element.get(0),a+"_detail");c&&d.remove(c)}},m.prototype._removeRow=function(a){var b=this;if(b._destroyDetailById(a),b.$element){var c=[],e=d.find(b.$element.get(0),a);e&&c.push({element:e,columns:b.columns}),f.hasFrozenColumns(b.renderOptions,b.frozenColumns)&&(e=d.find(b.$element.get(0),a+"_frozen")),e&&c.push({element:e,columns:b.frozenColumns}),c.forEach(function(c){var g=e.parentNode,h=d.find(g,a+"_detail");if(h&&d.remove(h),g.firstChild===e&&b.renderOptions.headerIsHidden&&!b.renderOptions._useColGrp&&g.childNodes.length>1){
//no header &&  not useColGrp ==> update cols width on first row
var i=g.childNodes[1];c.columns.forEach(function(a,b){var c=i.childNodes[b];a.options.width&&(c.style.width=f.ensureWidth(a.options.width)),a.options.minWidth&&(c.style.minWidth=f.ensureWidth(a.options.minWidth))})}d.remove(c.element)})}},m.prototype._updOddEven=function(){var a=this;if(!a.renderOptions._useStripedCss&&a.$element){var b=d.find(a.$element.get(0),a.id+"_rows");f.updateEvenOdd(b),b=d.find(a.$element.get(0),a.id+"_frozen_rows"),b&&f.updateEvenOdd(b)}},m.prototype._createRow=function(a){var b=this;if(b.$element){var c=b.state.value.findById(a),e=b.state.value.indexOf(c),g=void 0,h=void 0,i=f.hasFrozenColumns(b.renderOptions,b.frozenColumns);i&&(g=d.find(b.$element.get(0),b.id+"_frozen_rows"),h=f.createRow(b.id,e,c,b.frozenColumns,b.renderOptions,b.options.design,b.form.$locale,g.childNodes.length%2===1,!0),d.append(g,h)),g=d.find(b.$element.get(0),b.id+"_rows"),h=f.createRow(b.id,e,c,b.columns,b.renderOptions,b.options.design,b.form.$locale,g.childNodes.length%2===1,!1),d.append(g,h)}},m.prototype.filtrableColumns=function(){var a=this,b=a.$schema;return b&&"array"===b.type&&b.items&&"object"===b.items.type?j.filtrableFields(b.items,a.form.$locale):[]},m.prototype._updateSorting=function(){var a=this,b=a.renderOptions;if(b&&b.sorting&&!b.headerIsHidden){var c=d.find(a.$element.get(0),a.id+"_cols");c&&f.updSorting(b,c,a._colByField,a.state.value.$orderby()),c=d.find(a.$element.get(0),a.id+"_frozen_cols"),c&&f.updSorting(b,c,a._colByField,a.state.value.$orderby())}},m.prototype._renderColumns=function(a){var b=this;if(b._inplaceEditRemove(!1,!1),a._useColGrp){
// create free columns
...
if(e&&(d.empty(e),d.append(e,f.createColGroup(b.columns,a,!1))),e=d.find(b.$element.get(0),b.id+"_colgrp"),d.empty(e),d.append(e,f.createColGroup(b.columns,a,!1)),f.hasFrozenColumns(a,b.frozenColumns)){var g=c&&!a.headerIsHidden?d.find(b.$element.get(0),b.id+"_colgrp_frozen_header"):null;g&&(d.empty(g),d.append(g,f.createColGroup(b.frozenColumns,a,!0))),g=d.find(b.$element.get(0),b.id+"_colgrp_frozen"),g&&(d.empty(g),d.append(g,f.createColGroup(b.frozenColumns,a,!0)))}}if(!a.headerIsHidden){var h=d.find(b.$element.get(0),b.id+"_cols");d.empty(h),d.append(h,f.createCols(b.id,b.columns,a,b.options.design,b.form.$locale,b.state.value.$orderby(),!1)),f.hasFrozenColumns(a,b.frozenColumns)&&(h=d.find(b.$element.get(0),b.id+"_frozen_cols"),h&&(d.empty(h),d.append(h,f.createCols(b.id,b.frozenColumns,a,b.options.design,b.form.$locale,b.state.value.$orderby(),!0))))}a.allowFrozenColumns&&f.updateFrozenWidth(b.$element.get(0),b.id,b.frozenColumns)},m.prototype.toggleMultiselect=function(){var a=this;if(a.$element){var b=a.renderOptions;b.selecting&&b.selecting.row&&(
//ToDo scroll
a.removeEvents(),b.selecting.multiselect=!b.selecting.multiselect,a._initCols(b),a._renderColumns(b),a._renderRows(),a.setEvents(a.renderOptions),a.resize())}},m.prototype.render=function(a){var b=this,d=b._initOptions(c.Utils.defaultOptions);return b.$element||(b.$schema.description&&(d.description=e.tt(b.$schema.description,b.form.$locale)),b.$element=$(f.gridContainer(b.id,d,b.options.design,b.$schema.title,b.form.$locale,b.columns,b.frozenColumns)),b._renderColumns(d),b._renderRows(),b._state2UI(),b.setEvents(d)),b.appendElement(a,d),b.$element},m}(b.AbsField);b.BasicGrid=m,c.registerControl(m,"array",!1,"",null),c.registerControl(m,"array",!1,"basicgrid",null)}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/index.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="./absfield.control.ts" />
...
var g=$('<div tabindex="0" class="bs-checkboxlist-list col-lg-6 col-xs-12 checkbox-inline"><div class="bs-checkboxlist-list-check"><a><span class="'+f.iconClass("square-o")+'"></span></a></div><div class="bs-checkboxlist-list-title"></div></div>').get(0);a.forEach(function(a,d){var h=g.cloneNode(!0);c.disabled?(f.attr(h,"tabindex","-1"),f.removeClass(h,"bs-pointer"),f.addClass(h,"bs-cursor-disabled")):(f.attr(h,"tabindex","0"),f.addClass(h,"bs-pointer"),f.removeClass(h,"bs-cursor-disabled"));var i=h.firstChild.firstChild.firstChild;i.className=b&&b.indexOf(a.code)>=0?f.iconClass("check-square-o"):f.iconClass("square-o");var j=h.lastChild;f.append(j,document.createTextNode(a.libelle)),f.append(e,h)})}else{var h=$('<center><div class="bs-lv-nodata">Aucun résultat trouvé ...</div></center>').get(0);f.append(e,h)}f.append(d.$element.get(0),e)},a.prototype._inputs=function(){return this.$element.get(0)},a.prototype._setItemValue=function(a,b){var c=a.firstChild.firstChild.firstChild;c.className=b?f.iconClass("check-square-o"):f.iconClass("square-o")},a.prototype._toggleEnumByIndex=function(a){var b=this;if(a>=0&&a<b.elements.length){var c=b.elements[a],d=b.findVal(c.code),e=b._inputs();d>=0?(b._setItemValue(e.childNodes[a],!1),b.removeVal(c.code),b.options.onSelectItem&&b.options.onSelectItem("remove",{id:a,value:c,data:c})):(b._setItemValue(e.childNodes[a],!0),b.addVal(c.code),b.options.onSelectItem&&b.options.onSelectItem("add",{id:a,value:c,data:c}))}},a}();b.CheckBoxList=z;var A=function(a){function b(b,c,d){a.call(this,b,c,d);var e=this;d.registerListenerFor(e.$bind+".$item",e),this._state()}return __extends(b,a),b.prototype._state=function(){var a=this;a.state=a.state||{};var b=a.form.getState(a.$bind);Object.keys(b).forEach(function(c){a.state[c]=b[c]}),a.state.value=a.form.getValue(a.$bind)},b.prototype.click=function(a){},b.prototype._state2UI=function(){},b.prototype.destroy=function(){var b=this;b.form.unRegisterListenerFor(b.$bind+".$item",b),a.prototype.destroy.call(this)},b.prototype.changed=function(a,b,c,d,e){},b.prototype.stateChanged=function(a,b){},b.prototype._createContainer=function(a,b,c,e){var f=['<div id="{0}" data-render="{0}">','<label for="{0}_input" id="{0}_label" class="'+(c?"":"bs-none")+'">'+(c||"")+"</label>",'<div id="{0}_toolbar"></div>',"<br />",'<div id="{0}_list"></div>','<center id="{0}_paginer"></center>',"</div>"];return d.format(f.join(""),a)},b.prototype._onSelectToolElement=function(a){var b=this;"search"===a.name&&b._lookup.search(a.value)},b.prototype.createToolBar=function(a,b){var d=this;if(d.$element&&!d._toolbar){var e=[{name:"search",type:"search",right:!1}];b=$.extend({selectToolElement:d._onSelectToolElement.bind(d)}),d._toolbar=new c.ToolBar(e,b);var g=f.query(d.$element.get(0),"#"+a+"_toolbar");if(!g)return;d._toolbar.render($(g))}},b.prototype._onSelectPaginer=function(a){var b=this;switch(a){case"next":b._lookup.nextPage();break;case"prev":b._lookup.prevPage();break;case"first":b._lookup.firthPage();break;case"last":b._lookup.lastPage();break;default:b._lookup.toPage(a-1)}},b.prototype.createPaginer=function(a,b){var d=this;if(d.$element){if(!d._pager){b=$.extend({size:"default",boundaryLinks:!0,selectPage:d._onSelectPaginer.bind(d)},b),d._pager=new c.Pager(b);var e=f.query(d.$element.get(0),"#"+a+"_paginer");if(!e)return;d._pager.render($(e))}var g=d._pager;g.props.totalPages=d._lookup.getNbPages(),g.props.currentPage=d._lookup.currentPage()+1}},b.prototype._onSelectCheckBoxList=function(a,b){var c=this;"add"===a?c.state.value.push({code:b.value.code,lib:b.value.libelle}):"remove"===a&&c.state.value.remove(c.state.value.find("code",b.value.code))},b.prototype._getValues=function(){var a=this,b=$.extend(!0,{},a.state.value);return b._items=b._items.map(function(a){return a.code}),b._items},b.prototype.createList=function(a,b){var d=this;if(d.$element&&!d._list){d._list=new c.CheckBoxList({onSelectItem:d._onSelectCheckBoxList.bind(d)}),d._list.values=d._getValues();var e=f.query(d.$element.get(0),"#"+a+"_list");if(!e)return;d._list.render($(e))}},b.prototype.createLookup=function(a){var b=this;if(b.$schema.ds){var d=function(a,c){c=c||{},c.inited&&c.updated?b._lookup.firthPage():a&&(b.$schema.ds.data.$params.$search&&b.createToolBar(b.id,{}),b.createList(b.id,{}),b._list.elements=a,b.createPaginer(b.id,b.renderOptions.pager))};b._lookup=new c.DsLookup(b.$schema.ds,{notify:d})}},b.prototype.render=function(a){var b=this,d=b._initOptions(c.Utils.defaultOptions);return b.$element||(b.setEvents(null),b.$element=$(b._createContainer(b.id,e.tt(b.$schema.title,b.form.$locale),b.options.design,d)),b.createLookup({}),b._state2UI()),b.appendElement(a,d),b.$element},b}(b.AbsField);c.registerControl(A,"array",!1,"lookup-list",null);var B=function(a){function b(b,c,e){a.call(this,b,c,e),this.renderInternal=function(a,b){var c=this;if(c.$element){var d;switch(b.renderModel){case"model2":d=new x(c.listeChamps,c.listeFilters,c.listeOperateurs,c.listeTypes,b,function(a,b){"VALIDE"==a&&c.form.execAction("validate",{})});break;default:d=new w(c.listeChamps,c.listeFilters,c.listeOperateurs,c.listeTypes,b)}f.append(c.$element.get(0),d.render())}},this.createContainer=function(a){return d.format('<div id="{0}" data-render="{0}" class="bs-filter"></div>',a)},this._state(),this.options=c||{},this.initData()}return __extends(b,a),b.prototype.initData=function(){var a=this;
// reporter sur un fichier json les labels
a.listeOperateurs=new h,a.listeOperateurs.add("in","égal à",!1,{symbol:"="}),a.listeOperateurs.add("nin","différent de",!1,{symbol:"!="}),a.listeOperateurs.add("gt","supérieur à",!1,{symbol:">"}),a.listeOperateurs.add("ge","supérieur ou égal à",!1,{symbol:">="}),a.listeOperateurs.add("lt","inférieur à",!1,{symbol:"<"}),a.listeOperateurs.add("le","inférieur ou égal à",!1,{symbol:"<="}),a.listeOperateurs.add("between","entre",!0,{symbol:"entre"}),a.listeOperateurs.add("nbetween","pas entre",!0,{symbol:"pas entre"}),a.listeOperateurs.add("like","contient",!1,{symbol:"contient"}),a.listeOperateurs.add("nlike","ne contient pas",!1,{symbol:"ne contient pas"}),a.listeOperateurs.add("vide","vide",!1,{symbol:"est vide"}),a.listeOperateurs.add("nvide","pas vide",!1,{symbol:"n'est pas vide"}),a.listeTypes=new l,a.listeTypes.addType("decimal","Décimal",["in","nin","gt","ge","lt","le","between","nbetween","vide","nvide"]),a.listeTypes.addType("money","Money",["in","nin","gt","ge","lt","le","between","nbetween","vide","nvide"]),a.listeTypes.addType("integer","Entier",["in","nin","gt","ge","lt","le","between","nbetween","vide","nvide"]),a.listeTypes.addType("date","Date",["in","nin","gt","ge","lt","le","between","nbetween","vide","nvide"]),a.listeTypes.addType("string","Chaîne de caractères",["in","nin","like","nlike","vide","nvide"]),a.listeTypes.addType("enum","Enum",["in","nin","vide","nvide"]),a.listeTypes.addType("lookup","Lookup",["in","nin","vide","nvide"]),a.listeTypes.addType("boolean","Booléen",["in","nin","vide","nvide"]),a.listeChamps=new i;var b=a.state.value&&a.state.value.champs?a.state.value.champs:[];b.forEach(function(b){var c={};b.lookup?(c.lookupSchema=g.getLookup(a.$bind,b.lookup,a.$schema),c.lookup=b.lookup,c.format="lookup"):b["enum"]&&b["enum"].length?(c["enum"]=b["enum"],c.enumName=b.enumName,c.format="enum"):"boolean"===b.type?(c["enum"]=[{code:"true",libelle:"Vrai"},{code:"false",libelle:"Faux"}],c.format="enum"):c.decimals=b.decimals,a.listeChamps.add(b.code,b.libelle,b.type,c)});var c=a.state.value&&a.state.value.filters?a.state.value.filters:[];a.listeFilters=new k(c),c.forEach(function(b){var c=[];b.values.forEach(function(a){c.push(a)});var d=[];b.values2&&b.values2.forEach(function(a){d.push(a)}),a.listeFilters.add2(b.code,b.op,d.length?d:c)})},b.prototype._state=function(){var a=this;a.state=a.state||{};var b=a.form.getState(a.$bind);Object.keys(b).forEach(function(c){a.state[c]=b[c]}),a.state.value=a.form.getValue(a.$bind)},b.prototype.click=function(a){},b.prototype._setDisabled=function(a,b){},b.prototype._setReadOnly=function(a,b){},b.prototype._setMandatory=function(a,b){},b.prototype._state2UI=function(){},b.prototype.changed=function(a,b,c,d){},b.prototype.stateChanged=function(a,b){},b.prototype.render=function(a){var b=this,d=b._initOptions(c.Utils.defaultOptions);return b.$element||(b.$element=$(b.createContainer(b.id)),f.empty(b.$element.get(0)),d.id=b.id,d.title=b.$schema.title||"",d=$.extend(!0,d,b.renderOptions),b.renderInternal({data:b.state.value},d),b.setEvents(null),b._state2UI()),b.appendElement(a,d),b.$element},b.prototype.destroy=function(){a.prototype.destroy.call(this)},b}(b.AbsField);b.ComposantFilter=B,c.registerControl(B,"object",!1,"filter")}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../typings/index.d.ts" />
/// <reference path="../../js/core/core.ts" />
/// <reference path="../../js/ui/form/modalform.control.ts" />
var Phoenix;!function(a){var b;!function(a){var b=a,c=function(a,b,c,d,e){e=e||{};var f={code:b,libelle:c,type:d,decimals:e.decimals,"enum":e["enum"],enumName:e.enumName,lookup:e.lookup};a.push(f)},d=function(a,b,d,e,f,g,h){var i={};i.decimals=f,i["enum"]=g,i.enumName=h,c(a,b,d,e,i)},e=function(a,b){var c=function(a,b){for(var d=[],e=a.length%2!=0,f=e?a.length-1:a.length,g=0;f>g;g+=2)d.push({$left:a[g],$op:b,$right:a[g+1]});return e&&d.push(a[a.length-1]),d.length>=2&&(d=c(d,b)),d},d=function(b){function d(a,b,c,d){return{$left:{$left:a,$op:"ge",$right:{type:b,value:c}},$op:"and",$right:{$left:a,$op:"le",$right:{type:b,value:d}}}}function e(a,b,c){return{$left:"contains("+a+", '"+c+"')",$op:"eq",$right:!0}}var f=a.find(function(a){return a.code==b.code}),g="in"==b.op?"eq":b.op;g="nin"==g?"ne":g;var h=b.values.map(function(a){return a.code?a.code:a});return"between"==g||"nbetween"==g?"between"==g?d(b.code,f.type,h[0],h[1]):{$op:"not",$right:d(b.code,f.type,h[0],h[1])}:(h=h.map(function(a){var c=null;switch(g){case"like":c=e(b.code,f.type,a);break;case"nlike":c={$op:"not",$right:e(b.code,f.type,a)};break;case"vide":c={$left:b.code,$op:"eq",$right:{type:"string",value:""}};break;case"nvide":c={$left:b.code,$op:"ne",$right:{type:"string",value:""}};break;default:c={$left:b.code,$op:g,$right:{type:f.type,value:a}}}return c}),c(h,"or")[0])},e=[];return b.forEach(function(a){e.push(d(a))}),c(e,"and")[0]};a.filterData={filter:{champs:[],filters:[]}},b.glbGridFilter=function(c,d,e){function f(a,b){function c(a){var b;switch(a){case"in":b="=";break;case"nin":b="!=";break;case"like":b="contient";break;case"nlike":b="ne contient pas";break;case"vide":b="est";break;case"nvide":b="n'est pas";break;case"gt":b=">";break;case"ge":b=">=";break;case"lt":b="<";break;case"le":b="<=";break;case"between":b="entre";break;case"nbetween":b="pas entre";break;default:b=a}return b}var d=[];return a.forEach(function(a){b.forEach(function(b){return a.code===b.code?(a.lib=b.libelle,!1):void 0});var e=(a.lib||a.code)+" "+c(a.op);e+="vide"===a.op||"nvide"===a.op?" vide":"between"===a.op||"nbetween"===a.op?" "+a.values[0]+" et "+a.values[1]:a.getValueNames?" "+a.getValueNames().join(","):" "+a.values.join(","),d.length&&d.push(" et "),d.push(e)}),d.join("")}if(c.length){var g={name:"filtre",$type:"block",$items:[{$type:"block",$items:[{$bind:"filter",$widget:"filter",options:{renderModel:"model1"}}]}],form:!0},h={type:"object",properties:{filter:{type:"object",title:"Filtre",properties:{champs:{type:"array",items:{type:"object",properties:{code:{type:"string"},libelle:{type:"string"},type:{type:"string"},decimals:{type:"number"},enumName:{type:"string"},"enum":{type:"array",items:{type:"object",properties:{code:{type:"string"},libelle:{type:"string"}}}},lookup:{type:"string"}}}},filters:{type:"array",items:{type:"object",properties:{code:{type:"string"},op:{type:"string"},values:{type:"array",items:{type:"string"}},values2:{type:"array",items:{type:"object",properties:{code:{type:"string"},lib:{type:"string"}}}}}}}}}}};a.filterData.filter.champs.length&&a.filterData.filter.champs.splice(0),c.forEach(function(c){var d=$.extend(!0,{},c.schema);switch(d.type){case"number":d.decimals>0?d.type="decimal":d.type="integer"}c.schema["enum"]&&(d["enum"]=c.schema["enum"].map(function(a,b){return{code:a,libelle:c.schema.enumNames[b]||a}})),b.filter.addField2(a.filterData.filter.champs,c.name,d.title,d.type,{decimals:d.decimals,"enum":d["enum"]})});var i={title:"Filtre",buttons:[{pattern:"validate"}]};b.OpenModalForm(i,g,h,a.filterData,e,function(c,e,g,h){switch(e.property){case"validate":if(!g.validate())return;a.filterData=g.model();var i=null;a.filterData.filter.filters.length&&(i=b.filter.format.toPhenix(a.filterData.filter.champs,a.filterData.filter.filters)),d.filter={value:i,title:f(a.filterData.filter.filters,a.filterData.filter.champs)},c.close()}})}},a.filter={format:{toPhenix:e},addField:d,addField2:c}}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../typings/index.d.ts" />
/// <reference path="../../js/core/locale.ts" />
/// <reference path="../../js/ui/form/form.control.ts" />
/// <reference path="../../js/ui/form/controls/absfield.control.ts" />
var Phoenix;!function(a){var b;!function(b){var c=b,d=(a.utils,a.ulocale,a.dom),e=(a.Observable.SchemaUtils,a.bootstrap4,function(){function a(a,b,c){var d=this,e={expandIcon:"plus",collapseIcon:"minus",checkedIcon:"check",uncheckedIcon:"unchecked",itemIcon:"",groupIcon:"",multiSelect:!1,showTags:!1,groupLink:!1,itemLink:!0};d._options=$.extend(!0,e,b),d._data=a||{},d._callback=c||null,d._nodes=$.extend(!0,[],a.items),d._selectedItems=[],d._init()}return Object.defineProperty(a.prototype,"selectedItems",{get:function(){return this._selectedItems},set:function(a){this._selectedItems=a},enumerable:!0,configurable:!0}),a.prototype._init=function(){var a=this;a._contructeArbreNodes(a._nodes,a._options)},a.prototype._getGroupNode=function(a,b){var c=this,d=null;return a.every(function(a){return a.items&&(d=a.name===b?a:null,d||(d=c._getGroupNode(a.items,b))),!d}),d},a.prototype._getItemNode=function(a,b){var c=this,d=null;return a.every(function(a){return d=a.items||a.name!==b?null:a,!d&&a.items&&(d=c._getItemNode(a.items,b)),!d}),d},a.prototype._getItem=function(a){var b=this,c=null;return b._data.items.every(function(b){return b.name===a?(c=b,!1):!0}),c},a.prototype._contructeArbreNodes=function(a,b){function c(a,b,f,g,h){var i=$(e._template().item).get(0);a.forEach(function(a){a.level=f||0,a.show=1==g,a.parent=b||null,a.component=i.cloneNode(),a.items&&(a.tagsSize=0,c(a.items,a,a.level+1,!1,h));for(var j=a.parent;j;)j.tagsSize++,j=j.parent;for(var k=1;k<=a.level;k++)d.append(a.component,$(e._template().indent).get(0));if(a.items){var l=e._createIcon(a.component,h.expandIcon,"icon-group bs-cursor-p");if(d.attr(l,"data-event","click"),d.attr(l,"data-action","expand"),h.multiSelect&&h.groupLink){var m=e._createIcon(a.component,h.uncheckedIcon,"bs-cursor-p");d.attr(m,"data-event","click"),d.attr(m,"data-action","uncheck")}else h.groupLink&&(d.attr(a.component,"data-event","click"),d.attr(a.component,"data-action","selectitem"));e._createIcon(a.component,h.groupIcon)}else{var l=e._createIcon(a.component);if(d.addClass(l,"icon-exist"),h.multiSelect&&h.itemLink){var m=e._createIcon(a.component,h.uncheckedIcon,"bs-cursor-p");d.attr(m,"data-event","click"),d.attr(m,"data-action","uncheck")}else h.itemLink&&(d.attr(a.component,"data-event","click"),d.attr(a.component,"data-action","selectitem"));e._createIcon(a.component,h.itemIcon)}d.append(a.component,document.createTextNode(a.title)),d.attr(a.component,"data-id",a.name)})}var e=this;Array.isArray(a)&&a.length&&(c(a,null,0,!0,b),b.showTags&&e._addTags(e._nodes))},a.prototype._addTags=function(a){var b=this;a.forEach(function(a){if(a.items){var c=$(b._template().badge).get(0);d.append(c,document.createTextNode(""+a.tagsSize)),d.append(a.component,c),b._addTags(a.items)}})},a.prototype._template=function(){return{list:'<ul class="list-group bs-treeview"></ul>',item:'<li class="list-group-item"></li>',indent:'<span class="indent"></span>',icon:'<span class="icon"></span>',link:'<a href="#" style="color:inherit;"></a>',badge:'<span class="badge"></span>'}},a.prototype._createIcon=function(a,b,c){var e=this,f=$(e._template().icon).get(0);return b&&e._addIcon(f,b,c),d.append(a,f),f},a.prototype._addIcon=function(a,b,c){d.attr(a,"class","icon icon-exist "+d.iconClass(b)+(c?" "+c:""))},a.prototype._setEvents=function(){var a=this;a._container&&a._container.addEventListener("click",function(b){var c=b.target,e=null;if(e="click"===d.attr(c,"data-event")?c:d.parentByTag(a._container,c,"LI"),e&&"click"===d.attr(e,"data-event")){var f=d.attr(e,"data-action");"expand"===f?a._display(e,!0):"collapse"===f?a._display(e,!1):"selectitem"===f?a._select(e):"check"===f&&a._options.multiSelect?a._check(e,!1):"uncheck"===f&&a._options.multiSelect&&a._check(e,!0)}})},a.prototype._display=function(a,b){var c=this,e=d.parentByTag(c._container,a,"LI");if(e){var f=d.attr(e,"data-id"),g=c._getGroupNode(c._nodes,f);if(g){var h=function(a,b){a.forEach(function(a){if(a.show=b,a.items){h(a.items,!1);var e=d.query(a.component,".icon-group");e&&(c._addIcon(e,c._options.expandIcon,"icon-group bs-cursor-p"),d.attr(e,"data-action","expand"))}})};h(g.items,b),c._addIcon(a,b?c._options.collapseIcon:c._options.expandIcon,"icon-group bs-cursor-p"),d.attr(a,"data-action",b?"collapse":"expand"),c.renderItems(c._nodes)}}},a.prototype._select=function(a){var b=this,c=d.parentByTag(b._container,a,"LI");if(c){var e=d.query(b._container,".active");e&&d.removeClass(e,"active"),d.addClass(a,"active");var f=d.attr(c,"data-id"),g=b._getItem(f);b._selectedItems.splice(0),g&&(b._selectedItems.push(g),b._callback&&b._callback({action:"select",data:g}))}},a.prototype._check=function(a,b){var c=this,e=d.parentByTag(c._container,a,"LI");if(e){var f=d.attr(e,"data-id"),g=c._getItem(f);if(g){c._addIcon(a,b?c._options.checkedIcon:c._options.uncheckedIcon,"bs-cursor-p"),d.attr(a,"data-action",b?"check":"uncheck");var h=void 0;if(b)c._selectedItems.push(g),h="add";else{var i=-1;c._selectedItems.every(function(a,b){return a.name===f?(i=b,!1):!0}),i>=0&&(c._selectedItems.splice(i,1),h="remove")}c._callback&&c._callback({action:h,data:g})}}},a.prototype.renderItems=function(a){function b(a,c){a.forEach(function(a){a.show&&d.append(c,a.component),a.items&&b(a.items,c)})}var c=this;d.empty(c._container);var e=document.createDocumentFragment();b(a,e),d.append(c._container,e)},a.prototype.render=function(a){var b=this;return b._container||(b._container=$(b._template().list).get(0),b.renderItems(b._nodes),b._setEvents()),a&&d.append(a,b._container),b._container},a}()),f=function(a){function b(b,c,d){a.call(this,b,c,d);var f=this;f._state();var g=f.state.value.model();Array.isArray(g.items)&&g.items.length&&(f.multiSelectList=new e(g,g.options,function(a){console.log(a),console.log(f.multiSelectList.selectedItems)}))}return __extends(b,a),b.prototype._state=function(){var a=this;a.state=a.state||{};var b=a.form.getState(a.$bind);Object.keys(b).forEach(function(c){a.state[c]=b[c]}),a.state.value=a.form.getValue(a.$bind)},b.prototype.click=function(a){},b.prototype._state2UI=function(){},b.prototype.changed=function(a,b,c,d,e){},b.prototype.stateChanged=function(a){},b.prototype.render=function(a){var b=this;b._initOptions(c.Utils.defaultOptions);return b.$element||(b.$element=$(b.multiSelectList.render())),a&&d.append(a.get(0),b.$element.get(0)),b.$element},b}(b.AbsField);b.MultiSelectListForm=f,c.registerControl(f,"object",!1,"multiselectlist")}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../typings/index.d.ts" />
/// <reference path="../../js/core/locale.ts" />
/// <reference path="../../js/ui/form/form.control.ts" />
/// <reference path="../../js/ui/form/controls/absfield.control.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a,b,c,d){d=d||"",b=$.extend({titleIsHidden:!1,placeHolder:!1,columns:!1},b);var e=[];return g.Utils.fieldWrapper(e,b,c,function(){e.push('<ul id="{0}" class="pillbox boxed-tags"></ul>')}),h.format(e.join(""),a)}function d(a,b){var c=j.query(b.$element.get(0),"#"+b.id+".pillbox"),d=j.query(c,"li.item-edit"),e=j.query(d,"input"),f=j.query(c,"li.item-edit > div");if(f.innerHTML="",!e.value)return void j.removeClass(f,"list-open");var g=document.createDocumentFragment(),h=document.createElement("div");b.context.data.forEach(function(a){var c=new RegExp("^"+e.value.toLocaleLowerCase());if(c.test(a[b.context.entree.code].toLocaleLowerCase())){var d=h.cloneNode(!0);d.textContent=a[b.context.entree.code],d.addEventListener("mouseover",function(a){j.addClass(a.currentTarget,"list-item-hover")},!1),d.addEventListener("mouseout",function(a){j.removeClass(a.currentTarget,"list-item-hover")},!1),g.appendChild(d)}}),f.appendChild(g),j.addClass(f,"list-open")}function e(a,b){if(8==a.keyCode){var c=j.query(b.$element.get(0),"#"+b.id+".pillbox"),d=j.query(c,"li.item-edit"),e=j.query(c,"li.item-edit > input");if(!e.value){var f=j.query(c,"li.label-primary");if(f){var g=j.query(f,"span").textContent;b.state.value.remove(b.state.value.find("code",g))}else{var h=d.previousSibling;h&&(j.removeClass(h,"label-default"),j.addClass(h,"label-primary"))}}}}function f(a,b){for(var c=j.query(a.$element.get(0),"#"+a.id+".pillbox"),d=j.queryAll(c,"li.item span"),e=null,f=0;f<d.length;f++){var g=d.item(f);if(b.code===g.textContent){e=g;break}}if(e){var h=j.parentByTag(c,e,"li");c.removeChild(h)}}var g=b,h=a.utils,i=a.ulocale,j=a.dom,k=a.Observable.SchemaUtils,l=(a.bootstrap4,function(a){function b(b,c,d){a.call(this,b,c,d),this.context={data:[],entree:{code:"code",parent:"parent"},sortie:{code:"code",parent:"parent"}},d.registerListenerFor(this.$bind+".$item",this),this._state()}return __extends(b,a),b.prototype._state=function(){var a=this;a.state=a.state||{},a.state.value=a.form.getValue(a.$bind);var b=a.form.getState(a.$bind);Object.keys(b).forEach(function(c){a.state[c]=b[c]})},b.prototype.destroy=function(){var b=this;b.form.registerListenerFor(b.$bind+".$item",b),a.prototype.destroy.call(this)},b.prototype.click=function(a){var b=this;if(b.$element){var c=j.query(b.$element.get(0),"#"+b.id+".pillbox"),d=j.parentByTag(c,a.target,"li"),e=d?j.hasClass(d,"item-edit"):!1;if(d&&e){var f=j.query(c,".item-edit .list-open");if(!f)return;var g=j.query(d,"input"),h=a.target.textContent;if(null==b.state.value.find("code",h)){var i=null;b.context.data.forEach(function(a){h===a[b.context.sortie.code]&&(i=a[b.context.sortie.parent])});var k={};k[b.context.sortie.code]=h,k[b.context.sortie.parent]=i,b.state.value.push(k)}g.value="",j.removeClass(f,"list-open")}else if(d&&"I"==a.target.nodeName.toUpperCase()){var l=j.query(d,"span").textContent;b.state.value.remove(b.state.value.find("code",l))}}},b.prototype._setDisabled=function(a,b){},b.prototype._setReadOnly=function(a,b){},b.prototype._setHidden=function(a,b){this.state.isHidden?j.addClass(b,"bs-none"):j.removeClass(b,"bs-none")},b.prototype._setMandatory=function(a,b){},b.prototype._state2UI=function(){var a=this,b=j.query(a.$element.get(0),"#"+a.id+".pillbox");a.state.value.forEach(function(c){j.append(b,a._addOldItem(c))})},b.prototype.changed=function(a,b,c,d,e){var g=this;if("add"===d){var h=j.query(g.$element.get(0),"#"+g.id+".pillbox");h.insertBefore(g._addOldItem(c),h.lastChild)}else"remove"===d&&f(g,e.$value)},b.prototype.stateChanged=function(a){},b.prototype._addNewItem=function(){var a=this,b=document.createElement("li");j.addClass(b,"item"),j.addClass(b,"item-edit"),b.innerHTML='<input autocomplete="off" autofocus="true" placeholder="indice ..."/><div></div>';var c=j.query(b,"input");j.addClass(b,"div");
//newListe.addEventListener("blur", function (event) { console.log("ok"); _dom.removeClass(liste, "list-open"); }, false);
return c.addEventListener("keypress",function(b){e(b,a)},!1),c.addEventListener("keyup",function(b){d(b,a)},!1),b},b.prototype._addOldItem=function(a){var b=document.createElement("li");j.addClass(b,"boxed-tags-item"),j.addClass(b,"item"),
// _dom.addClass(oldListe, "btn");
// _dom.addClass(oldListe, "btn-info");
b.innerHTML='<i class="glyphicon glyphicon-remove"></i><span></span>';var c=j.query(b,"span");return c.textContent=a.code,b},b.prototype._internalRender=function(a){var b=this,d=b._initOptions(g.Utils.defaultOptions);if(!b.$element){b.$element=$(c(b.id,d,b.options.design,i.tt(b.$schema.title,b.form.$locale)));var e=j.query(b.$element.get(0),"#"+b.id+".pillbox");b._state2UI(),j.append(e,b._addNewItem())}return b.appendElement(a,d),b.$element},b.prototype.render=function(a){var b=this;return b.$lookup?(b.context.entree=b.$lookup.mapping||b.context.entree,void k.executeLookup(b.$lookup,null,function(c){return b.context.data=c.value,b._internalRender(a)})):b._internalRender(a)},b}(b.AbsField));b.PillBox=l,g.registerControl(l,"array",!1,"pillbox",{lookup:!0})}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../typings/index.d.ts" />
/// <reference path="../../js/core/core.ts" />
var Phoenix;!function(a){var b;!function(b){var c=a.dom,d=(a.utils,a.locale,function(){function b(a,b){var c=this;c.config=a||{},c.options=c.options||{},c.data={value:a.value},c.props={},c._defineProps()}return b.prototype._defineProps=function(){var b=this,c=a.utils.defineProperty;c("value",b)},b.prototype._notifyChange=function(a){var b=this;switch(a){case"value":b.update()}},b.prototype.createElement=function(a,b,d){var e=["bs-button btn"];b.type&&e.push("btn-"+b.type),b.right&&e.push("pull-right");var f=['<div class="input-group '+(b.right?"pull-right":"")+'">','<button toolClick="'+a+'" type="button" class="'+e.join(" ")+'">',b.icon?'<span class="'+c.iconClass(b.icon)+'"></span>':"",b.title?"&nbsp;"+b.title:"","</button>","</div>"];return f.join("")},b.prototype._setEvents=function(){},b.prototype.update=function(){},b.prototype.getValue=function(){},b.prototype.render=function(a){var b=this;return b.$element||(b.$element=$(b.createElement(b.config.id,b.config,b.data.value)),b._setEvents()),a&&c.append(a.get(0),b.$element.get(0)),b.$element},b.prototype.destroy=function(){var a=this;a.$element=null,a.options=null,a.config=null},b}());b.ToolElement=d;var e=function(a){function b(b,c){a.call(this,b,c)}return __extends(b,a),b.prototype.createElement=function(a,b,c){var d=["label label-default form-control-static bs-toolbarandgrid-count"];b.right&&d.push("pull-right");var e=['<span tool="'+a+'" class="'+d.join(" ")+'">'+c+"</span>"];return e.join("")},b.prototype.update=function(){var a=this;a.$element&&c.text(a.$element.get(0),a.data.value)},b}(d);b.ToolElementCount=e;var f=function(a){function b(b,c){a.call(this,b,c),this.data.value="",this.oldValue=""}return __extends(b,a),b.prototype.createElement=function(a,b,d){var e=[];b.right&&e.push("pull-right");var f=['<div tabindex="'+a+'" class="input-group '+e.join(" ")+'">','<input toolKeyup="'+a+'" type="text" class="form-control" placeholder="'+(b.title||"Recherche")+'" />','<span class="input-group-btn">','<button toolClick="'+a+'" class="btn btn-default" type="button">','<span toolClick="'+a+'" class="'+c.iconClass(b.icon||"search")+'"> </span>',"</button>","</span>","</div>"];return f.join("")},b.prototype.update=function(){var a=this;if(a.$element){var b=c.query(a.$element.get(0),"input");b&&(b.value=a.data.value)}},b.prototype.getValue=function(){var a=this;return a.oldValue=a._getInputValue(),a.oldValue},b.prototype._getInputValue=function(){var a=this;if(a.$element){var b=c.query(a.$element.get(0),"input");return b?b.value:null}},b.prototype._setEvents=function(){var a=this;if(a.$element){var b=a.$element.get(0);if(b){var d=c.query(b,"input"),e=c.query(b,"button");d.addEventListener("focus",function(a){d.select()}),b.addEventListener("blur",function(b){var c=b.explicitOriginalTarget&&b.explicitOriginalTarget!=e&&null==b.relatedTarget;c=c||(null==b.relatedTarget||b.relatedTarget&&b.relatedTarget!=e)&&void 0==b.explicitOriginalTarget,b.target==d&&c&&(a.data.value=" ",a.props.value=a.oldValue)},!0)}}},b}(d);b.ToolElementSearch=f;var g=function(a){function b(b,c){a.call(this,b,c)}return __extends(b,a),b.prototype.createElement=function(a,b,d){var e=["bs-button btn btn-primary"],f=['<div class="input-group '+(b.right?"pull-right":"")+'">','<button toolClick="'+a+'" type="button" class="'+e.join(" ")+'">',b.icon?'<span class="'+c.iconClass(b.icon)+'"></span>':"",b.title?"&nbsp;"+b.title:"","</button>",'<span class="bs-toolbar-filter form-control-static bs-cursor-h"></span>',"</div>"];return f.join("")},b.prototype.addTooltip=function(a){var b=this,d=$('<span data-toggle="tooltip" data-phoenix-tooltip="true" data-placement="auto" title= "'+a+'"> '+a+" </span>"),e=c.query(b.$element.get(0),".bs-toolbar-filter");c.empty(e),c.append(e,d.get(0)),d.tooltip({html:!0,container:"body",template:'<div class="tooltip bs-tooltip-help" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner" style="text-align:left"></div></div>'})},b.prototype.update=function(){var a=this;a.$element&&a.addTooltip(a.data.value)},b.prototype.render=function(b){a.prototype.render.call(this,b);var c=this;c.addTooltip(c.data.value)},b}(d);b.ToolElementFilter=g;var h=function(){function a(a,b){var c=this;c.options=b||{},c.toolElements=a||{}}return a.prototype.getToolElement=function(a){var b=null;return this.toolElements.forEach(function(c,d){return d==a||c.name===a?(b=c.$component,!1):void 0}),b},a.prototype.setValue=function(a,b){var c=this,d=c.getToolElement(a);d&&(d.props.value=b)},a.prototype.getValue=function(a,b){var c=this,d=c.getToolElement(a);return d?d.getValue():void 0},a.prototype._setEvents=function(){function a(a,c){if(c>=0){var d=b.getToolElement(c);if(d&&b.options.selectToolElement){var e=d.getValue();b.options.selectToolElement({id:d.config.id,name:d.config.name,value:e,toolData:d.config},a)}}}var b=this;b.$element&&b.$element.on("click",function(b){var d=c.attr(b.target,"toolClick");null!==d&&a("click",d)}).on("keyup",function(b){if(13==b.keyCode){var d=c.attr(b.target,"toolKeyup");a("keyup",d)}})},a.prototype._removeEvents=function(){var a=this;a.$element&&a.$element.off("click")},a.prototype._renderToolElements=function(a){var b=this;if(a.length){b.$element.get(0);a.forEach(function(a,c){switch(a.id=c,a.type){case"count":a.$component=new e(a);break;case"filter":a.$component=new g(a);break;case"search":a.$component=new f(a);break;default:a.$component=new d(a)}a.$component&&a.$component.render(b.$element)})}},a.prototype.render=function(a){var b=this;return b.$element||(b.$element=$('<div class="form-inline bs-toolbar"></div>'),b._renderToolElements(b.toolElements),b._setEvents()),a&&(b.options.replaceParent?a.replaceWith(b.$element):a.append(b.$element)),b.$element},a.prototype.destroy=function(){var a=this;a._removeEvents(),a.$element=null,a.options=null},a}();b.ToolBar=h}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));

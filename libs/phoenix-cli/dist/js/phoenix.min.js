...
//not compatible with rozenColumns
var b=this;if(b._destroyDetailById(a),b.$element){var c=e.find(b.$element.get(0),a+"_detail");c&&e.remove(c)}},r.prototype._removeRow=function(a){var b=this;if(b._destroyDetailById(a),b._viewMap){var c=b._viewMap[a];if(c){delete b._viewMap[a];var d=b._view.indexOf(c);d>=0&&b._view.splice(d,1)}}if(b.$element){var f=[],h=e.find(b.$element.get(0),a);h&&f.push({element:h,columns:b.columns}),g.hasFrozenColumns(b.renderOptions,b.frozenColumns)&&(h=e.find(b.$element.get(0),a+"_frozen"),h&&f.push({element:h,columns:b.frozenColumns})),f.forEach(function(c){var d=c.element.parentNode,f=e.find(d,a+"_detail");if(f&&e.remove(f),d.firstChild===c.element&&b.renderOptions.headerIsHidden&&!b.renderOptions._useColGrp&&d.childNodes.length>1){
//no header &&  not useColGrp ==> update cols width on first row
var h=d.childNodes[1];c.columns.forEach(function(a,b){var c=h.childNodes[b];a.options.width&&(c.style.width=g.ensureWidth(a.options.width)),a.options.minWidth&&(c.style.minWidth=g.ensureWidth(a.options.minWidth))})}e.remove(c.element)})}},r.prototype._updOddEven=function(){var a=this;if(!a.renderOptions._useStripedCss&&a.$element){var b=e.find(a.$element.get(0),a.id+"_rows");g.updateEvenOdd(b),b=e.find(a.$element.get(0),a.id+"_frozen_rows"),b&&g.updateEvenOdd(b)}},r.prototype._createRow=function(a){var b=this;if(b.$element){var c=0,d=b._viewMap[a.$id];d?d=b._viewMap[a.$id]:(d={level:0,value:a},b._view.push(d),b._view.push(a.$id),c=b._view.length-1);var f=void 0,h=void 0,i=g.hasFrozenColumns(b.renderOptions,b.frozenColumns);i&&(f=e.find(b.$element.get(0),b.id+"_frozen_rows"),h=g.createRow(b.id,c,d.level,d.value,b.frozenColumns,b.renderOptions,b.options.design,b.form.$locale,f.childNodes.length%2===1,!0),e.append(f,h)),f=e.find(b.$element.get(0),b.id+"_rows"),h=g.createRow(b.id,c,d.level,d.value,b.columns,b.renderOptions,b.options.design,b.form.$locale,f.childNodes.length%2===1,!1),e.append(f,h)}},r.prototype.filtrableColumns=function(){var a=this,b=a.$schema,c=a.$schemaItems;return b&&"array"===b.type&&c&&"object"===c.type?m.filtrableFields(c,a.form.$rootSchema,a.form.$locale):[]},r.prototype._getColumnsFromSchema=function(){var a=this,b=a.$schema,c=a.$schemaItems;return b&&"array"===b.type&&c&&"object"===c.type?m.columns(c,a.form.$rootSchema,a.form.$locale):[]},r.prototype._getSelectedColumns=function(){var a=this,b={};return Object.keys(a._mapCols).forEach(function(a){b[a]=!0}),b},r.prototype._getGroupsFromSchema=function(){var a=this,b=a.$schema,c=a.$schemaItems;return b&&"array"===b.type&&c&&"object"===c.type&&c.groups?c.groups:{}},r.prototype.getColumnsForSettings=function(){var a=this;return{schemaGroups:a._getGroupsFromSchema(),schemaColumns:a._getColumnsFromSchema(),selectedColumns:a._getSelectedColumns(),locale:a.form.$locale}},r.prototype.getColumnsForFilter=function(){var a=this;return{schemaGroups:a._getGroupsFromSchema(),schemaColumns:a.filtrableColumns(),locale:a.form.$locale}},r.prototype.getColumnsForFilterExpress=function(a){var b,c=this;if(a&&Array.isArray(a)){var d=c._getColumnsFromSchema();b=[],a.forEach(function(a){d.every(function(c){return a!==c.name||(b.push(c),!1)})})}else b=c._getColumnsFromSchema();var e=[];return b.forEach(function(a){var b=a.schema,c={code:a.name,lib:b.title||b.name,type:b.type};b["enum"]&&(c["enum"]=b["enum"]),b.enumNames&&(c.enumNames=b.enumNames),e.push(c)}),e},r.prototype._updateSorting=function(){var a=this,b=a.renderOptions;if(b&&b.sorting&&!b.headerIsHidden){var c=e.find(a.$element.get(0),a.id+"_cols");c&&g.updSorting(b,c,a._colByField,a.state.value.$orderby()),c=e.find(a.$element.get(0),a.id+"_frozen_cols"),c&&g.updSorting(b,c,a._colByField,a.state.value.$orderby())}},r.prototype._renderColumns=function(a){var b=this;if(b._inplaceEditRemove(!1,!1),a._useColGrp){
// create free columns

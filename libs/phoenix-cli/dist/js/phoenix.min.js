...
//    css.push('nowrap');
//}
return b&&d.push("table-header"),!b&&a._useStripedCss&&d.push("table-striped"),a._useColGrp&&d.push("bs-fixed"),b||!a.editing&&!a.nowrap?!b&&a.allowFrozenColumns&&d.push("nowrap"):d.push("nowrap"),b&&a.allowFrozenColumns&&d.push("headernowrap"),d.push("bs-theme"),a.border&&d.push("table-bordered"),a.small&&d.push("bs-style-small-table"),d},z=function(a,b,c){var d=[];return c?d:(a.width&&"auto"!==a.width&&d.push("min-width: "+l(a.width)),d)},A=function(a,b,c,d){var e=b.scrolling&&b.scrolling.vertical,f=y(b,c,d);a.push("<table"),f.length&&a.push(' class="'+f.join(" ")+'"'),a.push(' id="{0}_table'),d&&a.push("_frozen"),c&&a.push("_header"),a.push('"');var g=z(b,c,d);g.length&&a.push(' style="'+g.join(";")+'"'),a.push(">"),

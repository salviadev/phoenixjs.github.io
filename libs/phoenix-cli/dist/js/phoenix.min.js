...
//    html.push("</caption>");
//}
b._useColGrp&&a.push('<colgroup id="{0}_colgrp'+(d?"_frozen":"")+(c?"_header":"")+'"></colgroup>'),b.headerIsHidden||(c?a.push('<thead><tr class="bs-va-middle" id="{0}'+(d?"_frozen":"")+'_cols"></tr></thead>'):e||a.push('<thead><tr class="bs-va-middle" id="{0}'+(d?"_frozen":"")+'_cols"></tr></thead>')),c||(a.push('<tbody id="{0}'),d&&a.push("_frozen"),a.push('_rows"></tbody>')),a.push("</table>")},B=function(a){var b=0;return a.forEach(function(a){b+=parseInt(a.options.width+"",10)}),b},C=function(a,b,c){var d=B(c),f=e.find(a,b+"_frozen_header_parent");f&&(f.style.width=d+"px"),f=e.find(a,b+"_frozen_header_sep"),f&&(d?e.removeClass(f,"empty"):e.addClass(f,"empty"))},D=function(a){var b=a.cloneNode(!0);if("th"===b.tagName.toLowerCase()){var c=a.parentElement,d=c.parentElement.parentElement,f=["<div>"];f.push('<table class="'),f.push(d.className),f.push('">'),f.push("<thead>"),f.push('<tr class="'),f.push(c.className),f.push('">'),f.push("</tr></thead><table>"),f.push("</div>");var g=$(f.join("")).get(0),h=g.firstChild.firstChild.firstChild;h.style.height=a.offsetHeight+"px",e.append(h,b),b=g}var i=e.position(a,null);return b.style.top=i.top+"px",b.style.left=i.left+"px",b.style.width=a.offsetWidth+"px",b.style.height=a.offsetHeight+"px",b.style.zIndex="5000",b.style.position="absolute",b},E=function(a,b,f,g,i,j,k){g=g||"",b._useColGrp=w(b,j),b._headernowrap=b.xxx,b._useStripedCss=!(b.rows&&b.rows.detail),b=$.extend({right:!1,icon:null,type:"default",width:"auto",height:"auto",size:null,scrolling:{horizontal:!1}},b),void 0!==b.title&&(g=b.title);var l=[],m=["bs-field-group bs-island"];l.push('<div id="{0}" '),l.push(' class="'),f&&m.push("design"),l.push(m.join(" ")),l.push('"'),h(a,b,f,l),l.push(">"),
//create header div
...
var Phoenix;!function(a){var b;!function(b){var c=b,d=a.utils,e=a.dom,c=b,f=a.ulocale,g=c.GridUtil,h=a.Observable.errorsUtils,i=a.link,j=a.locale,k=a.drag,l=a.events,m=a.Observable.SchemaUtils,n=function(a,b){return b===e.keys.VK_TAB&&a.shiftKey?!1:a.altKey||a.ctrlKey||a.metaKey||a.shiftKey},o=function(a){a=(a||"")+"",a=a.trim();var b=parseInt(a,10);return b+""===a||b+"px"===a||b+" px"===a};b.glbGridFilter=null,b.glbGridSettings=null;var p=function(a){function p(b,c,d){a.call(this,b,c,d),this._refreshGrid=function(){var a=this,b=a.renderOptions;a.removeEvents(),a._initCols(b),a._renderColumns(b),a._renderRows(),a.setEvents(a.renderOptions),a.resize()};var e=this;d.registerListenerFor(e.$bind+".$item",e),e._state(),e.checkOptions(e.fieldOptions),e._initCols(e.fieldOptions),e._details=[]}return __extends(p,a),p.prototype.checkOptions=function(a){void 0===a.allowColumnMove&&(a.allowColumnMove=!0),a.align=a.align||"middle"},p.prototype._inplaceEditValue2Model=function(a,b,c){var d=m.text2Value(a,c.schema),e=b.getValue(c.$bind);return d!==e?(b.setValue(c.$bind,d),!0):!1},p.prototype._inplaceEditAcceptKeys=function(a){var b=this;if(b.inplace.schema["enum"]){if(a===e.keys.VK_UP||a===e.keys.VK_DOWN)return!1}else if(m.isDate(b.inplace.schema)&&c.Utils.useDatePicker()&&(a===e.keys.VK_UP||a===e.keys.VK_DOWN||a===e.keys.VK_LEFT||a===e.keys.VK_RIGHT))return!1;return!0},p.prototype._inplaceEditAddEvents=function(){var a=this;a.inplace.schema["enum"]&&$(a.inplace.input).on("change",function(b){var c=a.inplace.td,d=a._td2value(c),e=a._inplaceEditGetValue(d);a._inplaceEditValue2Model(e,d.item,d.col)||a._modifyCell(d.item,d.col.$bind,c)})},p.prototype._inplaceEditRemoveEvents=function(){var a=this;a.inplace.schema["enum"]?$(a.inplace.input).off("change"):m.isDate(a.inplace.schema)&&c.Utils.useDatePicker()&&b.Utils.datePickerDestroy($(a.inplace.parent))},p.prototype._inplaceEditGetValue=function(a){var b=this;if(b.inplace.schema["enum"]){if(!a.item)return null;var d=b.inplace.input.selectedIndex,e=a.item.getState(a.col.$bind);return e.filter?b.inplace.schema.filters[e.filter][d]:b.inplace.schema["enum"][d]}return c.Utils.text2value(b.inplace.input.value,b.inplace.schema)},p.prototype._inpaceEditShow=function(a,b){var d=this,f=d._td2value(a),h=f.item.getValue(f.col.$bind),i=f.item.getState(f.col.$bind),j=m.value2Text(h,f.col.schema);a.tabIndex=-1;var k={nativeNumber:!1,nativeDate:!1,type:"text",after:null};m.isDate(f.col.schema)?(k.nativeDate=c.Utils.nativeDate(),k.nativeDate?k.type="date":c.Utils.useDatePicker()&&(k.after={icon:"calendar"})):m.isNumber(f.col.schema)&&(k.nativeNumber=c.Utils.nativeNumber(),k.nativeNumber&&(k.type="number")),d.inplace=g.createInplaceEdit(j,h,i,a,f,f.col,k),d._inplaceEditAddEvents(),d.inplace.isInputElement?(d.inplace.input.tabIndex=0,d.inplace.input.focus(),d.inplace.canSelect&&e.select(d.inplace.input)):(
// focus on td ?
a.tabIndex=0,a.focus())},p.prototype._inplaceEditRemove=function(a,b){var c=this;if(c.inplace&&!b){var d=c.inplace.td;a&&(d.tabIndex=0);var f=c._td2value(d);c._inplaceEditRemoveEvents(),c.inplace.parent&&e.remove(c.inplace.parent),e.removeClass(d,"focused");var g=!!c.inplace.input;if(g){var h=c._inplaceEditGetValue(f);if(c.inplace=null,!f.item)return;c._inplaceEditValue2Model(h+"",f.item,f.col)||c._modifyCell(f.item,f.col.$bind,d)}}c.inplace=null},p.prototype._inplaceEditModel2Control=function(a,b,d){var e=this,f=e._td2value(d),h=(e._inplaceEditGetValue(f),a.getValue(f.col.$bind)),i=a.getState(f.col.$bind),j=m.value2Text(h,f.col.schema),k={nativeNumber:c.Utils.nativeNumber(),nativeDate:c.Utils.nativeDate()};g.updateInplaceEdit(e.inplace,j,h,i,d,f,f.col,k)},p.prototype.removeEvents=function(){var a=this;a.scrollableMaster&&$(a.scrollableMaster).off("scroll"),a.scrollableFrozenContent&&a.fieldOptions.editing&&$(a.scrollableFrozenContent).off("scroll"),a.scrollableMaster=null,a.scrollableHeaderOfMaster=null,a._drag&&(k.dragManager.rmvDrag(a._drag),a._drag=null)},p.prototype.setEvents=function(a){var b=this,c=a.scrolling&&a.scrolling.vertical;if(c){var d=b.$element.get(0);b.scrollableMaster=e.find(d,b.id+"_master_scroll"),b.scrollableHeaderOfMaster=e.find(d,b.id+"_table_header_content");var f=g.hasFrozenColumns(a,b.frozenColumns);b.scrollableFrozenContent=f?e.find(d,b.id+"_frozen_scroll"):null,b.scrollableMaster&&b.scrollableHeaderOfMaster&&$(b.scrollableMaster).on("scroll",b.syncHeaderAndFrozenScroll.bind(b)),b.scrollableFrozenContent&&b.fieldOptions.editing&&$(b.scrollableFrozenContent).on("scroll",b.syncMasterScroll.bind(b))}if((a.allowColumnResize||a.allowColumnMove)&&!a.headerIsHidden){var h=k.dragManager.addDrag([b.$element.get(0)]);b._drag=h,h.canStartDragHandler=b._canStartDrag.bind(b),h.onDragStart=b._onDragStart.bind(b),h.onDrag=b._onDrag.bind(b),h.onDragEnd=b._onDragEnd.bind(b)}},p.prototype._getColsInfo=function(a,b){var c=[];return a.forEach(function(a,e){var f=b.childNodes[e];f.id||(f.id=d.allocID()),c.push({htmlId:f.id,info:a})}),c},p.prototype._canStartDrag=function(a){var b=this,c=a.target,f=e.attr(c,"data-drag"),g=c;return f||(f=e.attr(c.parentNode,"data-drag"),g=c.parentNode),f?(g.id||(g.id=d.allocID()),b._drag.data.op=f,b._drag.data.cloneId=g.id,b._drag.data.column=e.attr(g,"colId"),b._drag.data.column?b["_cdd"+f](a):!1):!1},p.prototype._onDragStart=function(a){var b=this;return b._drag.data.op?b["_sdd"+b._drag.data.op](a):!1},p.prototype._onDrag=function(a){var b=this;return b._drag.data.op?b["_ddd"+b._drag.data.op](a):!1},p.prototype._onDragEnd=function(a,b){var c=this;return c._drag.data.op?c["_edd"+c._drag.data.op](a,b):!1},p.prototype._cddmove=function(a){var b=this,c=b.renderOptions;if(!c.allowColumnMove)return!1;var d=b.$element.get(0),f=b._drag,g=e.find(d,f.data.cloneId);f.coverDocument=!0,f.cursor="move",f.moveX=!0,f.moveY=!0,f.startOffset=e.position(g,null);var h,i,j={firstDelta:0,lastDelta:-6,delta:-4,top:f.startOffset.top,height:g.offsetHeight};if(c.allowFrozenColumns&&(h=e.find(d,b.id+"_frozen_cols"),h&&(i=e.childrenPositions(h,b._getColsInfo(b.frozenColumns,h),!1,"frozen",j))),h=e.find(d,b.id+"_cols")){var k=e.childrenPositions(h,b._getColsInfo(b.columns,h),!1,"free",j);i=i?i.concat(k):k}return f.data.childrenPositions=i,!0},p.prototype._sddmove=function(a){var b=this,c=b._drag,d=e.find(b.$element.get(0),c.data.cloneId);return c.floatElement=g.cloneForMove(d),e.append(document.body,c.floatElement),!0},p.prototype._eddmove=function(a,b){var c=this,d=c._drag;if(d&&(d.floatElement&&(e.remove(d.floatElement),d.floatElement=null),d.data.mdiv&&(e.remove(d.data.mdiv),d.data.mdiv=null),!a&&d.data.best&&d.data.column)){var f=d.data.best.info,g=c._mapCols[d.data.column];if("empty"===d.data.best.position)
...
// remove src
c.renderOptions.columns.splice(k,1),l>k&&l--,
// insert at ni
c.renderOptions.columns.splice(l,0,i)}c._refreshGrid()}},p.prototype._dddmove=function(a){var b=this,c=b._drag,d=l.point(a),f=e.findNearest(d.x,d.y,c.data.childrenPositions);if(c.data.best!=f){var g={left:f.left,top:f.top,width:f.width,height:f.height};c.data.mdiv=e.showMove(c.data.mdiv,f.vertical,g,"frozen"===f.zone?"bs-drag-color-success":"bs-drag-color-info")}return c.data.best=f,!0},p.prototype.destroy=function(){var b=this;b._destroyDetails(),b.columns&&(b.columns.forEach(function(a){a.schema=null}),b.columns=null),b.frozenColumns&&(b.frozenColumns.forEach(function(a){a.schema=null}),b.frozenColumns=null),b.form.unRegisterListenerFor(b.$bind+".$item",b),b._inplaceEditRemove(!1,!0),b._pager&&(b._pager.destroy(),b._pager=null),b._toolBar&&(b._toolBar.destroy(),b._toolBar=null),b._details=null,b._mapCols=null,a.prototype.destroy.call(this)},p.prototype._moveToPage=function(a){var b=this;b.state.value.currentPage(a)},p.prototype._onselectPage=function(a){var b=this;switch(a){case"next":b._moveToPage(Math.min(b._pager.props.totalPages,b._pager.props.currentPage+1));break;case"prev":b._moveToPage(Math.max(0,b._pager.props.currentPage-1));break;case"first":b._moveToPage(1);break;case"last":b._moveToPage(b._pager.props.totalPages);break;default:b._moveToPage(a)}},p.prototype._onSelectToolElement=function(a){var c=this,d=a.name||a.id;return"filter"===a.name&&b.glbGridFilter?b.glbGridFilter(c.filtrableColumns(),c.state.value,c.form.$locale):"settings"===a.name&&b.glbGridSettings?b.glbGridSettings(c.getColumnsForSettings(),function(a){c.setColumns(a)}):void("multiselect"===a.name?c.toggleMultiselect():c.form.execAction(c.$bind+".$toolbar."+d,{toolElement:a,control:c}))},p.prototype.setColumns=function(a){var b=this;b.renderOptions.columns=a.map(function(a){var c=b._colByField(a.$bind);return c&&(a.options=c.options),a}),b._refreshGrid()},p.prototype._state=function(){a.prototype._state.call(this);var b=this,d=b.fieldOptions;if(b.state.value.isQueryable()){
// create pager
var e=$.extend({size:"default",selectPage:b._onselectPage.bind(b)},d.pager||{});b._pager=new c.Pager(e);var f=b._pager;f.props.totalPages=b.state.value.totalPages(),f.props.currentPage=b.state.value.currentPage()}var g=[];if(d.toolbar&&d.toolbar.items){var h=$.extend(!0,{},d.toolbar);h.items.forEach(function(a){if("count"===a.type)a=$.extend({name:"count",right:!0,value:b.state.value.totalCount()},a);else if("filter"===a.type)a=$.extend({name:"filter",value:b.state.value.filter||"",icon:"filter"},a);else if("multiselect"===a.type){var c=!!(d.selecting&&d.selecting.row&&d.selecting.multiselect);a=$.extend(a,{name:"multiselect",type:"default",icon:"check",value:c})}g.push(a)})}if(g.length){var e=$.extend({selectToolElement:b._onSelectToolElement.bind(b)});b._toolBar=new c.ToolBar(g,e)}},p.prototype._destroyDetails=function(){
//Destroy all inline "forms" 
var a=this;if(a._details){var b=c.formManager();a._details.forEach(function(a){var c=b.formByName(a);c&&c.destroy()}),a._details=[]}},p.prototype._destroyDetailById=function(a){var b=this,d=b._details.indexOf(a);d>=0&&b._details.splice(d,1);var e=c.formManager().formByName(a);e&&e.destroy()},p.prototype._initCols=function(a){var b=this;b._mapCols={},a.columns&&a.columns.length||(a.columns=[{$bind:"$index"}]),b.columns=[],b.frozenColumns=[];var c=a.columns.findIndex(function(a){return m.isSelectField(a.$bind)}),d=a.selecting&&a.selecting.row&&a.selecting.multiselect;d?0>c&&a.columns.splice(0,0,{$bind:"$selected",options:{width:50,frozen:!0,editable:!0}}):c>=0&&a.columns.splice(c,1);var e=a.scrolling&&a.scrolling.vertical||a.editing;a.columns.forEach(function(c,d){var h=$.extend({},c);return h.options=h.options||{},h.schema||(h.schema=m.getSchema(c.$bind,b.$schema.items)),h.schema?(h.title=f.tt(h.options.title||h.schema.title,b.form.$locale),m.isLink(c.$bind)&&(h.isLink=!0),e&&!h.options.width&&(h.options.width=g.widthFromSchema(h.schema)),h.options.frozen&&a.allowFrozenColumns?(h.options.width?o(h.options.width)||(h.options.width=50):h.options.width=g.widthFromSchema(h.schema),b.frozenColumns.push(h),void(b._mapCols[c.$bind]={column:h,index:b.frozenColumns.length-1,tindex:d})):(b.columns.push(h),void(b._mapCols[c.$bind]={column:h,index:b.columns.length-1,tindex:d}))):void console.log("Field (bind) not found : "+c.$bind)})},p.prototype._colByField=function(a){var b=this._mapCols[a];return b?b.column:null},p.prototype.changed=function(a,b,c,d,e){var f=this;if(f.$element){var h=!1,i=!1;switch(d){case"count":if(a===e.propName){var j=f._toolBar;j&&j.setValue&&j.setValue("count",f.state.value.totalCount())}break;case"filter":if(a===e.propName){var j=f._toolBar;j&&j.setValue&&j.setValue("filter",f.state.value.filter.title)}break;case"pagination":if(a===e.propName){var k=f._pager;k&&(k.props.totalPages=f.state.value.totalPages(),k.props.currentPage=f.state.value.currentPage())}break;case"sorting":a===e.propName&&f._updateSorting();break;case"set":case"propchange":a===e.propName&&(f._renderRows(),i=!0);break;case"add":f._createRow(e.$id),i=!0,h=!0;break;case"remove":f._removeRow(e.$id),h=!0;break;case"upd":if(a===e.propName){var l=e&&e.$id?f.state.value.findById(e.$id):null;l&&(f._modifyCell(l,e.property),m.isSelectField(e.property)&&g.setRowsSelected(l.$id,l.$selected,f.fieldOptions,f.$element.get(0)))}}h&&f._updOddEven(),i&&f.resize()}},p.prototype._modifyTD=function(a,b,d){var f=this,g=f._colByField(b),h=a.getState(b),i=g.options||{},j=i.editable&&!h.isDisabled&&!h.isReadOnly,k=c.Utils.displayValue(a.getValue(b),g.schema,f.form.$locale,{html:!0,useSymbol:!1,editable:j,selectable:i.selectable,check:i.check,avanced:i,tableOptions:f.config.options});if(e.empty(d),k.html){var l=$(k.value);e.append(d,l.get(0))}else e.append(d,document.createTextNode(k.value))},p.prototype._findTR=function(a,b){var c=this,d=c.renderOptions,f=a+(b.options.frozen&&d.allowFrozenColumns?"_frozen":"");return e.find(c.$element.get(0),f)},p.prototype._id2rowId=function(a){var b=a.indexOf("_frozen");return b>0&&(a=a.substring(0,b)),a},p.prototype._findtBody=function(a){var b=this,c=b.renderOptions,d=b.id+(a.options.frozen&&c.allowFrozenColumns?"_frozen_rows":"_rows");return e.find(b.$element.get(0),d)},p.prototype._modifyCell=function(a,b,c){var d=this;if(d.$element){if(c)return d.inplace&&d.inplace.input&&d.inplace.td===c?void d._inplaceEditModel2Control(a,b,c):d._modifyTD(a,b,c);var f=d._colByField(b);if(f){var g=d._findTR(a.$id,f);if(g)
//TODO: optimize
for(var h=0,i=g.childNodes.length;i>h;h++){var j=g.childNodes[h],k=e.attr(j,"colid");if(k===b){if(d.inplace&&d.inplace.input&&d.inplace.td===j)return void d._inplaceEditModel2Control(a,b,j);d._modifyTD(a,b,j)}}}}},p.prototype._rootElement=function(){return this.$element.get(0)},p.prototype._gridParentFocus=function(){var a=this;return e.find(a.$element.get(0),a.id+"_focus")},p.prototype._setErrors=function(a,b){var c=this,d=c.state.errors;c.showErrors(b,d)},p.prototype._setTableFocus=function(a){var b=this,c=e.find(b.$element.get(0),b.id+"_table");c&&(a?e.addClass(c,"focused"):e.removeClass(c,"focused")),c=e.find(b.$element.get(0),b.id+"_table_frozen"),c&&(a?e.addClass(c,"focused"):e.removeClass(c,"focused"))},p.prototype.focusIn=function(a){var b=this;if(b.$element)if(b._setTableFocus(!0),b.selectedCell){var c=b._cell(b.selectedCell,!0),d=b.canEdit(b.selectedCell);d&&!b.inplace&&b._inpaceEditShow(c.td,!0)}else b._inplaceEditRemove(!1,!1)},p.prototype.focusOut=function(a){var b=this;b.$element&&(b._setTableFocus(!1),b._inplaceEditRemove(!0,!1))},p.prototype._doTab=function(a){var b=this;return a?b._moveDownSelectedCell(1):b._moveUpSelectedCell(1)},p.prototype.keypress=function(a){var b=this;if(b.selectedCell&&b.inplace&&e.isChildOf(b.inplace.td,a.target)){var d=b._td2value(b.inplace.td);if(m.isNumber(b.inplace.schema)){if(c.Utils.keyPressNumber(a)===!1)return!1}else if(m.isBoolean(b.inplace.schema)){if(" "===String.fromCharCode(a.which)&&b.fieldOptions.editing){var f=d.item.getRelativeState(d.col.$bind);if(!f.isDisabled&&!f.isReadOnly){var g=d.item.getValue(d.col.$bind);d.item.setValue(d.col.$bind,!g)}}a.preventDefault()}}},p.prototype.keydown=function(a){var b=this,c=a.which||a.keyCode,d=!1;if(!n(a,c)&&(!b.inplace||!e.isChildOf(b.inplace.td,a.target)||b._inplaceEditAcceptKeys(c))){if(b.fieldOptions.selecting&&b.fieldOptions.selecting.cell)switch(c){case e.keys.VK_TAB:d=b._doTab(!a.shiftKey);break;case e.keys.VK_UP:d=b._moveUpSelectedCell(1);break;case e.keys.VK_DOWN:d=b._moveDownSelectedCell(1)}d&&a.preventDefault()&&a.stopPropagation()}},p.prototype._tr2rowId=function(a,b){var c=a.id;if(b&&b.options.frozen){var d=c.indexOf("_frozen");d>0&&(c=c.substring(0,d))}return c},p.prototype._td2cell=function(a){var b=this,c=a.parentNode,d=(c.parentNode,b._colByField(e.attr(a,"colid")));if(!d)return null;var f=b._tr2rowId(c,d),g=b.state.value.findById(f);return g&&d?{row:f,col:e.attr(a,"colid")}:null},p.prototype._td2value=function(a){var b=this,c=a.parentNode,d=(c.parentNode,b._colByField(e.attr(a,"colid"))),f=b._tr2rowId(c,d),g=b.state.value.findById(f);return{item:g,col:d}},p.prototype.mousedown=function(a){var b=this,c=e.parentByTag(b.$element.get(0),a.target,"td");if(c){var d=b.renderOptions,f=b._td2cell(c);f&&(b._selectCell(f,a,!0)?a.preventDefault():d.selecting&&d.selecting.row&&!d.selecting.cell&&!d.selecting.multiselect&&b._selectRow(f.row))}return!0},p.prototype.click=function(a){var b=this,c=e.parentByTag(b.$element.get(0),a.target,"td");if(c){var d=b._td2cell(c);if(d){
//that._selectCell(cell, event, false);
var f=b.state.value.findById(d.row),g=b._colByField(d.col);if(f){var h=a&&a.target&&a.target.$link||a.target.parentNode.$link;if(h){var j=f.getRelativeState(g.$bind);if(j.isDisabled||j.isHidden)return;g.schema.$widgetAction?b[g.schema.$widgetAction]&&b[g.schema.$widgetAction](f):b.form.execAction(b.$bind+".$item."+h,f)}else if(g){if(g.options.$link){var k=e.findByAttribute(a.target,c,"data-phoenix-href");if(k){var l=f.getRelativeState(g.$bind);l.isDisabled||i.execLink(g.options.$link,{$item:f},null)}}if((m.isSelectField(g.$bind)||b.fieldOptions.editing&&g.options.editable&&m.isBoolean(g.schema))&&e.attr(a.target,"data-clickable")){var l=f.getRelativeState(g.$bind);if(!l.isDisabled&&!l.isReadOnly){var n=f.getValue(g.$bind);f.setValue(g.$bind,!n)}}}}}}else{var o=e.parentByTag(b.$element.get(0),a.target,"th");if(o){var p=e.attr(o,"colid");if(b.renderOptions.sorting&&p){var q=b._colByField(p);if(q&&m.canSort(q.schema)){var r=q.$bind,s=b.state.value.$orderby();s===q.$bind&&(r=q.$bind+" desc"),b.state.value.$orderby(r)}}}}},p.prototype._setDisabled=function(a,b){var c=this;a.disabled=c.state.isDisabled},p.prototype._showSelected=function(a,b,c,d){var f=this;if(!a)return null;var g=f._cell(a,!1);g.td&&(b?(e.addClass(g.td,"bs-cell-selected"),f._inplaceEditRemove(!1,!1),c&&(f.focused||d)?f._inpaceEditShow(g.td,!1):(g.td.tabIndex=0,g.td.focus())):(e.removeClass(g.td,"bs-cell-selected"),g.td.tabIndex=-1))},p.prototype.canSelect=function(a){var b=this,c=b.selectedCell;if(c&&c.col===a.col&&c.row===a.row)return!1;if(!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var d=b._colByField(a.col);return d&&d.options.selectable},p.prototype.canEdit=function(a){var b=this;if(!b.fieldOptions.editing||!b.fieldOptions.selecting||!b.fieldOptions.selecting.cell)return!1;var c=b._colByField(a.col),d=c&&c.options.editable;if(d){var e=b.state.value.findById(a.row),f=e.getState(c.$bind);return!f.isReadOnly&&!f.isDisabled}return d},p.prototype.clearSelected=function(){var a=this,b=a.selectedCell;a.selectedCell=null,b&&a._showSelected(b,!1,!0,!1),a._gridParentFocus().tabIndex=0},p.prototype._selectRow=function(a){var b=this;b.state.value.selectRow(a,!0,!0)},p.prototype._selectCell=function(a,b,c){var d=this;if(!d.canSelect(a))return!1;var e=d.selectedCell,f=d.canEdit(a);d._showSelected(a,!0,f,c),d.selectedCell=a,e?d._showSelected(e,!1,!0,c):d._gridParentFocus().tabIndex=-1;var g=d.renderOptions;return g.selecting&&g.selecting.row&&!g.selecting.multiselect&&d._selectRow(a.row),!0},p.prototype._selectFirstCell=function(){var a=this,b=a.fieldOptions;if(!b.selecting||!b.selecting.cell)return!1;var c=e.find(a.$element.get(0),a.id+"_rows");if(!c.childNodes.length)return!1;for(var d=null,f=a.frozenColumns.concat(a.columns),g=0,h=f.length;h>g;g++){var i=f[g];if(i.options.selectable){b.allowFrozenColumns&&i.options.frozen&&(c=e.find(a.$element.get(0),a.id+"_frozen_rows"));var j=c.firstChild,k=a._tr2rowId(j,i);d={col:i.$bind,row:k};break}}return d?a._selectCell(d,null,!1):!1},p.prototype._cell=function(a,b){var c=this,d=c._mapCols[a.col],f=d.index,g=c._findTR(a.row,d.column),h=g.childNodes[f],i={td:h,tr:g,rIndex:-1,cIndex:-1};return b&&(i.rIndex=e.indexOf(g.parentNode,g),i.cIndex=f),i},p.prototype._moveUpSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._colByField(b.selectedCell.col),d=b._cell(b.selectedCell,!0),e=Math.max(d.rIndex-a,0);if(e!=d.rIndex){var f=b._findtBody(c),g=f.childNodes[e];return b._selectCell({row:b._id2rowId(g.id),col:b.selectedCell.col},null,!1)}return!1},p.prototype.resize=function(){var a=this;a._resize()},p.prototype._updateFrozenColumnsHeight=function(){var a=this,b=a.renderOptions;if(a.scrollableFrozenContent){if(!b.height||"auto"===b.height)return;var c=a.scrollableMaster.scrollWidth>a.scrollableMaster.clientWidth,d=void 0;d=c?parseInt(b.height+"",10)-e.scrollbar()+"px":parseInt(b.height+"",10)+"px",a.scrollableFrozenContent.style.height!==d&&(a.scrollableFrozenContent.style.height=d,a._vscroll())}},p.prototype._resize=function(){var a=this,b=a.renderOptions,c=b.scrolling&&b.scrolling.vertical;if(c){var d=g.hasFrozenColumns(b,a.frozenColumns);if(d){var f=e.scrollbar();f&&a._updateFrozenColumnsHeight(),a._vscroll()}}},p.prototype.syncHeaderAndFrozenScroll=function(a){var b=this;b._scroller&&"master"!==b._scroller||(b._scroller="master",b._hscroll(),b._vscroll(),b._removeScroller())},p.prototype.syncMasterScroll=function(a){var b=this;b._scroller&&"frozen"!==b._scroller||(b._scroller="frozen",b._vsmcroll(),b._removeScroller())},p.prototype._removeScroller=function(){var a=this;return a.fieldOptions.editing?(a._rsTimer&&window.clearTimeout(a._rsTimer),void(a._rsTimer=window.setTimeout(function(){a._scroller=null,a._rsTimer=null},50))):void(a._scroller=null)},p.prototype._vscroll=function(){var a=this;if(a.scrollableFrozenContent){var b=a.scrollableMaster.scrollTop,c=a.scrollableFrozenContent.scrollTop;b!==c&&(a.scrollableFrozenContent.scrollTop=b)}},p.prototype._vsmcroll=function(){var a=this,b=a.scrollableMaster.scrollTop,c=a.scrollableFrozenContent.scrollTop;b!==c&&(a.scrollableMaster.scrollTop=c)},p.prototype._hscroll=function(){var a=this,b=a.scrollableMaster.scrollLeft,c=a.scrollableHeaderOfMaster.scrollLeft;b!==c&&(a.scrollableHeaderOfMaster.scrollLeft=b)},p.prototype._moveDownSelectedCell=function(a){var b=this;if(!b.selectedCell)return b._selectFirstCell();var c=b._cell(b.selectedCell,!0),d=b._colByField(b.selectedCell.col),e=b._findtBody(d),f=Math.min(c.rIndex+a,e.childNodes.length-1);if(f!=c.rIndex){var g=e.childNodes[f];return b._selectCell({row:b._id2rowId(g.id),col:b.selectedCell.col},null,!1)}return!1},p.prototype._moveLeftSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},p.prototype._moveRightSelectedCell=function(){var a=this;return a.selectedCell?void 0:a._selectFirstCell()},p.prototype._state2UI=function(){var a=this,b=a._rootElement(),c=a.$element?a.$element.get(0):null;if(b){if(a._setDisabled(b,c),a.setHidden(c),a._setErrors(b,c),a._selectFirstCell(),a._toolBar){var d=$(e.find(c,a.id+"_header"));a._toolBar.render(d)}if(a._pager){var f=$(e.find(c,a.id+"_pagination"));a._pager.render(f)}}},p.prototype.stateChanged=function(a,b){var c=this,d=c.form.getState(c.$bind),e=c._rootElement(),f=c.$element?c.$element.get(0):null;a&&"isHidden"!==a||d.isHidden!==c.state.isHidden&&(c.state.isHidden=d.isHidden,e&&c.setHidden(f)),a&&"isDisabled"!==a||d.isDisabled!=c.state.isDisabled&&(c.state.isDisabled=d.isDisabled,e&&c._setDisabled(e,f)),a&&"errors"!==a||h.errorChanged(c.state.errors,d.errors)&&(c.state.errors=d.errors,c._setErrors(e,f))},p.prototype.stopProppagation=function(a){for(var b=this,c=a.target,d=b.$element.get(0);c;){if(c==d)return;c.href&&(a.preventDefault(),a.stopPropagation()),c=c.parentNode}},p.prototype._renderRows=function(){var a=this;if(a.$element){var b=void 0,c=void 0;a._inplaceEditRemove(!1,!1),a._destroyDetails(),g.hasFrozenColumns(a.renderOptions,a.frozenColumns)&&(b=e.find(a.$element.get(0),a.id+"_frozen_rows"),b&&(c=g.createRows(a.id,a.state.value,a.frozenColumns,a.renderOptions,a.options.design,a.form.$locale,!0),e.empty(b),e.append(b,c))),b=e.find(a.$element.get(0),a.id+"_rows"),c=g.createRows(a.id,a.state.value,a.columns,a.renderOptions,a.options.design,a.form.$locale,!1),e.empty(b),e.append(b,c)}},p.prototype.editDetail=function(a){
...
// prepare schema
var o=a.getSchema();"object"==typeof o&&(o.links=o.links||{},o.links.$updateChanges=o.links.$updateChanges||{title:j.ui.ApplyDetailChanges});var p={};m.detail.spacing&&(p.verticalSpacing=!0),p.closeButtonHandler=function(){b.closeDetail(d)},n._name&&(p.externalLayout=n._name,p.externalSchema=b.form.options.externalSchema,p.externalLocale=b.form.options.externalLocale),p.path=b.$bind,b._details.push(d),c.OpenForm($(k.firstChild),n,b.form.$schema,a.model(),b.form.$locale,function(c,e,f){switch(c.property){case"$links.$updateChanges":if(!b.state.value.updateItem(a,e))return;a.update(e.model()),b.closeDetail(d)}},p),e.after(l,k)}}},p.prototype.closeDetail=function(a){
//not compatible with rozenColumns
var b=this;if(b._destroyDetailById(a),b.$element){var c=e.find(b.$element.get(0),a+"_detail");c&&e.remove(c)}},p.prototype._removeRow=function(a){var b=this;if(b._destroyDetailById(a),b.$element){var c=[],d=e.find(b.$element.get(0),a);d&&c.push({element:d,columns:b.columns}),g.hasFrozenColumns(b.renderOptions,b.frozenColumns)&&(d=e.find(b.$element.get(0),a+"_frozen")),d&&c.push({element:d,columns:b.frozenColumns}),c.forEach(function(c){var f=d.parentNode,h=e.find(f,a+"_detail");if(h&&e.remove(h),f.firstChild===d&&b.renderOptions.headerIsHidden&&!b.renderOptions._useColGrp&&f.childNodes.length>1){
//no header &&  not useColGrp ==> update cols width on first row
var i=f.childNodes[1];c.columns.forEach(function(a,b){var c=i.childNodes[b];a.options.width&&(c.style.width=g.ensureWidth(a.options.width)),a.options.minWidth&&(c.style.minWidth=g.ensureWidth(a.options.minWidth))})}e.remove(c.element)})}},p.prototype._updOddEven=function(){var a=this;if(!a.renderOptions._useStripedCss&&a.$element){var b=e.find(a.$element.get(0),a.id+"_rows");g.updateEvenOdd(b),b=e.find(a.$element.get(0),a.id+"_frozen_rows"),b&&g.updateEvenOdd(b)}},p.prototype._createRow=function(a){var b=this;if(b.$element){var c=b.state.value.findById(a),d=b.state.value.indexOf(c),f=void 0,h=void 0,i=g.hasFrozenColumns(b.renderOptions,b.frozenColumns);i&&(f=e.find(b.$element.get(0),b.id+"_frozen_rows"),h=g.createRow(b.id,d,c,b.frozenColumns,b.renderOptions,b.options.design,b.form.$locale,f.childNodes.length%2===1,!0),e.append(f,h)),f=e.find(b.$element.get(0),b.id+"_rows"),h=g.createRow(b.id,d,c,b.columns,b.renderOptions,b.options.design,b.form.$locale,f.childNodes.length%2===1,!1),e.append(f,h)}},p.prototype.filtrableColumns=function(){var a=this,b=a.$schema;return b&&"array"===b.type&&b.items&&"object"===b.items.type?m.filtrableFields(b.items,a.form.$locale):[]},p.prototype._getColumnsFromSchema=function(){var a=this,b=a.$schema;return b&&"array"===b.type&&b.items&&"object"===b.items.type?m.columns(b.items,a.form.$locale):[]},p.prototype._getSelectedColumns=function(){var a=this,b={};return Object.keys(a._mapCols).forEach(function(a){b[a]=!0}),b},p.prototype._getGroupsFromSchema=function(){var a=this,b=a.$schema;return b&&"array"===b.type&&b.items&&"object"===b.items.type&&b.items.groups?b.items.groups:{}},p.prototype.getColumnsForSettings=function(){var a=this;return{schemaGroups:a._getGroupsFromSchema(),schemaColumns:a._getColumnsFromSchema(),selectedColumns:a._getSelectedColumns(),locale:a.form.$locale}},p.prototype._updateSorting=function(){var a=this,b=a.renderOptions;if(b&&b.sorting&&!b.headerIsHidden){var c=e.find(a.$element.get(0),a.id+"_cols");c&&g.updSorting(b,c,a._colByField,a.state.value.$orderby()),c=e.find(a.$element.get(0),a.id+"_frozen_cols"),c&&g.updSorting(b,c,a._colByField,a.state.value.$orderby())}},p.prototype._renderColumns=function(a){var b=this;if(b._inplaceEditRemove(!1,!1),a._useColGrp){
// create free columns

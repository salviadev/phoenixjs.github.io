...
/// <reference path="../../data/datasets.ts" />
/// <reference path="../datasets-plugin.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a,b,d,e,f,g,h){g(d,a,b,f,e)&&Object.keys(a.properties).forEach(function(e){var i=a.properties[e];if(!i.$reference)if("object"===i.type){var j=d?d+"."+e:e;c(i,b,j,!1,f?f[e]:null,g,h)}else if("array"===i.type){var k=s(i.items,b);if("object"===k.type){var j=d?d+"."+e:e;c(k,b,j,!0,f?f[e]:null,g,h)}}})}var d="#/definitions/",e=d.length;b.INDEX_FIELD_NAME="$index",b.SELECTED_FIELD_NAME="$select",b.EXPANDED_FIELD_NAME="$expand";var f=a.ulocale,g=(a.application,a.ajax,a.dom),h=(a.link,a.data),i=a.utils,f=a.ulocale,j=a.locale,k=a.customData,l=a.locale.schema,m=a.DatasetPlugin,n=[b.INDEX_FIELD_NAME,b.SELECTED_FIELD_NAME,b.EXPANDED_FIELD_NAME],o=function(a){return n.indexOf(a)>=0},p=function(){var a={};return{register:function(b,c){a[b]=c},get:function(b){return a[b]}}},q=function(){var a={};return{register:function(b,c){a[b]=c},get:function(b){return a[b]}}},r=function(a){if(!a.features){a.features={};var b=void 0===a.capabilities?"filtrable,sortable":a.capabilities;b&&b.split(",").forEach(function(b){a.features[b]=!0})}},s=function(a,b){if(a.$ref){var c=a.$ref.substr(e),d=b.definitions?b.definitions[c]:null;if(!d)throw"Schema $ref not found : "+a.$ref;return d}return a},t=q(),u=p(),v={_getDefault:function(a){return"@date"==a?f.date2ISO(new Date):a},checkLookup:function(a){return a?(a=$.extend({},a),a.data&&"odata"==a.data.$type||(a.pagination=!1,a.cache=!0),a.pagination!==!1&&(a.pagination=!0),a.pagination&&(a.cache=!1),a):null},schema2Authoring:function(a,b,d){var e=[];return c(a,b,"",!1,null,function(a,b,c,g,h){return!h&&(Object.keys(b.properties).forEach(function(g){var h=b.properties[g];if(v.inModel(h,c)&&!v.isCompositionRef(h,c))
//if (_sutils.isCompositionRef(ps) || _sutils.isCompositionList(ps)) return;
{var i=a?a+"."+g:g,j={$type:"field",$bind:i,$title:f.tt(h.title,d)||i,$widget:h.$widget,options:h.$widgetOptions};e.push(j)}}),b.links&&Object.keys(b.links).forEach(function(c){var g=b.links[c],h="$links."+c;h=a?a+"."+h:h;var i={$type:"action",$bind:h,$title:f.tt(g.title,d)||h,$widget:g.widget,options:g.$widgetOptions};e.push(i)}),!0)}),e},filtrableFields:function(a,b,d){var e=[];return c(a,b,"",!1,null,function(a,b,c,g,h){return!h&&(Object.keys(b.properties).forEach(function(g){var h=b.properties[g];if(v.inModel(h,c)&&!v.isCompositionRef(h,c)&&!v.isCompositionList(h,c,!0)){var j=a?a+"."+g:g;if(v.canFilter(h)){var k={name:j,schema:i.copy(h)};k.schema.title=f.tt(k.schema.title||"",d),e.push(k)}}}),!0)}),e},isFwField:o,columns:function(a,b,d){var e=[];return c(a,b,"",!1,null,function(a,b,c,g,h){return!h&&(Object.keys(b.properties).forEach(function(g){var h=b.properties[g];if(v.inModel(h,c)&&!v.isCompositionRef(h,c)&&!v.isCompositionList(h,c,!0)){var j=a?a+"."+g:g;if(v.canShowField(h)){var k={name:j,schema:i.copy(h)};k.schema.title=f.tt(k.schema.title||"",d),e.push(k)}}}),!0)}),e},allData:function(a){return!a.pagination},pkFields:function(a){return Array.isArray(a)?a:a.split(",").map(function(a){return a.trim()})},entityId:function(a){if("object"==typeof a){return Object.keys(a).map(function(b){var c=a[b];return"string"==typeof c?b+"='"+c+"'":b+"="+c}).join(",")}return"string"==typeof a?"'"+a+"'":a+""},extractPkValue:function(a,b){if(1==b.length)return a[b[0]];var c={};return b.forEach(function(b){c[b]=a[b]}),c},odataId:function(a,b){if(1==a.length)return b[a[0]];var c=[];return a.forEach(function(a){c.push(a+"="+encodeURIComponent(b[a]+""))}),c.join(",")},pk2Id:function(a,b){return 1===b.length?a:JSON.stringify(a)},id2Pk:function(a,b){return 1===b.length?a:JSON.parse(a)},equals:function(a,b,c){if(1===c.length)return a===b[c[0]];for(var d=0,e=c.length;d<e;d++){var f=c[d];if(a[f]!==b[f])return!1}return!0},extractBase:function(a){var b=a.split(".");return b.pop(),b.length?b.join(".")+".":""},parentPath:function(a){var b=a.split(".");return b.pop(),b.length?b.join("."):""},findByPk:function(a,b,c){if(c&&a)for(var d=0,e=c.length;d<e;d++){var f=c[d];if(v.equals(a,f,b))return f}return null},supportPagination:function(a){
//TODO
return!1},executeLookup:function(a,b,c){var d=h.execData(a.data,b,null);return c?void(d?d.then(c):c(null)):d},remoteSearch:function(a,b){return b.mapping?b.mapping[a]:a},lastSegment:function(a,b){var c=a.split("."),d=c.pop();return b&&b!=a&&(d=b.substring(c.join(".").length)),d},findFirst:function(a,b,c){if(!a||!c)return null;for(var d=a.toLocaleLowerCase(),e=d.length,f=0,g=c.length;f<g;f++){var h=c[f][b]||"";if(h.toLowerCase().substr(0,e)===d)return{item:c[f],index:f}}return null},_states:["$states","$links"],isMetaProp:function(a){return"$$"===a.substr(0,2)},removeMeta:function(a){Array.isArray(a)||Object.keys(a).forEach(function(b){v.isMetaProp(b)&&delete a[b]})},removeStates:function(a){Array.isArray(a)?a.forEach(function(a){a&&"object"==typeof a&&v.removeStates(a)}):(v._states.forEach(function(b){delete a[b]}),delete a.$errors,Object.keys(a).forEach(function(b){var c=a[b];c&&"object"==typeof c&&v.removeStates(c)}))},isMeta:function(a){var b="$$meta-".length;return"$$meta-"===a.substr(0,"$$meta-".length)?{widget:a.substr(b)}:null},getLookup:function(a,b,c,d){var e=a.split(".");e.pop();for(var f=c,g=0,h=e.length;g<h&&f;g++){var i=e[g];f="array"==f.type&&v.arrayProps.indexOf(i)>=0?s(f.items,d):f.properties?f.properties[i]:null}return f&&f.lookups?v.checkLookup(f.lookups[b]):null},getSchema:function(a,c,d,e){if(!a)return c;for(var f=a.split("."),g=c,h=!1,i=0,k=f.length;i<k&&g;i++){var l=f[i];if("array"==g.type&&v.arrayProps.indexOf(l)>=0)
// $item, $new 
g=s(g.items,d);else if("$links"===l)g=g.links,h=!0;else if(h)h=!1,g=g[l];else if(g=g.properties?g.properties[l]:null,!g&&i===k-1){if(l===b.INDEX_FIELD_NAME)return{type:"integer",title:"#",capabilities:null};if(l===b.SELECTED_FIELD_NAME)return{type:"boolean",title:j.ui.Selected,capabilities:null};if(l===b.EXPANDED_FIELD_NAME)return{type:"integer",title:"",capabilities:null}}}return e&&g&&"array"===g.type&&g.items&&(g=s(g.items,d)),g},states:["isHidden","isDisabled","isReadOnly","isMandatory"],statesAndErrors:["isHidden","isDisabled","isReadOnly","isMandatory","errors","filter"],linksStates:["isHidden","isDisabled"],isLink:function(a){return a.split(".").indexOf("$links")>=0},_isMoney:function(a){return v.isNumber(a)&&"money"==a.format},_internalExtractEnums:function(a,b,c,d){if(a.name){if(d.indexOf(a.name)>=0)return;d.push(a.name)}var e=function(b,d){if(d=d||a,d.enums&&d.enums[b]){var e=d.enums[b].type||"default";c[e]=c[e]||{},c[e][b]=d.enums[b]}else{
//$enumref = "Satut.codif"
var f=b.split(".");2===f.length&&(c[f[1]]=c[f[1]]||{},c[f[1]][f[0]]={type:f[1]})}};a.lookups&&Object.keys(a.lookups).forEach(function(b){var c=a.lookups[b];"enum"==c.data.$type&&c.data.$enumref&&e(c.data.$enumref)}),Object.keys(a.properties).forEach(function(f){var g=a.properties[f];if(v.inModel(g,b))if(v.isCompositionRef(g,b))v._internalExtractEnums(g,b,c,d);else if(v.isCompositionList(g,b,!0))v._internalExtractEnums(s(g.items,b),b,c,d);else{var h=a;v.isSimpleList(g,b)&&(g=s(g.items,b),h=g),g.$enumref&&e(g.$enumref,h)}})},_extractEnums:function(a,b){return v._internalExtractEnums(a,a,b,[])},_fillEnums:function(a,b){v._internalFillEnums(a,a,b,[])},_internalFillEnums:function(a,b,c,d){if(a.name){if(d.indexOf(a.name)>=0)return;d.push(a.name)}a.lookups&&Object.keys(a.lookups).forEach(function(b){var d=a.lookups[b];if("enum"==d.data.$type&&d.data.$enumref){var e=d.data.$enumref.split("."),f=2===e.length?c[e[1]]:c[a.enums[d.data.$enumref].type||"default"],g=2===e.length?e[0]:d.data.$enumref;if(f){d.data.$value=[];var h=f[g];h.enum.forEach(function(a,b){var c={code:a,title:h.enumNames[b]};h.fields&&i.extend(c,h.fields[b]),d.data.$value.push(c)})}}}),Object.keys(a.properties).forEach(function(e){var f=a.properties[e];if(v.inModel(f,b))if(v.isCompositionRef(f,b))v._internalFillEnums(f,b,c,d);else if(v.isCompositionList(f,b,!0))v._internalFillEnums(s(f.items,b),b,c,d);else{var g=a;if(v.isSimpleList(f,b)&&(f=s(f.items,b),g=f),f.$enumref){var h=f.$enumref.split(".");if(g.enums&&g.enums[f.$enumref]||2===h.length){var i=2===h.length?c[h[1]]:c[g.enums[f.$enumref].type||"default"],j=2===h.length?h[0]:f.$enumref;if(i){var k=i[j];k&&(f.enum=k.enum,f.enumNames=k.enumNames,f.filters=k.filters)}}}}})},loadEnums:function(a){var b={};v._extractEnums(a,b);var c=Object.keys(b).map(function(a){var c=u.get(a);if(!c)throw"Invalid enum type: "+a;return c.promise(b[a],a)});return c.length?c:null},arrayProps:["$item","$new"],init:function(a,b,c,d){var e=d||{};return e.$states=e.$states||{},Object.keys(a.properties).forEach(function(d){var f=a.properties[d];if(v.inModel(f,b)){var g=v.isMetaProp(d),h=a.states?a.states[d]:null,i=e.$states[d]=e.$states[d]||{};if(g||h&&Object.keys(h).forEach(function(a){void 0===i[a]&&(i[a]=h[a])}),v.isCompositionRef(f,b))
// recursive	
i.isMandatory&&(e[d]=v.init(f,b,c,e[d]||{}));else if(v.isCompositionList(f,b,!1)||v.isSimpleList(f,b))e[d]=e[d]||[];else if(v.isList(f,b))e[d]=e[d]||[];else if(void 0===e[d])if(void 0!==f.default)e[d]=v._getDefault(f.default);else if(f.enum)e[d]=f.enum[0];else switch(f.type){case"number":case"integer":e[d]=0}}}),e},
//
isCompositionRef:function(a,b){return"object"===a.type&&!a.$reference},isRef:function(a,b){return"object"===a.type&&a.$reference},isList:function(a,b){return"array"===a.type&&a.$reference},isCompositionList:function(a,b,c){if("array"===a.type&&a.items){var d=s(a.items,b);return("object"===d.type||"array"===d.type)&&(!a.$reference||c&&a.$reference)}return!1},isSimpleList:function(a,b){if("array"===a.type&&a.items){var c=s(a.items,b);return("object"!==c.type||"array"===c.type)&&!a.$reference}return!1},inModel:function(a,b){return!v.isRef(a,b)},formatNumber:function(a,b){return"money"==a.format?f.money(b,!1):f.decimal(b,a.decimals||0,null)},_title:function(a,b){return b?f.tt(a,b):a},canSort:function(a){return!!a&&(!a.hidden&&(r(a),a.features.sortable))},canShowField:function(a){return!a.hidden},canFilter:function(a){return!!a&&(!a.hidden&&(r(a),a.features.filtrable))},checkNumber:function(a,b,c,d){var e=!0;return b.exclusiveMinimum?void 0!=b.minimum&&a<=b.minimum&&(d.push({message:i.format(l.minNumberExclusive,v._title(b.title,c),v.formatNumber(b,b.minimum))}),e=!1):void 0!=b.minimum&&a<b.minimum&&(d.push({message:i.format(l.minNumber,v._title(b.title,c),v.formatNumber(b,b.minimum))}),e=!1),b.exclusiveMaximum?void 0!=b.maximum&&a>=b.maximum&&(d.push({message:i.format(l.maxNumberExclusive,v._title(b.title,c),v.formatNumber(b,b.maximum))}),e=!1):void 0!=b.maximum&&a>b.maximum&&(d.push({message:i.format(l.maxNumber,v._title(b.title,c),v.formatNumber(b,b.maximum))}),e=!1),e},_validateEmail:function(a,b){var c=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return c.test(a)},_validateJson:function(a,b){try{JSON.parse(a)}catch(a){return b.ex=a,!1}return!0},checkString:function(a,b,c,d,e){var f=!0,g=a||"";if(c.minLength&&g.length<c.minLength&&(e.push({message:i.format(l.minLength,v._title(c.title,d),c.minLength)}),f=!1),b.isMandatory&&""===g&&(e.push({message:i.format(l.required,v._title(c.title,d))}),f=!1),c.format)if("email"===c.format)a&&!v._validateEmail(a,{})&&(e.push({message:l.invalidEmail}),f=!1);else if("json"===c.format){var h={};a&&!v._validateJson(a,h)&&(e.push({message:h.ex.message}),f=!1)}return f},validatePassword:function(a,b,c,d,e,f){var g=!0;return d.isHidden||d.isDisabled?g:(a!==b&&(f.push({message:l.passwordMismatch}),g=!1),g)},validateSchema:function(a,b,c,d,e){var f=!0;if(c&&(c.isHidden||c.isDisabled))return f;switch(b.type){case"number":case"integer":f=v.checkNumber(a,b,d,e);break;case"string":f=v.checkString(a,c,b,d,e)}return f},loadEnumsPromise:function(a){var b=v.loadEnums(a);return b?i.Promise.all(b).then(function(b){var c={};return b.forEach(function(a){c[a.type]=a.enums}),v._fillEnums(a,c),a}):new i.Promise(function(b,c){b(a)})},loadSchemaRefs:function(a,b,c,d){if(!a)return d();var e=v.loadEnums(a),f=e?e:[],h=e?e.length:0,j=w.loadMainData(c);j&&f.push(j);var k=j?h+1:0;return f.length?(g.processing(!0),void i.Promise.all(f).then(function(c){g.processing(!1);var e={};c.forEach(function(a,c){c<h?e[a.type]=a.enums:c<k&&$.extend(!0,b,a)}),h&&v._fillEnums(a,e),d(b)}).catch(function(a){throw g.processing(!1),a})):d(b)},stateProps:function(a){return a.enum&&a.filters?["filter"]:a.items&&a.items.enum&&a.items.filters?["filter"]:null},isPassword:function(a){return"string"===a.type&&"password"===a.format},isDate:function(a){return"string"===a.type&&"date"===a.format},isDateTime:function(a){return"string"===a.type&&"date-time"===a.format},isBoolean:function(a){return"boolean"===a.type},isSelectField:function(a){return a===b.SELECTED_FIELD_NAME},isExpandField:function(a){return a===b.EXPANDED_FIELD_NAME},isNumber:function(a){return"number"===a.type||"integer"===a.type},isText:function(a){return"string"===a.type&&("json"===a.format||"memo"===a.format)},isMoney:function(a){return v.isNumber(a)&&"money"==a.format},text2Value:function(a,b){if(v.isNumber(b)){var c=v.isMoney(b)?j.number.places:b.decimals,d=f.string2Float(a);return d=parseFloat(d.toFixed(c))}return a},value2Text:function(a,b){return v.isNumber(b)?v.isMoney(b)?f.money(parseFloat(a||"0"),!1):f.decimal(a,b.decimals,null):a||""},expand$Ref:function(a,b){return s(a,b)},removeExpand:function(a,b){if(!b)return a;var c=b+".$item.",d=a.lastIndexOf(c);return d<0?a:a.substr(d+c.length)},registerValidator:t.register,getValidator:t.get,registerEnumManager:u.register,getEnumManager:u.get},w={extractDatasets:function(a){if(a.datasets){var b=Object.keys(a.datasets);if(b.length)return b.map(function(b){var c=$.extend({},a.datasets[b],!0);return c.name=b,c})}return null},isQuery:function(a){return!("odata"!==a.$type||a.$method&&"GET"!==a.$method.toUpperCase()||a.$params.hasOwnProperty("$entityId"))},isCreateOrUpdate:function(a){return"odata"===a.$type&&a.$params.hasOwnProperty("$entityId")},extractMainDataSource:function(a){var b=null;if(a.datasets){var c=Object.keys(a.datasets);c.length&&(c.forEach(function(c){a.datasets[c].$main&&(b=$.extend({},a.datasets[c],!0))}),b||(b=$.extend({},a.datasets[c[0]],!0)))}return b},datasetsAsPromise:function(a,b){return new i.Promise(function(c,d){var e={};g.processing(!0);var f=null;a.forEach(function(a){a.$main&&(f=a)}),f||(f=a[0]),w.isCreateOrUpdate(f)&&(f.$create=f.$create||{}),m.executeDatasets(a,{},e,{},function(a,h){if(g.processing(!1),h)d(h);else{if(b){var i=k.get(b);i&&i(e)}c(e[f.name])}})})},datasetAsPromise:function(a,b){return new i.Promise(function(c,d){var e={};a.name=a.name||"data",g.processing(!0),m.executeDatasets([a],b||{},e,{},function(b,f){g.processing(!1),f?d(f):c(e[a.name])})})},loadMainData:function(a){var b=w.extractDatasets(a);return b&&b.length?w.datasetsAsPromise(b,a.transform):i.Promise.resolve(null)},dsConfig:function(a,b,c){var d=b.$reference;if(a&&d){var e=Object.keys(a);if(1===e.length){var f=a[e[0]];return f.$main=!0,f}if("string"==typeof d)return a[d]}return null}},x={_enums:{},promise:function(a,b){var c={};return Object.keys(a).forEach(function(b){var d=a[b];x._enums[b]||(x._enums[b]={enum:d.enum,enumNames:d.enumNames,filters:d.filters}),c[b]=x._enums[b]}),new i.Promise(function(a,d){a({type:b,enums:c})})}};v.registerEnumManager("default",x),b.SchemaUtils=v,b.DataUtils=w}(b=a.Observable||(a.Observable={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../core/core.ts" />
...
/// <reference path="../../../core/core.ts" />
/// <reference path="./absfield.control.ts" />
var Phoenix;!function(a){var b;!function(b){function c(a,b,c,f,g){f=f||"",b=$.extend({titleIsHidden:!1},b);var h=[];return d.Utils.fieldWrapper(h,b,c,function(){h.push('<div style="background-color: red;">'+f+"</div>")}),e.format(h.join(""),a)}var d=b,e=a.utils,f=a.dom,g=a.ulocale,h=function(a){function b(b,c,d){a.call(this,b,c,d);var f=this;f._map=[],b.options&&b.options.$expression?(f.$expression=b.options.$expression,e.extractAngularVars(f.$expression,f._map)):(f.$expression=e.format("{0}: {{{1}}}",e.escapeHtml(g.tt(f.$schema.title,f.form.$locale)),f.$bind),f._map.push({name:f.$bind})),f._map.forEach(function(a){a.name!=f.$bind?(a.schema=d.getSchema(a.name),f.form.registerListenerFor(a.name,f)):a.schema=f.$schema}),this._state()}return __extends(b,a),b.prototype._state=function(){var a=this;a.state=a.state||{},a.state.values=a.state.values||{},a.state.fvalues=a.state.fvalues||{};var b=a.form.getState(a.$bind);a.state.isHidden=b.isHidden,a._map.forEach(function(b){a.state.values[b.name]=a.form.getValue(b.name),a.state.fvalues[b.name]=d.Utils.displayValue(a.state.values[b.name],b.schema,a.form.$locale,{html:!1,useSymbol:!0},b.name).value})},b.prototype._value2UI=function(){var a=this,b=a.$element?a.$element.get(0):null,c=e.execAngularExpression(a.$expression,a.state.fvalues),d=$("<div>"+c+"</div>").get(0);for(f.empty(b);d.childNodes.length>0;)b.appendChild(d.childNodes[0])},b.prototype._findMap=function(a){for(var b=this,c=0,d=b._map.length;c<d;c++){var e=b._map[c];if(e.name==a)return e}return null},b.prototype.changed=function(a,b,c,e){var f=this;if(a&&f.state.values[a]!=c){var g=f._findMap(a);g&&(f.state.values[a]=c,f.state.fvalues[a]=d.Utils.displayValue(f.state.values[a],g.schema,f.form.$locale,{html:!1,useSymbol:!0},a).value,f._value2UI())}},b.prototype.stateChanged=function(a,b){if(!a||"isHidden"===a){var c=this,d=c.form.getState(c.$bind),e=c.$element?c.$element.get(0):null;d.isHidden!==c.state.isHidden&&(c.state.isHidden=d.isHidden,e&&c.setHidden(e))}},b.prototype._state2UI=function(){var a=this,b=a.$element?a.$element.get(0):null;b&&(a.setHidden(b),a._value2UI())},b.prototype.render=function(a){var b=this,e=b._initOptions(d.Utils.defaultOptions);return b.$element||(b.$element=$(c(b.id,e,b.options.design,g.tt(b.$schema.title,b.form.$locale),"")),b._state2UI()),b.appendElement(a,e),b.$element},b.prototype.destroy=function(){var b=this;b._map.forEach(function(a){a.name!=b.$bind&&b.form.unRegisterListenerFor(a.name,b)}),a.prototype.destroy.call(this)},b}(b.AbsField);b.ReadOnlyField=h,d.registerControl(h,"*",!1,"",{readOnly:!0})}(b=a.ui||(a.ui={}))}(Phoenix||(Phoenix={}));
/// <reference path="../../../../../typings/index.d.ts" />
/// <reference path="../../../core/core.ts" />
/// <reference path="../../../core/modules/locale.ts" />
/// <reference path="./absfield.control.ts" />
